...
_STRINGS: dict[str, str] = {
    ...
    "The predicted prominence P = 3 lg(OR) + 2 lg(LD) combines the onset rate OR (dB/s) and the level difference LD (dB) of each impulse (NT ACOU 112:2002, clause 7, Formula 1); the governing value is the highest P over a 30-minute period among impulses with an onset rate above 10 dB/s (clauses 4.5/8).": "La prominencia prevista P = 3 lg(OR) + 2 lg(LD) combina la tasa de inicio OR (dB/s) y la diferencia de nivel LD (dB) de cada impulso (NT ACOU 112:2002, cláusula 7, Fórmula 1); el valor rector es la P más alta en un periodo de 30 minutos entre los impulsos con una tasa de inicio superior a 10 dB/s (cláusulas 4.5/8).",
    "The L<sub>Aeq</sub> adjustment K<sub>I</sub> = 1.8 (P &#8722; 5) dB for P &gt; 5, else 0 dB, is applied to L<sub>Aeq,30min</sub> on the basis of the single impulse with the highest prominence (clause 8, Formula 2).": "El ajuste de L<sub>Aeq</sub> K<sub>I</sub> = 1,8 (P &#8722; 5) dB para P &gt; 5, y 0 dB en caso contrario, se aplica a L<sub>Aeq,30min</sub> sobre la base del único impulso con la prominencia más alta (cláusula 8, Fórmula 2).",
    ...
    "Population fractile Q = {q}": "fractil poblacional Q = {q}",
    ...
    "{standard} tonal audibility of a wind turbine per IEC 61400-11:2012+A1:2018 (subclauses 9.5.2-9.5.5); a tone is audible when the tonal audibility &#916;L<sub>a</sub> exceeds 0 dB.": "{standard} audibilidad tonal de un aerogenerador según IEC 61400-11:2012+A1:2018 (apartados 9.5.2-9.5.5); un tono es audible cuando la audibilidad tonal &#916;L<sub>a</sub> supera 0 dB.",
    "Tonal audibility of a wind turbine per IEC 61400-11:2012+A1:2018 (subclauses 9.5.2-9.5.5); a tone is audible when the tonal audibility &#916;L<sub>a</sub> exceeds 0 dB.": "Audibilidad tonal de un aerogenerador según IEC 61400-11:2012+A1:2018 (apartados 9.5.2-9.5.5); un tono es audible cuando la audibilidad tonal &#916;L<sub>a</sub> supera 0 dB.",

...
_STRINGS: dict[str, str] = {
    ...
    "A band reaches engineering grade when L<sub>d</sub> &gt; F<sub>pI</sub>, F<sub>+/&#8722;</sub> &#8804; 3 dB and the two sweeps repeat within the ISO 9614-2:1996 Table 2 limit s per segment; survey grade drops the F<sub>+/&#8722;</sub> criterion (Annex B). The A-weighted L<sub>WA</sub> sums the determinable bands only; a band with net power P &#8804; 0 is not determinable (clause 9.2) and omitted. Levels are referenced to the reference sound power 1 pW.": "Una banda alcanza el grado de ingeniería cuando L<sub>d</sub> &gt; F<sub>pI</sub>, F<sub>+/&#8722;</sub> &#8804; 3 dB y los dos barridos se repiten dentro del límite s de la Tabla 2 de la ISO 9614-2:1996 por segmento; el grado de control prescinde del criterio F<sub>+/&#8722;</sub> (Anexo B). El L<sub>WA</sub> ponderado A suma solo las bandas determinables; una banda con potencia neta P &#8804; 0 no es determinable (apartado 9.2) y se omite. Los niveles se refieren a la potencia acústica de referencia 1 pW.",

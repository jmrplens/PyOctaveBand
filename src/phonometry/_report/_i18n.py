...
_STRINGS: dict[str, str] = {
    ...
    "{standard} octave-band measurement of room noise. Noise Criteria (NC) rating by the tangency method (ANSI/ASA S12.2-2019).": "{standard} medición del ruido de salas por bandas de octava. Calificación de Criterio de Ruido (NC) por el método de la tangencia (ANSI/ASA S12.2-2019).",
    "Noise Criteria (NC) rating by the tangency method (ANSI/ASA S12.2-2019).": "Calificación de Criterio de Ruido (NC) por el método de la tangencia (ANSI/ASA S12.2-2019).",

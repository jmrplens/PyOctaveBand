...
:math:`\lvert H_3 \rvert = a_3/4` (phase :math:`\pi`), and a THD(f)
equal to the closed form
:math:`\sqrt{(a_2/2)^2 + (a_3/4)^2} / (1 + 3 a_3/4)` -- which also
...
def swept_sine_distortion(
    ...
    *,
    ...
    :math:`[n f_1, n f_2]`), or :func:`phonometry.sweep_signal` for

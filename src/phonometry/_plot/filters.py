...
_STRINGS: dict[str, str] = {
    ...
    "IEC 61260-1 class {cls} mask — $f_\\mathrm{{m}}$ = {fm} Hz":
        "Máscara clase {cls} IEC 61260-1 — $f_\\mathrm{{m}}$ = {fm} Hz",
    "lowpass": "paso bajo",
    "highpass": "paso alto",
    "magnitude": "magnitud",
    "Cascade": "Cascada",
...
def plot_filter_class(
    ...
    ax.set_title(
        _t("IEC 61260-1 class {cls} mask — $f_\\mathrm{{m}}$ = {fm} Hz", language, cls=cls,

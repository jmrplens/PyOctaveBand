...
:mod:`~phonometry.environment.assessment.impulse_prominence` helpers (NT ACOU 112, which
...
:mod:`~phonometry.environment.assessment.impulse_prominence`. The method for determining

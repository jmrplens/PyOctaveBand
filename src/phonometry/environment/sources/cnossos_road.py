...
.. math::
   ...
   L'_{W,\mathrm{eq,line},i,m} = L_{W,i,m}
...
def road_rolling_noise(
    ...
    *,
    ...
    :math:`L_{W\mathrm{R},i,m} = A_{\mathrm{R},i,m} + B_{\mathrm{R},i,m} \log_{10}(v_m/v_\mathrm{ref}) +
    dL_{W\mathrm{R},i,m}` with the
...
def road_propulsion_noise(
    ...
    *,
    ...
    :math:`L_{W\mathrm{P},i,m} = A_{\mathrm{P},i,m} + B_{\mathrm{P},i,m} (v_m - v_\mathrm{ref})/v_\mathrm{ref} +
    dL_{W\mathrm{P},i,m}` with
...
def road_source_power(
    ...
    *,
    ...
    Evaluates
    :math:`L'_{W,\mathrm{eq,line},i,m} = L_{W,i,m} + 10 \log_{10}(Q_m/(1000 v_m))` for every
...
def line_source_segment_power(
    ...
    :math:`L_{W,\mathrm{segment},i} = L'_{W,\mathrm{eq,line},i} + 10 \log_{10}(dL)`. This is
    arithmetic, not a

...
$$
\bar{L}_p = 10\lg\left( \frac{1}{N_M} \sum_i 10^{L_{pi}/10} \right), \qquad
L_W = \bar{L}_p - K_1 - K_2 + 10\lg\frac{S}{S_0},\quad S_0 = 1\ \text{m}^2 .
$$
...
$$
K_1 = -10\lg\left( 1 - 10^{-\Delta L_p/10} \right),
$$
...
$$
K_2 = 10\lg\left( 1 + \frac{4 S}{A} \right).
$$
...
$10\lg(S/S_0)$ gives $L_W(f)$, and the A-weighted energy sum across bands

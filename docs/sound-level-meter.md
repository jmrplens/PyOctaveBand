...
Deep guide: [Calibration and dBFS](calibration.md), which
...
plus $10\lg$ of the 10 s duration, and $L_{90}$ barely notices the event at
all.
...
Deep guides: [Filter Banks](filter-banks.md) for the filter
architectures and zero-phase mode,
[Block Processing](block-processing.md) for streaming, and
[Multichannel and Performance](multichannel.md) for arrays.
...
- [Measurement uncertainty (GUM and Monte Carlo)](gum-uncertainty.md):
  ...
  included.
- [Calibrated spectral analysis](spectral-analysis.md): when
...
- [Block Processing](block-processing.md): turn this page's

...
| :--- | :--- | :--- | :--- | :--- |
| `x` | 1D or 2D array, or `Signal` | digital units, or Pa for a calibrated `Signal` | non-empty | 2D is `[channels, samples]`; a `dbfs` bank ignores the calibration and stays in digital units |

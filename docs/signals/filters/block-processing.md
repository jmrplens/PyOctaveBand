...
bank = filters.OctaveFilterBank(fs, fraction=1, limits=[900, 1100],
...
offline = filters.OctaveFilterBank(fs, fraction=1, limits=[900, 1100],
...
fs = 48000
octave_filter = filters.OctaveFilterBank(fs, 1, stateful=True, resample=False)

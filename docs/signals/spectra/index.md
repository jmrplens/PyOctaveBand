...
compliance verdict. Three capabilities a reader looks for are genuinely
absent.
...
[Electroacoustics](../../devices/electroacoustics/electroacoustics.md),
and the two-microphone intensity probe on [Sound

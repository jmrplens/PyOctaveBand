...
(ISO 3382-3). Two separate decay measurements in a reverberation room, one
with the room empty and one with the specimen installed, yield a material's
sound absorption; that method (ISO 354)

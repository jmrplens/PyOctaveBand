...
The whole tube, sample included, can also be simulated: the
[FDTD guide](fdtd-simulation.md) runs this exact
measurement virtually and recovers the analytic absorption of the modelled
sample through the same reduction chain.

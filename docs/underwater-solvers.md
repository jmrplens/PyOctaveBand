...
with a pressure-release surface at $z = 0$ and a pressure-release or rigid
bottom. Each eigenfunction $\Psi_m(z)$ is a standing wave in depth that
...
The **split-step Fourier** algorithm marches it exactly in two alternating

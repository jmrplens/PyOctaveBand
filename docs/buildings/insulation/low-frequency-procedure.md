...
25 m³ and a `frequencies` vector that names the 50 Hz, 63 Hz and 80 Hz bands,
it has been told everything it needs to know that Clause 8.1 is in force. If no
...
defect of the print, recorded in the [errata registry](../../ERRATA.md).)
...
[conformance report](../../CONFORMANCE.md), and every one of them judges a

...
impact, and the loudspeaker facade methods. A road-traffic facade stays silent
...
that Clause 8.1 is in force, and with no procedure to run it says so with a

...
- [HVAC noise the German way (VDI 2081)](devices/noise-control/vdi2081-air-systems.md): the same fan-to-room chain by the German guideline: the assembly-type fan model of Equation (13), the attenuation and flow noise of each duct element, the splitter silencer and its own noise, and the room step of Equation (36), against the worked sheet of Part 2 Table 1 (VDI 2081 Blatt 1:2001-07; Blatt 2:2005-05)
- [Control valve noise (IEC 60534-8-3)](devices/noise-control/control-valve-noise.md): the whole of Clause 5 for a valve with standard trim: the five flow regimes and the pressure ratios that define them, the valve style modifier and jet diameter that set the peak frequency, the acoustical efficiency of each regime, the internal level at the pipe wall and its third-octave spectrum, the pipe transmission loss shaped by the ring and coincidence frequencies, and the A-weighted level one metre outside, against the seven worked examples of Annex A (IEC 60534-8-3:2010)
- [Hydrodynamic valve noise (IEC 60534-8-4)](devices/noise-control/valve-cavitation.md): the same chain for a liquid: the differential pressure ratio and the characteristic pressure ratio that decide whether the valve cavitates, the turbulent and cavitating acoustical efficiencies that add up to the sound power, the two peak frequencies they radiate at, the pipe transmission loss anchored at the ring frequency, and the level one metre outside, against the three worked examples of Annex A (IEC 60534-8-4:2005)

...
- **Comportamiento de la biblioteca:** implementa la Ec. (4.6) con la presión
  ...
  ([`tests/fluids/test_water.py`](../tests/fluids/test_water.py),
...
- **Comportamiento de la biblioteca:** no le afecta. El desliz está en una
  ...
  [`room_effect`](../src/phonometry/noise_control/hvac.py) toma ``A`` como
  argumento y
...
- **Comportamiento de la biblioteca:** no le afecta.
  [`critical_distance`](../src/phonometry/room/steady_field.py) toma ``Q`` como

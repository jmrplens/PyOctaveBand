...
across 12 mm of solid spacer, and that `Δr` is both the sensitivity of the
gradient estimate and the origin of the high-frequency error.*
...
sample or any whole number of cycles). **F1**, the

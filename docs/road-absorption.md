...
- [Impedance Tube](impedance-tube.md): the ISO 10534-2 two-microphone method
  the spot tube defers its mathematics to, and the laboratory instrument the
  spot method miniaturises.
- [Diffusers and Their Coefficients](diffusers.md): the other family of
...
- International Organization for Standardization. (1998). *Acoustics —
  ...
  implemented in the [Impedance Tube](impedance-tube.md) guide.
...
the ISO 10534-2:1998 routine of the [Impedance Tube](impedance-tube.md)

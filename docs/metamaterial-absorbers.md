...
- **The microperforated panel is a critically coupled absorber avant la
  ...
  the hole mass against the cavity compliance, with cavities of a tenth to
  a twentieth of a wavelength, an order short of the slit panel's
  compression, so the construction cannot reach the deep-subwavelength
  regime.

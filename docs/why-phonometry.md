...
| IEC 61672-1:2013 Table 5 | `lc_peak()` one-cycle/half-cycle peak responses, class 1 limits | `tests/signal/test_levels.py` |
...
533 numerical conformance checks across 57 domains and 362 standards, covering

...
[Loudspeaker Characterisation (IEC 60268-5)](loudspeakers.md), with the
sensitivity conventions and the baffled-piston radiation model, and
...
microphone side, its sensitivity references, directional patterns,
...
- Bendat, J. S., & Piersol, A. G. (2010). *Random data: Analysis and
  ...
  The $H_1$ and $H_2$ frequency-response estimators and the ordinary
  coherence $\gamma^2$ of section 4.

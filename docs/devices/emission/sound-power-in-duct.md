...
area term $10 \lg S = -5.06$ dB for the 0.312 m² duct, and the $-0.14$ dB of
the impedance term, which widens the gap rather than closing it because
Eq. (12) subtracts it, less the

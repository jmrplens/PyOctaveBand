...
[field sound insulation](insulation-field.md). And the harmonic distortion
...
[swept-sine distortion guide](swept-sine-distortion.md).
...
- [System Measurement](system-measurement.md): complementary Golay pairs and
  spectrally shaped sweeps, returning the same result types.
- [Swept-Sine Distortion & Phase](swept-sine-distortion.md): the Farina
  reading of the distortion the sweep separates.
- [Field Insulation Measurement (ISO 16283)](insulation-field.md): the same

...
first spike's height is exactly the reflection coefficient `a` -
of either sign - a closed form the tests and the conformance suite pin to
1e-10. `echo_detection` automates the reading: it picks the largest

...
|---|---|---|---|
| Spherical | $1/r^2$ | $20 \lg r$ | $r = H/(2\psi_c)$ |
| Cylindrical | $2\psi_c/(rH)$ | $10 \lg r$ | $r_{CS} = \pi H/(4\eta\psi_c^2)$ |
| Mode stripping | $\sqrt{\pi/(\eta H)}\, r^{-3/2}$ | $15 \lg r$ | $r_{MS} = k^2 H_e^3/(9\pi\eta)$ |
| Single mode | Eq. (9.54), exponential | steeper than $15 \lg r$ | — |
...
$PL = -10 \lg F$ and returns each regime's own law alongside it; the

...
discrete-point method live in [Sound Intensity (p-p)](intensity.md); which
route fits which job is weighed in [Sound Power](sound-power.md).
...
- [Theory](theory-environment-transport.md): the field-indicator derivations.

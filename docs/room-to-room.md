...
[Panel sound insulation](panel-sound-insulation.md) (mass law, coincidence,
...
reverberant fields, $\text{TL} = 10\lg(1/\tau)$ the transmission loss of the
...
matters is $L_{p1} = L_W + 10\lg(4/R_1)$. That is `steady_state_spl` with
...
$10\lg 4 = 6.02\ \text{dB}$, and without it the printed answers come out
6 dB low.
...
[Panel sound insulation](panel-sound-insulation.md) is for.
...
$\text{TL} = \text{IL} + 10\lg(S_E / R_i)$, which is
...
[Building sound insulation prediction](insulation-prediction.md) and
[Flanking transmission](flanking-lab.md).

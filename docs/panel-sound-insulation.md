...
coupling off as $1/f^2$ below that ceiling once $|Y_c|$ overtakes the plate
mobilities, which is exactly why a butterfly tie at 1.7 MN/m and a
vertical-twist tie at 94 MN/m behave so differently.
...
The **inputs** of this model are printed data: Table A4, corroborated by
Hopkins, Wilson & Craik (1999) Table 1 at a 50 mm cavity and by Craik & Wilson
(1995) Table 1 at 85 mm. The **output** is not: every published sound reduction

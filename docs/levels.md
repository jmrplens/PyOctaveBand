...
uncertainty section of [Environmental levels](environmental-levels.md));
...
of [Environmental levels](environmental-levels.md) does.
...
bank = metrology.OctaveFilterBank(fs=fs, fraction=12, order=6, limits=[50.0, 12000.0])

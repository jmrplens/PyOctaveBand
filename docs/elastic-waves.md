...
[panel sound insulation](panel-sound-insulation.md), the flexural waves of
...
[underwater sound propagation](underwater-propagation.md) cannot represent.
...
[bending-wave transmission guide](junction-transmission.md) embeds an
...
[underwater module](underwater-propagation.md) cannot represent, and the
...
[panel sound insulation guide](panel-sound-insulation.md) embeds the
...
- [Predicting Panel Sound Insulation](panel-sound-insulation.md): the mass
...
- [Underwater sound propagation](underwater-propagation.md): the

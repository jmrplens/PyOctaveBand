...
| ASTM E413-22 clause 5 (ASTM E1414 CAC) | Ceiling attenuation class of two accredited E1414 test reports | CAC 34 (ALA 16-091-5); CAC 25, sum 24 dB (Intertek J7488.04) | CAC 34; CAC 25, sum 24.0 dB | exact | &#9989; |
| ISO 140-9:1985 clause 3.3 | Normalized ceiling attenuation Dn,c = D - 10 lg(A/A0), A0 = 10 m2 | 43.0103 dB (+/-0 dB) | 43.0103 dB | 0 dB | &#9989; |
| Vigran (2008) Eq. (9.20) | Suspended-ceiling plenum penalty 10 lg(eps^2 LR/4h), LR = 4,75 m, h = 0,43 m | 10.4 dB (+/-0.05 dB) | 10.43 dB | 0.032 dB | &#9989; |

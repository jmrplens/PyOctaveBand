...
- **Library behaviour:** the conformance rows that reproduce Annex A.3 pass the
  ...
  land on the printed $b$ and $\kappa'$ ([`tests/reference_data/`](../tests/reference_data/),
...
- **Library behaviour:** implements A.5.6 with the redundancy term as printed
  there, in
  [`_index_from_corrected_mtf`](../src/phonometry/speech/sti.py); the pairwise
...
- **Library behaviour:** carries all three quantities on one scale, the plain
  ...
  [`sti.py`](../src/phonometry/speech/sti.py); the transcription in
  [`tests/reference_data/`](../tests/reference_data/) keeps the printed cells
...
- **Library behaviour:** computes $I_{am,k}$ from the unrounded masking factor.
  The transcription in [`tests/reference_data/`](../tests/reference_data/)
...
- **Library behaviour:** none required. `field_indicators` in
  [`intensity.py`](../src/phonometry/emission/intensity.py) forms $F_3$ from
...
- **Library behaviour:** none required. The coefficient of variation behind
  ...
  [`intensity.py`](../src/phonometry/emission/intensity.py) divides by the
...
- **Library behaviour:** unaffected. The slip is in a cross-reference, not in a
  number;
  [`room_effect`](../src/phonometry/noise_control/hvac.py) takes ``A`` as an
  argument and
  [`sabine_absorption_area`](../src/phonometry/room/steady_field.py)
...
- **Library behaviour:** unaffected.
  [`critical_distance`](../src/phonometry/room/steady_field.py) takes ``Q`` as
...
- **Library behaviour:**
  ...
  [`sound_strength`](../src/phonometry/room/auditorium.py) from the response
...
- **Evidence:** Verified on PDF page 21 (printed p. 13) of
  BS EN ISO 3382-1:2009.
- **Library behaviour:**
  [`directivity_energy_average`](../src/phonometry/room/auditorium.py) takes
...
- **Library behaviour:**
  ...
  and [`source_directivity_limit`](../src/phonometry/room/auditorium.py) carry
...
- **Evidence:** Verified on PDF page 11 (printed p. 3) of
  BS EN ISO 3382-1:2009.
- **Library behaviour:**
  [`gliding_directivity_deviation`](../src/phonometry/room/auditorium.py)
...
- **Library behaviour:**
  [`valve_aerodynamic_noise`](../src/phonometry/noise_control/valves.py) takes

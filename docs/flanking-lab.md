...
gives Eq. (9.18), whose receiving-side exponent carries the leakage back into
the room, $m'_R = m_R + s_R\tau_R/h$ (Eq. (9.17)). For a plenum with little
...
- International Organization for Standardization. (1985). *Acoustics —
  ...
  The normalized ceiling attenuation $D_{n,c}$ (clause 3.3) and the plenum
  test facility.
...
ceiling attenuation $D_{n,c}$ and its laboratory, and ASTM E413-22, the rating
...
it is anchored on its closed forms and on the convergence of Eq. (9.18) to
Eq. (9.20). The `Dn,c` measurement chain and the class are anchored on
accredited ASTM E1414 laboratory reports.

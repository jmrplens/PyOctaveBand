...
def test_event_flat_terrain_matches_flat_ground() -> None:
    ...
    flat = rotorcraft_event_level(
        hems, spd, ang, t, pos, (300.0, 0.0),
        ground=RotorcraftGround(flow_resistivity="D", terrain=dem,
...
def test_event_terrain_sets_receiver_elevation() -> None:
    ...
    res = rotorcraft_event_level(
        hems, spd, ang, t, pos, (300.0, 0.0),
        ground=RotorcraftGround(terrain=dem, terrain_resolution=100.0))
...
def test_event_numpy_scalar_flow_resistivity_is_scalar() -> None:
    ...
    hems, spd, ang, t, pos, dem = _terrain_case(np.zeros((41, 41)))
    base = rotorcraft_event_level(
        hems, spd, ang, t, pos, (300.0, 0.0),
        ground=RotorcraftGround(flow_resistivity=2.0e5))
    ...
    with_dem = rotorcraft_event_level(
        hems, spd, ang, t, pos, (300.0, 0.0),
        ground=RotorcraftGround(flow_resistivity=np.float32(2.0e5),
...
def test_contour_mixed_sigma_matches_stitched_scalar_runs() -> None:
    ...
    mixed = rotorcraft_noise_contour(
        hems, spd, ang, t, pos, x=x, y=y,
        ground=RotorcraftGround(flow_resistivity=sig))
    lo = rotorcraft_noise_contour(
        hems, spd, ang, t, pos, x=x, y=y,
        ground=RotorcraftGround(flow_resistivity=2.0e5))
    hi = rotorcraft_noise_contour(
        hems, spd, ang, t, pos, x=x, y=y,
        ground=RotorcraftGround(flow_resistivity=8.0e5))
...
def test_contour_mixed_elevation_matches_stitched_scalar_runs() -> None:
    ...
    mixed = rotorcraft_noise_contour(
        hems, spd, ang, t, pos, x=x, y=y,
        ground=RotorcraftGround(ground_elevation=ge))
    lo = rotorcraft_noise_contour(
        hems, spd, ang, t, pos, x=x, y=y,
        ground=RotorcraftGround(ground_elevation=0.0))
    hi = rotorcraft_noise_contour(
        hems, spd, ang, t, pos, x=x, y=y,
        ground=RotorcraftGround(ground_elevation=5.0))
...
def test_contour_with_terrain_smoke() -> None:
    ...
    res = rotorcraft_noise_contour(
        ...
        ground=RotorcraftGround(terrain=dem, terrain_resolution=200.0))

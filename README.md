...
| [Sound Power](https://github.com/jmrplens/phonometry/blob/main/docs/sound-power.md) | Choosing the determination method and declaring the noise emission (ISO 4871), with a guide per route: enveloping surface (ISO 3744/3746/3745), reverberation room (ISO 3741) and intensity scanning (ISO 9614-2/-3) |

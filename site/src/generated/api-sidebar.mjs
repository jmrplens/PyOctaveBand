...
export const apiSidebar = {
  ...
  items: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'reference/api/signal/levels',
        'reference/api/signal/spectra',
        'reference/api/signal/miso',
        'reference/api/signal/time-frequency',
        'reference/api/signal/test-signals',
        'reference/api/signal/phase',
        'reference/api/signal/cepstrum',
        'reference/api/signal/synchronous-average',
        'reference/api/signal/inversion',
        'reference/api/signal/correlation',
        'reference/api/signal/envelope',
      ],
    },
    {

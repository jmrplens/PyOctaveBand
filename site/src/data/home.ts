 ...
 *   81 guides        site/src/content/docs/guides/*.md*
...
export const en: HomeContent = {
	...
	coverage: {
		...
		lead: 'Nine areas, 81 guides, 120 API reference pages. Each row links to the area overview; the designations are the standards actually implemented there, not a reading list.',
		...
		areas: [
			...
			},
			{
				...
				href: '/phonometry/guides/sections/underwater/',
			...
			},
			{
				...
				href: '/phonometry/guides/sections/sources-devices/',
		...
		steps: [
			{
				...
				href: '/phonometry/getting-started/',
...
export const es: HomeContent = {
	...
	coverage: {
		title: 'Qué abarca',
		lead: 'Nueve áreas, 81 guías y 120 páginas de referencia de la API. Cada fila enlaza al índice del área; las designaciones son las normas realmente implementadas ahí, no una lista de lecturas.',
		...
		areas: [
			...
			},
			{
				...
				href: '/phonometry/es/guides/sections/underwater/',
			...
			},
			{
				...
				href: '/phonometry/es/guides/sections/sources-devices/',

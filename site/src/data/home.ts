...
export const es: HomeContent = {
	...
	coverage: {
		title: 'Qué abarca',
		lead: 'Nueve áreas, 66 guías y 120 páginas de referencia de la API. Cada fila enlaza al índice del área; las designaciones son las normas realmente implementadas ahí, no una lista de lecturas.',

...
- Theory: [Tone prominence: TNR and PR](/phonometry/reference/theory/perception/#tone-prominence-tnr-and-pr-ecma-418-1): the neighbouring family of tone metrics, TNR and PR, derived from the same critical-band picture.

...
description: "The ECMA-418-1 tone-to-noise ratio and prominence ratio: FFT-based prominence verdicts for discrete tones against frequency-dependent criteria, with the ECMA-74 measurement positions."
references:
  - type: standard
...
- [Environmental Levels](/phonometry/environment/environmental-levels/): the ISO 1996-1 rating levels and their Table A.1

...
**Covered.** Taal et al. 2011 (STOI) and Jensen & Taal 2016 (ESTOI), the two
...
index $d$ to a predicted percentage of words understood, calibrated on
specific listening-test corpora. `stoi()` returns only $d$, as

...
- [Filter Banks](/phonometry/signal/filters/filter-banks/): the one-third-octave bands the SII is
  evaluated on.
- [Levels](/phonometry/signal/levels/levels/): the spectrum and band levels behind the equivalent

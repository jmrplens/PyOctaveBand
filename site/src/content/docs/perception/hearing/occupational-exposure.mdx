...
[Levels](/phonometry/signal/levels/levels/)) turns *one* recording into a daily level. ISO 9612:2009,
...
- [Levels](/phonometry/signal/levels/levels/): the `lex_8h` / `sound_exposure` dose primitives
  (IEC 61252) and the $L_{Cpeak}$ these strategies report alongside.
- [Measurement uncertainty](/phonometry/signal/metrology/gum-uncertainty/): the GUM machinery behind

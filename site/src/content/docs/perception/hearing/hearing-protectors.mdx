...
references:
  - type: standard
    ...
    url: "https://www.iso.org/standard/70090.html"
  ...
  - type: standard
    ...
    url: "https://www.iso.org/standard/69233.html"
...
# from 63 Hz to 8 kHz. This is the example Annexes A to D of ISO 4869-2 are
...
computations always start at 125 Hz regardless, which is why the reference
spectra of Tables 2 and 3 begin there.

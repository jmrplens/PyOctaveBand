...
and [Field Insulation Measurement (ISO 16283)](/phonometry/guides/insulation-field/).
...
[elastic FDTD field](/phonometry/guides/elastic-waves/): a 10 mm
...
- API reference: [`building.panel_transmission`](/phonometry/reference/api/building/panel-transmission/), [`building.masonry_cavity_wall`](/phonometry/reference/api/building/masonry-cavity-wall/), [`building.aperture_transmission`](/phonometry/reference/api/building/aperture-transmission/), [`vibration.radiation_efficiency`](/phonometry/reference/api/vibration/radiation-efficiency/) and [`vibration.point_mobility`](/phonometry/reference/api/vibration/point-mobility/).

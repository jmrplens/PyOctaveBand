---
title: "Heavy and Soft Impact Sources (ISO 16283-2, JIS A 1418-2)"
...
[Field Insulation Measurement (ISO 16283)](/phonometry/guides/insulation-field/) and
...
- [Field Insulation Measurement (ISO 16283)](/phonometry/guides/insulation-field/): the
  tapping-machine chain of the same standard.
- [Laboratory Insulation Measurement](/phonometry/guides/insulation-lab/): the ISO 10140
...
- API reference: [`building.heavy_impact`](/phonometry/reference/api/building/heavy-impact/).

...
description: "EN 12354 prediction of in-situ sound insulation from element data: airborne and impact flanking transmission (EN 12354-1/2), façade insulation (EN 12354-3) and outdoor radiation (EN 12354-4)."
references:
  - type: book
    authors: ["Hopkins, C."]
    year: 2007
...
[laboratory](/phonometry/guides/insulation-lab/) measures $R$ and $K_{ij}$
element by element and junction by junction, this model assembles them into
a predicted $R'_w$, and the
[field measurement](/phonometry/guides/insulation-field/) checks the built

...
[Façade Sound Insulation](/phonometry/guides/facade-insulation/). The measured
...
- API reference: [`building.prediction.global_model`](/phonometry/reference/api/building/global-model/) and [`building.prediction.facade`](/phonometry/reference/api/building/facade/).

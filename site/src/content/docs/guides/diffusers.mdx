...
[Metadiffusers](/phonometry/guides/metadiffusers/).
...
- **The design frequency sets the depth.** The deepest well is
  ...
  the [metadiffuser](/phonometry/guides/metadiffusers/) attacks: at 500 Hz an
...
[Metadiffusers guide](/phonometry/guides/metadiffusers/).

## See also

- [Metadiffusers](/phonometry/guides/metadiffusers/): the deep-subwavelength
  ...
  centimetres thick.
- [In-situ Road-Surface Absorption](/phonometry/guides/road-absorption/): the
...
- API reference: [`materials.scattering_diffusion`](/phonometry/reference/api/materials/scattering-diffusion/) and [`materials.diffuser_design`](/phonometry/reference/api/materials/diffuser-design/).

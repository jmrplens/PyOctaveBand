...
[envelope spectrum](/phonometry/guides/cepstrum-echoes/), which reads the same
...
[fractional-delay and resampling tools](/phonometry/guides/test-signals/).
...
spectrum](/phonometry/guides/cepstrum-echoes/). Estimating delays across

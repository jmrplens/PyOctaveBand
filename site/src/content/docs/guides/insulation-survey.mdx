...
$k = 10\lg(T/T_0)$ measured with `building.reverberation_index` or
...
- API reference: [`building.survey_insulation`](/phonometry/reference/api/building/survey-insulation/).

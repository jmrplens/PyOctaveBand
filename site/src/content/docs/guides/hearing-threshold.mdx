...
[noise-induced hearing loss guide](/phonometry/guides/noise-induced-hearing-loss/)
...
[noise-induced hearing loss](/phonometry/guides/noise-induced-hearing-loss/)
...
- [Noise-induced hearing loss](/phonometry/guides/noise-induced-hearing-loss/): the
  ISO 1999 model that adds the noise component on top of this age component.
- [Speech Intelligibility Index](/phonometry/guides/speech-intelligibility/): a raised
  threshold as an input, and what it costs in speech audibility.
- [Loudness](/phonometry/guides/loudness/): the ISO 226:2023 threshold of hearing, the
  free-field pure-tone counterpart of the audiometric zero of section 2.
- [Occupational noise exposure](/phonometry/guides/occupational-exposure/): the ISO 9612

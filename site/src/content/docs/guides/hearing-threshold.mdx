...
<ThemeImage
  ...
  alt="ISO 7029 hearing-threshold deviation of a 70-year-old man on an inverted audiogram axis from 125 Hz to 8000 Hz: the median rises from about 3 dB at 125 Hz to about 45 dB at 8000 Hz, the requested 90 % fractile runs well below it, and the shaded 10 to 90 percent band widens toward the high frequencies"
  width="88%"
/>

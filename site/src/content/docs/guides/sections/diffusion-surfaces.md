...
Where the [Absorbers](/phonometry/guides/sections/absorbers/) subsection asks
...
[Diffusers and Their Coefficients](/phonometry/guides/diffusers/) is the
...
[Metadiffusers](/phonometry/guides/metadiffusers/) shrinks the Schroeder
...
[In-situ Road-Surface Absorption](/phonometry/guides/road-absorption/) takes
...
[metamaterial absorbers](/phonometry/guides/metamaterial-absorbers/) built
from the same slit and resonator cell, the scattering coefficient feeds the
room predictions of
[Room acoustics](/phonometry/guides/sections/room-acoustics/), and the road

...
description: "The total acoustic emission of a source: sound power determination by the pressure, reverberation-room and intensity-scanning routes (ISO 3740 and ISO 9614 series), the ISO 4871 noise emission declaration, and two-microphone sound intensity per IEC 61043 with the ISO 9614-1 field indicators."
---
...
when that route involves an intensity probe. The determined power level is
what the quieting measures of the
[Noise control](/phonometry/guides/sections/noise-control/) pages are judged
against.

...
already provides - the [envelope spectrum and cepstrum](/phonometry/guides/cepstrum-echoes/) and
...
2. **Detect and transform the envelope.** The repetition rate of the impacts
   ...
   [cepstrum and envelope-spectrum guide](/phonometry/guides/cepstrum-echoes/).
...
[Time synchronous averaging](/phonometry/guides/synchronous-averaging/) removes everything not
locked to one shaft, which separates a gearbox's two shafts before the
sidebands are read; and the [cepstrum](/phonometry/guides/cepstrum-echoes/) collapses a whole
...
- [Cepstrum, echoes and the envelope spectrum](/phonometry/guides/cepstrum-echoes/): the
  envelope spectrum these lines are drawn on, and the cepstral collapse of a
  harmonic family.
- [Time synchronous averaging](/phonometry/guides/synchronous-averaging/): separating one
...
- [Bending-wave transmission at plate junctions](/phonometry/guides/junction-transmission/): what
  happens to the vibration once it leaves the machine.
- API reference: [`vibration.machine_diagnostics`](/phonometry/reference/api/vibration/machine-diagnostics/).

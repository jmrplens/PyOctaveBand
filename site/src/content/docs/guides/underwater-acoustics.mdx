...
- General underwater propagation modelling (ray, normal mode, parabolic equation) is covered in [Underwater propagation solvers](/phonometry/guides/underwater-solvers/).

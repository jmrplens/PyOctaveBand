...
included, inside the [FDTD solver](/phonometry/guides/fdtd-simulation/) and
...
[2D FDTD solver](/phonometry/guides/fdtd-simulation/) is a plane-wave tube,
...
- [FDTD Simulation](/phonometry/guides/fdtd-simulation/): the 2D solver behind
  the virtual tubes of section 5.
- [Calibration](/phonometry/guides/calibration/): microphone calibration ahead
  of the two-microphone transfer function.
- API reference: [`materials.impedance_tube`](/phonometry/reference/api/materials/impedance-tube/).

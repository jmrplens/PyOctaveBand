...
lives in [environmental measurement](/phonometry/guides/environmental-levels/)); the mean
...
`ΔL`<sub>ta</sub> in dB (a quieter tone passes). Rendering needs reportlab and,

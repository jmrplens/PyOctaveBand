...
in a single hole; the [slit absorber](/phonometry/guides/metamaterial-absorbers/)
inherits it per slit; and when an
[impedance tube](/phonometry/guides/impedance-tube/) measurement disagrees
...
`alternating_airflow_resistance`), including the 1-4 Hz and Formula (3)/(4)
validity warnings, and the accredited-style ISO 9053-1 fiche.
...
- [Sound Absorption Measurement and Rating](/phonometry/guides/absorption-measurement/):
  ...
  absorber.
- API reference: [`materials.airflow_resistance`](/phonometry/reference/api/materials/airflow-resistance/).

...
[Electroacoustics](/phonometry/guides/electroacoustics/); the loudspeaker
counterpart has [its own guide](/phonometry/guides/loudspeakers/).
...
[electroacoustics distortion set](/phonometry/guides/electroacoustics/),
where it also weights THD.

## 4. Microphone characteristics report (IEC 60268-4)

The microphone companion of the
[loudspeaker report](/phonometry/guides/loudspeakers/): the rated
...
**Covered.** The IEC 60268-4:2014 rated microphone characteristics via
...
**Not covered.** The measurement procedures that produce the input curves
(the free-field response, the polar cuts, the noise spectrum, the
distortion-against-level sweep) are the laboratory's; this guide reduces
and reports them. The implemented edition is frozen at IEC 60268-4:2014;
...
[Calibration and dBFS](/phonometry/guides/calibration/).
...
- [Loudspeaker Characterisation (IEC 60268-5)](/phonometry/guides/loudspeakers/):
  ...
  the chain.
- [Calibration and dBFS](/phonometry/guides/calibration/): turning a
  microphone's rated sensitivity into calibrated sound pressure levels.
- [Build a sound level meter](/phonometry/guides/sound-level-meter/): the

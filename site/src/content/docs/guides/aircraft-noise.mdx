...
fiche](/phonometry/guides/insulation-ratings/#iso-717-report-report); a supplied
...
[Airport noise](/phonometry/guides/airport-noise/).
...
chain has moved to [Airport noise](/phonometry/guides/airport-noise/).
...
- API reference: [`aircraft.aircraft_noise`](/phonometry/reference/api/aeroacoustics/aircraft-noise/) and [`aircraft.atmospheric_absorption`](/phonometry/reference/api/aeroacoustics/atmospheric-absorption/).

...
- [Sound Power in the Reverberation Room (ISO 3741)](/phonometry/guides/sound-power-reverberation/):
  ...
  corrections.
- [Sound Power by Intensity Scanning (ISO 9614-2 / ISO 9614-3)](/phonometry/guides/sound-power-intensity/):
...
- [Levels](/phonometry/guides/levels/): energy averaging and the A-weighting behind $L_{WA}$.

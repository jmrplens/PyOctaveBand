...
carry an uncertainty of that order on their own; the [ISO 12999-1 uncertainty section](/phonometry/guides/insulation-field/#measurement-uncertainty-iso-12999-1) puts a number on the
...
requirements (the number and placement of loudspeaker and microphone
positions, the low-frequency procedure, the choice between the global and the
element method) are not checked. The EN 12354-3 and EN 12354-4 worked examples
...
- API reference: [`building.facade_prediction`](/phonometry/reference/api/building/facade-prediction/) and [`building.insulation`](/phonometry/reference/api/building/insulation/).

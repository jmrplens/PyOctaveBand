...
[Multiple Shock Vibration](/phonometry/guides/multiple-shock-vibration/) for
records containing repeated shocks, which the r.m.s. and VDV measures on
this page do not substitute for.

## See also

- API reference: [`vibration.human_vibration`](/phonometry/reference/api/vibration/exposure/).

...
[Aircraft noise](/phonometry/guides/aircraft-noise/); the physical
propagation ingredients (ground effect, atmospheric absorption, barriers)
are [Outdoor sound propagation](/phonometry/guides/outdoor-propagation/).
...
- [Environmental Levels](/phonometry/guides/environmental-levels/): the

...
- API reference: [`psychoacoustics.psychoacoustic_annoyance`](/phonometry/reference/api/psychoacoustics/annoyance/) and [`psychoacoustics.fluctuation_strength`](/phonometry/reference/api/psychoacoustics/fluctuation-strength/).

...
from phonometry import miso_coherence, noise_signal, signal
...
first (see [Correlation and delay](/phonometry/guides/correlation-delay/))
...
- [Spectral analysis](/phonometry/guides/spectral-analysis/): the single-input coherent output spectrum this page generalizes, and the shared Welch core.
- [Correlation and delay](/phonometry/guides/correlation-delay/): estimating and removing the bulk delays that bias coherence low.
- [Multichannel and Performance](/phonometry/guides/multichannel/): the per-channel path this cross-channel analysis complements.
- API reference: [`signal.miso`](/phonometry/reference/api/spectra/miso/).

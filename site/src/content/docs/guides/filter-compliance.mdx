...
architectures and their responses, is
[Filter Banks](/phonometry/guides/filter-banks/); the same machinery applied
to the frequency weightings is section 8 of
...
- [Frequency Weighting](/phonometry/guides/weighting/): the companion
  verification of the A, C, Z, B, D and G curves against the IEC 61672-1 and
  ANSI S1.4 tolerance tables.

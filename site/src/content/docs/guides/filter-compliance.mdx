...
parameter reference, is [Filter Banks](/phonometry/guides/filter-banks/),
and the five architectures with their compared responses are
[Filter Architecture Gallery](/phonometry/guides/filter-gallery/); the same
...
- [Filter Banks](/phonometry/guides/filter-banks/): the band mathematics and
  the architectures whose class is verified here.
- [Frequency Weighting](/phonometry/guides/weighting/): the companion
...
- [Sound Level Meter](/phonometry/guides/sound-level-meter/): the instrument

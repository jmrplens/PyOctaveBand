---
title: "Loudness"
description: "Loudness in sones: Zwicker (ISO 532-1), Moore-Glasberg (ISO 532-2), time-varying Moore-Glasberg-Schlittenlacher (ISO 532-3) and the Sottek Hearing Model loudness of ECMA-418-2, plus the ISO 226:2023 equal-loudness contours."
references:
  - type: book
    ...
    note: "The critical-band and masking psychoacoustics behind the Zwicker model and the loudness sensation the newer models refine."
  - type: article

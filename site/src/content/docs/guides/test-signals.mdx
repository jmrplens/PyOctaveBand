...
description: "The signal toolbox of the metrology domain: IEC 60268-1 tone bursts with exact gating, colored noise with an exact spectral slope, polyphase resampling behind an explicit anti-alias specification, and band-limited fractional delay with a linear or circular boundary."
references:
  - type: standard
...
[spectral analysis guide](/phonometry/guides/spectral-analysis/#5-colored-noise-generators)),
...
[Fast/Slow/Impulse ballistics](/phonometry/guides/time-weighting/) reference
...
from phonometry import noise_signal, resample_signal, signal
...
- `mode="linear"` (default) zero-pads the record past the shift, so samples
  ...
  kernel inside
  [`align_impulse_responses`](/phonometry/guides/correlation-delay/#3-impulse-response-delay-and-alignment).
...
The [window figures of merit](/phonometry/guides/spectral-analysis/#6-choosing-the-window)
...
[correlation and delay work](/phonometry/guides/correlation-delay/), where
...
- [Time Weighting](/phonometry/guides/time-weighting/): the detector ballistics the tone bursts exercise (IEC 61672-1 Table 4).
- [Correlation and delay](/phonometry/guides/correlation-delay/): the alignment work built on the fractional-delay kernel.
- [Synchronous averaging](/phonometry/guides/synchronous-averaging/): period alignment with the same band-limited shift when $f_s T$ is not an integer.
- [Spectral analysis](/phonometry/guides/spectral-analysis/): the colored-noise verification and the window metrics.
- API reference: [`signal.test_signals`](/phonometry/reference/api/spectra/signals/).

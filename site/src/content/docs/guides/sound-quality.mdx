...
<ThemeImage
  ...
  alt="ECMA-418-2 average specific tonality over the 53 Bark_HMS bands for a 1 kHz tone at 40 dB SPL: the tonality is concentrated in a single peak at the tone's critical band around 8.5 Bark_HMS and falls to nearly zero elsewhere, integrating to T = 1.00 tu_HMS"
  width="80%"
/>

...
reflected and transmitted waves this section prices at `tau12(0 deg) = 0.5`.
...
`n = pi S fc / c0²` used by the [flanking model](/phonometry/guides/flanking-lab/), only
...
- [Laboratory Flanking Transmission (ISO 10848)](/phonometry/guides/flanking-lab/):
  the measurement of `Kij` from velocity level differences, the empirical

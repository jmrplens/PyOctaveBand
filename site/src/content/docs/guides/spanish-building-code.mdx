...
- [Insulation Ratings (ISO 717)](/phonometry/guides/insulation-ratings/): the reference-curve route with $R_w$, $C$, $C_{tr}$ and the enlarged-range terms that DB-HR calls simply $C$ and $C_{tr}$.
- [Spanish Noise Regulation (RD 1367/2007)](/phonometry/guides/spanish-noise-regulation/): where the site's day noise index $L_d$ that Table 2.1 is entered with comes from.
- [Façade Sound Insulation](/phonometry/guides/facade-insulation/): the ISO 16283-3 measurement of $D_{2m,nT}$ and its EN 12354-3 prediction, which feed the $D_{2m,nT,Atr}$ index of this page.
...
- [Field Insulation Measurement (ISO 16283)](/phonometry/guides/insulation-field/): the band spectra of $R'$, $D_{nT}$ and $L'_{nT}$ that these global quantities summarise.

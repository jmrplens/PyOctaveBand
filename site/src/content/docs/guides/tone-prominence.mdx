...
(the [tone-audibility guide](/phonometry/guides/tone-audibility/));
...
test (the [sound-quality guide](/phonometry/guides/sound-quality/)); and a
turbine is its own regime, with a measurement procedure in IEC 61400-11 that
fixes the geometry and the wind bins (the
[wind-turbine guide](/phonometry/guides/wind-turbine-noise/)).
...
- [Environmental Levels](/phonometry/guides/environmental-levels/): the ISO 1996-1 rating levels whose tonal adjustments
...
- [Objective audibility of tones in noise](/phonometry/guides/tone-audibility/): the
  ISO/PAS 20065 audibility ΔL that the ISO 1996-2 tonal adjustment Kt is read from.
- [Wind-turbine noise](/phonometry/guides/wind-turbine-noise/): the IEC 61400-11 tonal

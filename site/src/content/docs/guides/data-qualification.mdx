...
Every average in this documentation - a [PSD](/phonometry/guides/spectral-analysis/), a
[Leq](/phonometry/guides/levels/), a
[GUM budget](/phonometry/guides/gum-uncertainty/) - assumes the record is
...
[Welch autospectrum](/phonometry/guides/spectral-analysis/):
...
[Welch PSD](/phonometry/guides/spectral-analysis/) and the random-error
formulas of the [correlation estimators](/phonometry/guides/correlation-delay/)
all assume the record is stationary, as does the very idea of *the* $L_{eq}$ of
a measurement in [Levels](/phonometry/guides/levels/). When a record fails
...
[calibrated spectrogram](/phonometry/guides/time-frequency/) - that do not
assume stationarity. And when it passes, the
[GUM machinery](/phonometry/guides/gum-uncertainty/) can propagate the
...
- API reference: [`metrology.data_qualification`](/phonometry/reference/api/metrology/random-data/).

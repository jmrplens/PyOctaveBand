...
`two_microphone_impedance` (see the [Acoustic Materials guide](/phonometry/guides/materials/)).
...
[Acoustic Materials guide](/phonometry/guides/materials/). The Fraunhofer

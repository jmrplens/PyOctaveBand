...
- [Prominent Discrete Tones](/phonometry/guides/tone-prominence/): the tone-to-noise and prominence-ratio verdicts that justify the Table A.1 tonal adjustments objectively.

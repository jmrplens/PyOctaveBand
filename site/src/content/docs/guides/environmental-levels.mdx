...
**Covered.** ISO 1996-1:2016's Lden, Ldn and composite rating level (clause
...
- [Integrated and Statistical Levels](/phonometry/guides/levels/): the Leq/LAeq, percentile and event levels the indicators of this page are assembled from.
- [Objective audibility of tones in noise (ISO/PAS 20065)](/phonometry/guides/tone-audibility/): the tonal audibility whose mean value maps to the Kt adjustment (Table J.1).

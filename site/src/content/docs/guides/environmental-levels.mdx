...
[Integrated and Statistical Levels](/phonometry/guides/levels/); everything
...
[Prominent Discrete Tones](/phonometry/guides/tone-prominence/) are
...
6.5, `environmental.lden`/`ldn`/`composite_rating_level`); and ISO
...
- [Integrated and Statistical Levels](/phonometry/guides/levels/): the $L_{eq}$/$L_{Aeq}$, percentile and event levels the indicators of this page are assembled from.
- [Objective audibility of tones in noise (ISO/PAS 20065)](/phonometry/guides/tone-audibility/): the tonal audibility whose mean value maps to the $K_t$ adjustment (Table J.1).
- [Prominent Discrete Tones](/phonometry/guides/tone-prominence/): the ECMA-418-1 tone-to-noise and prominence-ratio verdicts, complementary emission screening for the tonal question.
- [Occupational exposure (ISO 9612)](/phonometry/guides/occupational-exposure/): the workplace counterpart, from task samples to the daily exposure level with its uncertainty budget.
- API reference: [`environmental.measurement`](/phonometry/reference/api/environment/measurement/) and [`environmental.rating`](/phonometry/reference/api/environment/rating/).

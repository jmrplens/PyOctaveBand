...
own guide, [Metamaterial Absorbers](/phonometry/guides/metamaterial-absorbers/).
...
[Metamaterial Absorbers](/phonometry/guides/metamaterial-absorbers/) covers
...
(`layered_absorber` with `PorousLayer`, `PoroelasticLayer`,
...
[Diffusers and Their Coefficients](/phonometry/guides/diffusers/) and, for
the resonator-loaded deep-subwavelength panels, in
[Metadiffusers](/phonometry/guides/metadiffusers/). The critically coupled

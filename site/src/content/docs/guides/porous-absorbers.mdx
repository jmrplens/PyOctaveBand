...
[flow rig](/phonometry/guides/airflow-resistance/) measures) the classical equivalent-fluid models
...
[reverberation room](/phonometry/guides/absorption-measurement/) guides;
rating the predicted spectrum lives in the latter's
[ISO 11654 section](/phonometry/guides/absorption-measurement/#3-weighted-rating-and-absorption-class-iso-11654).
...
[ASTM E2611 transfer-matrix reduction](/phonometry/guides/impedance-tube/)) plugs into the layer
...
[ASTM E2611 machinery](/phonometry/guides/impedance-tube/) (`TransferMatrix`).
...
[impedance-tube page](/phonometry/guides/impedance-tube/), the MPP to Maa's own approximation
...
- [Airflow Resistance](/phonometry/guides/airflow-resistance/),
  [Impedance Tube](/phonometry/guides/impedance-tube/) and
  [Sound Absorption Measurement and Rating](/phonometry/guides/absorption-measurement/):

...
- [Underwater sound propagation](/phonometry/guides/underwater-propagation/):
  ...
  into a range.
- API reference: [`underwater.marine_mammal_weighting`](/phonometry/reference/api/underwater/marine-mammal-weighting/) and [`underwater.marine_mammal_audiograms`](/phonometry/reference/api/underwater/marine-mammal-audiograms/).

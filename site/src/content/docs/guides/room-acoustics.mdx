...
description: "Impulse-response acquisition (ISO 18233), room parameters EDT/T20/T30/C50/C80/Ts (ISO 3382-1/2) and open-plan speech metrics (ISO 3382-3)."
references:
  - type: book
    authors: ["Kuttruff, H."]
    year: 2016
...
[ISO 11654 absorption fiche](/phonometry/guides/absorption-measurement/#iso-11654-report-report);
...
$r_D$, $r_P$) from `room.open_plan_metrics`.
...
STIPA tools of the
[Speech Transmission Index guide](/phonometry/guides/speech-transmission/).
The ISO 354 reverberation-room absorption that consumes the measured
$T_1$/$T_2$ pair has moved to its own guide,
[Sound Absorption Measurement and Rating](/phonometry/guides/absorption-measurement/).
...
- [Conformance report](https://github.com/jmrplens/phonometry/blob/main/docs/CONFORMANCE.md): the closed-form decays and parameter
  definitions the ISO 18233 / ISO 3382 implementations are validated against.

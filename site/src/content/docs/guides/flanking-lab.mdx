...
- [Room-to-room and open-plan acoustics](/phonometry/guides/open-plan-acoustics/): the open-plan context
...
- API reference: [`building.flanking_transmission`](/phonometry/reference/api/building/flanking-transmission/)
  and [`building.ceiling_plenum`](/phonometry/reference/api/building/ceiling-plenum/).

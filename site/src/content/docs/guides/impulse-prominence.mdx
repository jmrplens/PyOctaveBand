...
measurement of [ISO 1996-2](/phonometry/guides/environmental-levels/).
...
- API reference: [`environment.assessment.impulse_prominence`](/phonometry/reference/api/environment/impulse-prominence/).

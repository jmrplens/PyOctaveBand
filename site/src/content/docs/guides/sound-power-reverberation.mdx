...
absorption area, the Waterhouse boundary correction and the C1/C2
...
- [Room Acoustics](/phonometry/guides/room-acoustics/): measuring the
  reverberation time `T60` that sets the Sabine absorption area.
...
- [Theory](/phonometry/reference/theory/environment-transport/): the
  Waterhouse and C1/C2 derivations.

...
[ISO 3382-1/-2 room-acoustics fiche](/phonometry/guides/room-acoustics/#iso-3382-report-report); the
...
$$
L_{SN} = 10\lg\!\left[\frac{Q}{4\pi r^2}\right] + 10\lg\!\left[\frac{A_\text{tab}}{4}\right].
$$
...
below it. The curves are parallel because occupancy always costs $10\lg N$:
...
- [Speech Transmission Index](/phonometry/guides/speech-transmission/): the
...
- [Levels](/phonometry/guides/levels/): the A-weighted levels behind the
  spatial decay.

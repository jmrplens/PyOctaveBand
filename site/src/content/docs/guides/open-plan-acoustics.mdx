...
description: "Speech privacy in open-plan offices per ISO 3382-3: the spatial decay rate D2,S of A-weighted speech, the level at 4 m, the distraction and privacy distances from STI, the to-scale measurement line and the accredited fiche."
references:
  - type: standard
...
ISO 3382-3 fiche through `.report()`.

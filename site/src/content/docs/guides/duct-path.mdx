...
references:
  - type: book
    ...
    primary: true
    note: "The fan sound-power model (Ch. 13, Eq. 13.1 with Tables 13.5-13.8), the duct attenuation, flexible duct, split loss, end reflection, silencer self-noise and room effect of Ch. 14, and the worked duct-borne sheet of Table 14.9 this guide is built around."
  - type: book
...
[Silencers](/phonometry/guides/silencers/) and the rest of the installation
methods in
[Industrial noise control](/phonometry/guides/noise-control/) are the
companion pages.
...
[room constant](/phonometry/guides/room-image-sources/).
...
<ReportPreview
	...
	caption="Duct-borne noise path fiche (DuctPathResult.report): the supply path of the worked sheet element by element, rated NC-22.6 and passing NC 30 with 5 dB to spare at 63 Hz."
/>
...
[Silencers](/phonometry/guides/silencers/), is one-dimensional. It assumes
...
- [Steady-state room field](/phonometry/guides/room-image-sources/): the

...
[Room Acoustics](/phonometry/guides/room-acoustics/); the same IR measured
...
[Room Acoustics guide](/phonometry/guides/room-acoustics/)) each band
...
[Room Acoustics guide](/phonometry/guides/room-acoustics/) picks up exactly
there, and its open-plan sibling walks the
[ISO 3382-3 line of workstations](/phonometry/guides/open-plan-acoustics/).
Measured either side of a partition, the same sweeps feed the level
differences of
[field sound insulation](/phonometry/guides/insulation-field/). And the
...
analysis of the
[swept-sine distortion guide](/phonometry/guides/swept-sine-distortion/).
...
- [Room Acoustics](/phonometry/guides/room-acoustics/): the decay analysis
...
- [System Measurement](/phonometry/guides/system-measurement/):
  ...
  result types.
- [Swept-Sine Distortion & Phase](/phonometry/guides/swept-sine-distortion/):
  the Farina reading of the distortion the sweep separates.
- [Field Insulation Measurement (ISO 16283)](/phonometry/guides/insulation-field/):
  the same measurement either side of a partition.
- [Image Sources & Steady-State Field](/phonometry/guides/room-image-sources/):
...
- API reference: [`room.room_ir`](/phonometry/reference/api/rooms/room-ir/).

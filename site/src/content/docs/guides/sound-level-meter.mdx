...
Deep guides: [Frequency Weighting (A, C, Z)](/phonometry/guides/weighting/)
...
continue in [Environmental Levels](/phonometry/guides/environmental-levels/).
...
- API reference: [`metrology.calibration`](/phonometry/reference/api/metrology/calibration/),
  ...
  [`signal.levels`](/phonometry/reference/api/signal/levels/),

...
| `filter_type` | str | — | `'butter'` (default), `'cheby1'`, `'cheby2'`, `'ellip'`, `'bessel'` | See the [Filter Architecture Gallery](/phonometry/guides/filter-gallery/) |
...
[Filter Architecture Gallery](/phonometry/guides/filter-gallery/). The
...
- [Filter Class Verification (IEC 61260-1)](/phonometry/guides/filter-compliance/):
  ...
  designed here.
- API reference: [`phonometry`](/phonometry/reference/api/filters/phonometry/), [`filters.core`](/phonometry/reference/api/filters/core/) and [`filters.weighting`](/phonometry/reference/api/filters/parametric-filters/).

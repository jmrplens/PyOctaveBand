...
[dynamic-stiffness guide](/phonometry/guides/dynamic-stiffness/). Together they set the mass-spring
...
[EN 12354-2 prediction](/phonometry/guides/insulation-prediction/) consumes whichever $\Delta L_w$ you have.
...
[Predicting Resilient-Layer Performance](/phonometry/guides/resilient-layers/). The superseded full-size ISO 140-8 method exists here
only as the comparison axis of the Foret et al. (2011) worked example.
...
- [Predicting Sound Insulation (EN 12354)](/phonometry/guides/insulation-prediction/):
  the impact model whose Formula (21) consumes ΔLw.
...
- API reference: [`building.floor_covering_improvement`](/phonometry/reference/api/building/floor-covering-improvement/).

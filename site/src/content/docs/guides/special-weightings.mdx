...
- API reference: [`filters.weighting`](/phonometry/reference/api/filters/parametric-filters/) and [`filters.compliance`](/phonometry/reference/api/filters/compliance/).

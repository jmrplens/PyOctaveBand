...
<ThemeImage
  ...
  alt="Octave-band source-line power of an urban arterial: bars for the total and marker lines for the light, medium heavy, heavy and motorcycle contributions, showing light vehicles governing below 500 Hz and heavy vehicles at 1 kHz"
  width="88%"
  loading="eager"
/>

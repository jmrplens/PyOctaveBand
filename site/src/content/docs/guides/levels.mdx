...
[Environmental Levels](/phonometry/guides/environmental-levels/): the Lden
and Ldn descriptors, the composite rating levels of ISO 1996-1 with their
...
and LEX,8h (`sound_exposure`, `lex_8h`); and the fractional-octave-band
spectrogram of `OctaveFilterBank.spectrogram`.

**Not covered.** The ISO 1996-1 whole-day indicators (Lden, Ldn, rating
...
- [Environmental Levels (ISO 1996-1/-2)](/phonometry/guides/environmental-levels/): the Lden/Ldn indicators, rating levels and the ISO 1996-2 determination chain built on the levels of this page.

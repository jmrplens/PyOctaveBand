...
- **Long-term community annoyance**: $L_{den}$/$L_{dn}$ and the ISO
  ...
  [Environmental Levels](/phonometry/guides/environmental-levels/).
...
of [Environmental Levels](/phonometry/guides/environmental-levels/) does.
...
[Loudness](/phonometry/guides/loudness/). Whether a single $L_{eq}$ is a fair
...
[Environmental Levels](/phonometry/guides/environmental-levels/). IEC
61252 was revised in 2025; only the formulae of the implemented first
edition (1993) are here, not the newer one.

## See also

- [Environmental Levels (ISO 1996-1/-2)](/phonometry/guides/environmental-levels/): the $L_{den}$/$L_{dn}$ indicators, rating levels and the ISO 1996-2 determination chain built on the levels of this page.
...
- API reference: [`metrology.levels`](/phonometry/reference/api/levels/levels/).

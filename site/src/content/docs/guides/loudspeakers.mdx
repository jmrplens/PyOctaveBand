...
description: "The IEC 60268-5 loudspeaker chain: the characteristic sensitivity and its 1 W / 1 m conventions, the baffled radiating piston with its radiation impedance and directivity, and the rated-characteristics report that renders the standard's data sheet with the on-axis response, impedance, THD and polar panels to the IEC 60263 scale conventions."
references:
  - type: book
...
drawn to the IEC 60263 scale conventions.
...
[swept-sine THD](/phonometry/guides/swept-sine-distortion/) chain.
...
- [Sound Power](/phonometry/guides/sound-power/): the emission descriptor of
  sources that are not supposed to make sound.

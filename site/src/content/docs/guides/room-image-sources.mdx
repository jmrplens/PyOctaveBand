...
description: "The deterministic image-source room impulse response of a rectangular room (Kuttruff, Vorländer) and the statistical steady-state level with the room constant, critical distance and Schroeder frequency (Bies)."
references:
  - type: book
    authors: ["Kuttruff, H."]
    year: 2016

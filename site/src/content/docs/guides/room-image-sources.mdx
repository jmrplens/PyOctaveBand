...
[Room Acoustics guide](/phonometry/guides/room-acoustics/) with a synthetic
one, and the second complements the single decay rate of the
[Reverberation-time prediction guide](/phonometry/guides/reverberation-prediction/)
with a level-versus-distance prediction, bridging the
[sound power](/phonometry/guides/sound-power/) of a source and the level it
produces indoors.
...
receiver alone fixes the arrival time and the `1/(4πr)` spreading of that
reflection.*
...
[Fitzroy and Arau-Puchades models](/phonometry/guides/reverberation-prediction/)
...
$10\lg(\rho c / 400)$ term (about +0.14 dB at 20 °C).
...
- the Eyring reverberation time recovered from the decay of the synthetic
  ...
  independent [2D FDTD solver](/phonometry/guides/fdtd-simulation/)
...
the
[reverberation-prediction guide](/phonometry/guides/reverberation-prediction/)
...
[2D FDTD solver](/phonometry/guides/fdtd-simulation/). Bolt's preferred
dimension ratios are discussed but not tabulated.

## See also

- [Room Acoustics](/phonometry/guides/room-acoustics/): the *measured* impulse
...
- [Sound Power](/phonometry/guides/sound-power/): the `Lw` that drives the
  steady-state level.

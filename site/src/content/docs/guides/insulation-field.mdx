...
[Façade Sound Insulation](/phonometry/guides/facade-insulation/), and the
...
[Façade Sound Insulation](/phonometry/guides/facade-insulation/). When a full
...
[Insulation Ratings (ISO 717)](/phonometry/guides/insulation-ratings/). And the
...
([Façade Sound Insulation](/phonometry/guides/facade-insulation/)), the survey
method ISO 10052
([Sound Insulation Survey Method](/phonometry/guides/insulation-survey/)), the
rating engines ISO 717-1/-2
([Insulation Ratings](/phonometry/guides/insulation-ratings/)) and the
sound-intensity route ISO 15186-1/-2
([Sound Insulation by Intensity](/phonometry/guides/insulation-intensity/)).

## See also

- [Insulation Ratings (ISO 717)](/phonometry/guides/insulation-ratings/): the
  reference-curve engine behind every weighted single number on this page.
- [Façade Sound Insulation](/phonometry/guides/facade-insulation/): the third
...
- [Room Acoustics](/phonometry/guides/room-acoustics/): the room parameters and
...
- API reference: [`building.insulation`](/phonometry/reference/api/building/insulation/) and [`building.building_uncertainty`](/phonometry/reference/api/building/building-uncertainty/).

---
title: "Predicting Resilient-Layer Performance (Coverings, Floating Floors, Linings)"
...
- API reference: [`building.resilient_layers`](/phonometry/reference/api/building/resilient-layers/).

...
description: "Vibration as a source of building noise, as a human exposure and as a diagnosis of the machine: the FRF vocabulary (ISO 7626), bending-wave junction transmission, isolator transfer stiffness (ISO 10846), sound power from surface vibration (ISO/TS 7849), the EN 15657 and EN 12354-5 equipment chain, the ISO 2631 and ISO 5349 human-vibration metrics, and the kinematic fault frequencies of rotating machinery."
---
...
insulation](/phonometry/buildings/insulation/) models of the buildings section.
...
Start with
[Mechanical mobility and the FRF family](/phonometry/vibration/structural/mechanical-mobility/)
if you care about the noise a machine causes in a building, with
[Human Vibration](/phonometry/vibration/human/human-vibration/) if you care
about the dose a person receives, or with [Machine fault
frequencies](/phonometry/vibration/machinery/machine-diagnostics/) if you care
...
[Laboratory flanking transmission](/phonometry/buildings/insulation/flanking-lab/)
...
are in [Signal analysis](/phonometry/signals/), and [Spectral
analysis](/phonometry/signals/spectra/spectral-analysis/) is the page the
machinery diagnostics build on. The derivations are in [Vibration
theory](/phonometry/reference/theory/vibration/): the human-vibration weightings, the ISO 2631-5

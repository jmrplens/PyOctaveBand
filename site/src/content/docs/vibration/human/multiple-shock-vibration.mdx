...
the measurement time $t_\mathrm{m}$ (Formula 4): $D_{z\mathrm{d}} = D_z\,(t_\mathrm{d}/t_\mathrm{m})^{1/6}$. To
...
the daily dose $D_{z\mathrm{d}}$ (Formula 4), the daily compressive stress $S_\mathrm{d}$

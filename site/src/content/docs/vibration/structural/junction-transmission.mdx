...
$\eta_{ij} = c_{g,i} L_{ij} \tau_{ij} / (2\pi^2 f S_i)$ and the wave-approach
**vibration reduction index** (Eq. 5.116)
$K_{ij} = 10\log_{10}(1/\tau_{ij}) + 5\log_{10}(f_{c,j}/f_\text{ref})$ with
$f_\text{ref} = 1000\ \text{Hz}$ and
$f_{c,j}$ the critical frequency of the *receiving* plate. Combined with the

...
already provides - the [envelope spectrum and cepstrum](/phonometry/signal/spectra/cepstrum-echoes/) and
...
2. **Detect and transform the envelope.** The repetition rate of the impacts
   ...
   [cepstrum and envelope-spectrum guide](/phonometry/signal/spectra/cepstrum-echoes/).
...
[Time synchronous averaging](/phonometry/signal/spectra/synchronous-averaging/) removes everything not
locked to one shaft, which separates a gearbox's two shafts before the
sidebands are read; and the [cepstrum](/phonometry/signal/spectra/cepstrum-echoes/) collapses a whole
...
- [Cepstrum, echoes and the envelope spectrum](/phonometry/signal/spectra/cepstrum-echoes/): the
  envelope spectrum these lines are drawn on, and the cepstral collapse of a
  harmonic family.
- [Time synchronous averaging](/phonometry/signal/spectra/synchronous-averaging/): separating one

...
references:
  ...
  - type: standard
    ...
    note: "The machine groups of 4.2 and the support classification of 4.3, the zone boundaries of Tables A.1 and A.2 in both quantities with the measurement band Annex A states, the most-restrictive rule of 5.2.3, the significant change of 5.3 and the ALARM and TRIP settings of 5.4. This edition has been superseded by ISO 20816-3:2022, which is not held here; the boundaries are taken from the edition that is."
  - type: standard
    organization: "International Organization for Standardization"
    year: 2020
    title: "Mechanical vibration \u2014 Measurement and evaluation of machine vibration \u2014 Part 9: Gear units"
    designation: "ISO 20816-9:2020"
    note: "The rating system: the units of Table 1, the shaft and housing measurements of Clause 6, the evaluation zones of 8.2, the acceptance ceiling of 8.3, the boundary tables 2, 3 and 4, the classification of Table 5, and the rating curves of Annex A."
---
...
`is_significant_change`, `alarm_limit` and `trip_limit`. For gear units, the three rating
tables and the classification of ISO 20816-9, and the two rating curves of
its Annex A, through `GEAR_UNIT_ZONES`, `GEAR_UNIT_CLASSES`,
`gear_unit_zone_boundaries`, `gear_shaft_displacement_limit` and
`gear_housing_velocity_limit`.
</ScopeClaim>
<ScopeClaim status="not-covered" label="Not covered">
The zone boundaries of the machine-specific parts this page does not name, which it takes

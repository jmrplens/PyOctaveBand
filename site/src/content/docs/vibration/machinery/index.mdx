---
title: "Machinery"
description: "Reading a machine from its vibration: the kinematic bearing, gear, motor and blade-passing families computed from the geometry, and the band-pass and envelope route that brings a defect out of the noise floor."
---
...
envelope spectrum](/phonometry/signals/spectra/cepstrum-echoes/), one section
...
averaging](/phonometry/signals/spectra/synchronous-averaging/) does it first.

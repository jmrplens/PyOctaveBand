...
[Integrated and Statistical Levels](/phonometry/signal/levels/levels/); everything
...
- [Integrated and Statistical Levels](/phonometry/signal/levels/levels/): the $L_{eq}$/$L_{Aeq}$, percentile and event levels the indicators of this page are assembled from.

...
references:
  ...
  - type: report
    ...
    note: "The common EU framework contrasted with ISO 9613-2 in section 4."
  - type: standard
...
- [CNOSSOS-EU road emission](/phonometry/environment/sources/cnossos-road-emission/) and [CNOSSOS-EU rail emission](/phonometry/environment/sources/cnossos-rail-emission/): the source strengths the comparison in section 4 refers to.

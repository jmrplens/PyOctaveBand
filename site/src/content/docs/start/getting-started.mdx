...
guides cover them left to right ([Calibration](/phonometry/signal/metrology/calibration/) →
[Frequency Weighting](/phonometry/signal/levels/weighting/) → [Filter Banks](/phonometry/signal/filters/filter-banks/) →
[Time Weighting](/phonometry/signal/levels/time-weighting/) → [Levels](/phonometry/signal/levels/levels/)).
...
- [Filter Architecture Gallery](/phonometry/signal/filters/filter-gallery/): choose an architecture and inspect responses
- [Calibration and dBFS](/phonometry/signal/metrology/calibration/): get real-world SPL values

...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_tsa_setup_es.svg" alt="Alzado a escala de un reductor de una etapa: el eje de entrada a 1800 revoluciones por minuto con una única tira de cinta reflectante y un cabezal de tacómetro óptico apuntándole a 20 mm, un piñón de 37 dientes que arrastra una rueda de 89 dientes, un acelerómetro atornillado sobre el soporte del rodamiento más cercano al piñón con su eje en la dirección de la carga, y ambos cables llegando a un frontal de dos canales con un solo reloj a 25,6 kHz; un recuadro muestra el tren de pulsos del tacómetro sobre el registro de vibración con las fronteras de troceado alineadas" width="92%" />
...
- **La frecuencia de muestreo sale del contenido que quieres conservar.** Un
  ...
  conservar cinco armónicos de engrane pide $f_s \ge 2{,}56 \times 5550 =
...
certificación, así que no hay ningún apartado de cumplimiento contra el

...
Para un tono AM $A_0 (1 + m \cos(2\pi f_m t)) \cos(2\pi f_c t)$ con $f_m$
en un bin de análisis las formas cerradas son:

| `kind` | nivel medio | línea en $f_m$ | línea en $2f_m$ |
|---|---|---|---|
| `'magnitude'` | $A_0$ | $A_0 m$ | - |
...
detector), y elige $f_s$ al menos 2,56 veces el extremo superior de la banda.
...
```python
# Una resonancia estructural de 3 kHz excitada a una tasa de defecto de 120 Hz,
# bajo una línea de 50 Hz tres veces más fuerte: el paso banda es lo que las
# separa.

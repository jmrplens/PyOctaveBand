...
automáticamente: `time_delay` y el correlador directo solo informan
del mayor pico, la misma limitación que `echo_detection` señala en el cepstrum
dentro de [Cepstrum, ecos y espectro de la
envolvente](/phonometry/es/signals/spectra/cepstrum-echoes/). Estimar retardos entre
más de dos sensores, como haría un array o un beamformer, implica llamar

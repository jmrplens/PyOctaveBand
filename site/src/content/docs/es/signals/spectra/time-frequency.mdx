...
salvo que $B_e \ge r\,T_B$. Con $B_e = 1{,}5/T_B$ eso da un óptimo
...
rápido que tenga que quedar nítido, contrasta el $B_e$ resultante con las dos
...
toda la banda, y cada celda solo lleva la parte que cae dentro de un $B_e$: unos
...
$10\log_{10} B_e$ e integra en la banda que interese, o usa `'density'` e integra
...
recordando que un lóbulo principal más ancho sube $B_e$ y con él la separación

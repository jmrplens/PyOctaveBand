...
frecuencia y el banco no lleva ninguna corrección para ello, a diferencia del
diseño ajustado `high_accuracy` de los filtros de ponderación: la banda atenuada más
...
[Correlación, retardo y
envolvente](/phonometry/es/signals/spectra/correlation-delay/) y [Coherencia
múltiple y parcial](/phonometry/es/signals/spectra/miso-coherence/).
</ScopeClaim>
</Scope>

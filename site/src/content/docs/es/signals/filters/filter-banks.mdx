...
$$
f_m = 1000 \cdot G^{x/b}\ (b\ \text{impar}), \qquad
f_m = 1000 \cdot G^{(2x+1)/2b}\ (b\ \text{par}), \qquad
...
ángulos $\omega = 2\pi f / f_s$ que abarca la banda de paso. De ahí salen dos
...
banda de $1/b$ de octava es $B = f_m\,(G^{1/2b} - G^{-1/2b})$, que para tercios
de octava vale $0{,}231\,f_m$, y de ahí se siguen dos consecuencias.
...
$f_m = 1000 \cdot G^{x/b}$ para $b$ impar y
$f_m = 1000 \cdot G^{(2x+1)/2b}$ para $b$ par — de modo que 1 kHz es una
frecuencia central de banda en las fracciones impares y un *borde* de banda
en las pares — y los bordes son $f_1 = f_m G^{-1/2b}$ y
$f_2 = f_m G^{+1/2b}$ en ambos casos; cada banda de tercio de

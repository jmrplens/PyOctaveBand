...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/survey_channel_average_es.svg" alt="Panel superior: cinco curvas finas grises de tercios de octava correspondientes a cinco posiciones de una misma sala, junto con un promedio energético azul grueso y un promedio aritmético de los valores en decibelios en rojo discontinuo. Por encima de unos 400 Hz las cinco posiciones coinciden dentro de un decibelio y los dos promedios se superponen; por debajo, en la región modal, las posiciones se dispersan hasta quince decibelios y el promedio rojo discontinuo queda por debajo del azul. Panel inferior: la diferencia entre ambos banda a banda, nula por encima de 400 Hz y creciente hasta una subestimación máxima de 3,8 dB a 40 Hz" width="88%" />

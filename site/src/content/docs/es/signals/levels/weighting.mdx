...
de 15 848,9 Hz queda 16,2 dB por debajo de su objetivo de diseño (la clase 1
admite ahí −16,0 dB y la clase 2 no fija límite inferior) y a
...
cadena, de modo que informa de clase 2 a 32 kHz y de ninguna clase a 16 kHz
en lugar de un grado que el filtro no puede dar. Para una ponderación A de
clase 1 en toda la tabla, muestrea a 44,1 kHz o más.

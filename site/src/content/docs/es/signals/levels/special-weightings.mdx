...
$L_{pG}$ (o $L_{Geq}$ para el nivel equivalente).
...
**unos pocos decibelios importan aquí muchísimo más**: un $L_{pG}$ de 85 dB y
...
un $L_{pG}$ con estas referencias de percepción, nunca con un límite ponderado
...
la propia cadena** e informa el $L_{pG}$ solo hasta donde la cadena sea plana;
...
ventana, y el $L_{pG}$ con el ancho de banda de análisis con el que se calculó.
...
la cabeza del operador y déjalo anotado. Informa el $L_{AU}$
...
voladuras, y expresa los niveles como $L_{pG}$ (o $L_{Geq}$ para el nivel

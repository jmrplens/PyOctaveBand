...
pero ninguna llega a `verify_weighting_class`, y en su lugar se anclan a sus
tablas publicadas en el informe de conformidad. La dosis de ruido es solo la
primera edición (1993) de IEC 61252, no la revisión de 2025. Y una dosis es
...
[Exposición al ruido en el trabajo (ISO
9612)](/phonometry/es/perception/hearing/occupational-exposure/).
</ScopeClaim>
</Scope>

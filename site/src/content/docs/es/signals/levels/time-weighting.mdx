...
muy cortos se valoran con $L_{Cpeak}$ en su lugar: incluso Impulse, la balística
...
corto**, en una cantidad que solo depende de $T_b/\tau$. Por eso un nivel máximo
no significa nada sin su balística, y por eso los impulsos cortos frente a los
125 ms se valoran con $L_{Cpeak}$ en su lugar.
...
(apartado 5.8.1), implementado como el filtro recursivo de `time_weighting`
...
- [Normativa española de ruido](/phonometry/es/environment/assessment/spanish-noise-regulation/): una valoración en vigor que sigue exigiendo la ponderación I, a través de la corrección por impulsividad $K_i$ sobre $L_{AIeq} - L_{Aeq}$.

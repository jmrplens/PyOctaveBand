...
- [Bancos de filtros](/phonometry/es/signal/filters/filter-banks/): las bandas de tercio de octava
  sobre las que se evalúa el SII.
- [Niveles](/phonometry/es/signal/levels/levels/): los niveles espectrales y de banda que sustentan las

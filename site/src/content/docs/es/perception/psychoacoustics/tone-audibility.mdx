...
banda crítico $\Delta f_c$ y las frecuencias de esquina (Fórmulas 2 a 5), el
nivel medio de banda estrecha $L_S$ y el nivel del tono $L_T$ (Fórmulas 6 y 8,
Anexo D), el nivel de banda crítica del enmascaramiento $L_G$, el índice de

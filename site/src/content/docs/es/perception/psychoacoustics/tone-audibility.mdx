...
- Teoría: [Prominencia tonal: TNR y PR](/phonometry/es/reference/theory/perception/#prominencia-tonal-tnr-y-pr-ecma-418-1): la familia vecina de métricas tonales, el TNR y el PR, deducida del mismo modelo de bandas críticas.

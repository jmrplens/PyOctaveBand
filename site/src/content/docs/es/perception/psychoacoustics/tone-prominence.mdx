...
`tone_to_noise_ratio()` y `prominence_ratio()`. Las posiciones de micrófono del
apartado 6 y los requisitos de instrumentación del apartado 7 están
documentados en el §2 como las condiciones bajo las que quedan definidas las
dos relaciones.

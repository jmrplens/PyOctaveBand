...
(sonoridad total $N$, nivel de sonoridad $L_\mathrm{N}$ y los percentiles
...
el número único $N = X\ \text{sonio}$ ($L_\mathrm{N} = Y\ \text{fonio}$) en caja, una
fila opcional de

...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/loudness_models_comparison.svg" alt="Sonoridad de un tono de 1 kHz en función del nivel para los modelos de Zwicker, Moore-Glasberg y Sottek, todos pasando cerca de 1 sonio a 40 dB SPL" width="80%" />
...
exige la norma, 0,9845. La constante de calibración $c_\mathrm{N}$ se conserva en su

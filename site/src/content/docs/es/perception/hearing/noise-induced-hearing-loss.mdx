...
NIPTS mediano del apartado 6.3.1 (Fórmula 2, extrapolada por debajo de 10
años con la Fórmula 3, Tabla 1) y su fractil poblacional del apartado 6.3.2
(Fórmulas 4-7, Tablas 2-3), junto con la combinación HTLAN del apartado 6.1
...
A, evaluada a partir de ISO 7029:2017, la edición que el apartado 6.2.2 cita
sin fecha.

**No cubierto.** Los apartados 6.2.3 y 6.2.4 permiten sustituir la base de

...
**Qué tiene que ser $L_{EX,8h}$.** El primer argumento es el nivel de exposición
...
2/3/4 kHz enmarcado con las condiciones de exposición ($L_{EX,8h}$, la
...
del oyente y de la exposición (edad y sexo, $L_{EX,8h}$ durante los años de
...
- [Exposición laboral al ruido](/phonometry/es/perception/hearing/occupational-exposure/): el
  estudio según ISO 9612 que produce el $L_{EX,8h}$ que consume este modelo, y

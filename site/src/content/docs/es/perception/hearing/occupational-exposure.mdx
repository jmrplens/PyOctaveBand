...
[Niveles](/phonometry/es/signal/levels/levels/)) convierte *una* grabación en un nivel
...
- [Niveles](/phonometry/es/signal/levels/levels/): las primitivas de dosis `lex_8h` /
  `sound_exposure` (IEC 61252) y el $L_{Cpeak}$ que estas estrategias declaran al
  lado.
- [Incertidumbre de medición](/phonometry/es/signal/metrology/gum-uncertainty/): la

...
- **Daño**: [Pérdida auditiva inducida por ruido (ISO 1999)](/phonometry/es/perception/hearing/noise-induced-hearing-loss/):
  ...
  HTLAN.
- **Protección**: [Protectores auditivos (ISO 4869-2)](/phonometry/es/perception/hearing/hearing-protectors/):
  los métodos por bandas de octava, HML y SNR que dicen lo que un protector
  deja realmente en el oído, y el valor de protección supuesta del que parten
  los tres.

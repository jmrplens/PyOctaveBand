...
- **Molestia comunitaria a largo plazo**: $L_{den}$/$L_{dn}$ y los niveles
  ...
  [Niveles ambientales](/phonometry/es/environment/environmental-levels/).
...
[Ponderación temporal](/phonometry/es/signal/levels/time-weighting/)). Y todo lo
de esta página asume la señal ya en pascales: el factor de sensibilidad que
la lleva ahí es el asunto de
[Calibración](/phonometry/es/signal/metrology/calibration/).
...
[Niveles ambientales](/phonometry/es/environment/environmental-levels/): los
...
Consulta [Calibración y dBFS](/phonometry/es/signal/metrology/calibration/) para
convertir unidades digitales a SPL físico, y
[Ponderación temporal](/phonometry/es/signal/levels/time-weighting/) para los
...
[calificación de datos](/phonometry/es/signal/metrology/data-qualification/) la
...
[Niveles ambientales](/phonometry/es/environment/environmental-levels/). La IEC
61252 se revisó en 2025; aquí solo están las fórmulas de la primera edición
implementada (1993), no las de la más reciente.

## Véase también

- [Niveles ambientales (ISO 1996-1/-2)](/phonometry/es/environment/environmental-levels/): los indicadores $L_{den}$/$L_{dn}$, los niveles de evaluación y la cadena de determinación de ISO 1996-2 construidos sobre los niveles de esta página.
- [Ponderación temporal](/phonometry/es/signal/levels/time-weighting/): el detector Fast/Slow/Impulse sobre el que se definen los niveles percentiles.
- [Calibración](/phonometry/es/signal/metrology/calibration/): el factor de sensibilidad que convierte unidades digitales en los pascales que todo nivel de esta página asume.
...
- [Multicanal y rendimiento](/phonometry/es/signal/filters/multichannel/): niveles por canal y cómo combinarlos energéticamente.

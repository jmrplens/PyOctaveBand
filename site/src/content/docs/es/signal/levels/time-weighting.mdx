...
[Niveles](/phonometry/es/signal/levels/levels/), mientras que las métricas
...
[Construye un sonómetro](/phonometry/es/signal/sound-level-meter/).
...
Consulta [Niveles integrados y estadísticos](/phonometry/es/signal/levels/levels/)
...
[Construye un sonómetro](/phonometry/es/signal/sound-level-meter/). La
...
- [Niveles](/phonometry/es/signal/levels/levels/): los niveles percentiles definidos sobre la salida del detector, y las métricas integradas que lo evitan.
- [Construye un sonómetro](/phonometry/es/signal/sound-level-meter/): la cadena completa de instrumento IEC 61672-1 alrededor de este detector.
- [Ponderación frecuencial](/phonometry/es/signal/levels/weighting/): los filtros A/C/Z aplicados antes del detector.
- [Procesado por bloques](/phonometry/es/signal/filters/block-processing/): el detector en streaming sobre tramas sin discontinuidades de estado.

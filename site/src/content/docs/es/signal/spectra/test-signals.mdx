...
en la [guía de análisis espectral](/phonometry/es/signal/spectra/spectral-analysis/#5-generadores-de-ruido-de-colores)),
...
[balística Fast/Slow/Impulse](/phonometry/es/signal/levels/time-weighting/) (la
...
- `mode="linear"` (por defecto) rellena el registro con ceros más allá del
  ...
  [`align_impulse_responses`](/phonometry/es/signal/spectra/correlation-delay/#3-retardo-y-alineación-de-respuestas-al-impulso).
...
[guía de análisis espectral](/phonometry/es/signal/spectra/spectral-analysis/#5-generadores-de-ruido-de-colores).

## Dónde se usan estas herramientas

Las [figuras de mérito de las ventanas](/phonometry/es/signal/spectra/spectral-analysis/#6-elegir-la-ventana)
...
[trabajo de correlación y retardo](/phonometry/es/signal/spectra/correlation-delay/),
...
- [Ponderación temporal](/phonometry/es/signal/levels/time-weighting/): la balística de detector que ejercitan las salvas de tono (IEC 61672-1, Tabla 4).
- [Correlación y retardo](/phonometry/es/signal/spectra/correlation-delay/): el trabajo de alineación construido sobre el núcleo de retardo fraccionario.
- [Promediado síncrono](/phonometry/es/signal/spectra/synchronous-averaging/): alineación de períodos con el mismo desplazamiento de banda limitada cuando $f_s T$ no es entero.
- [Análisis espectral](/phonometry/es/signal/spectra/spectral-analysis/): la verificación del ruido de colores y las métricas de ventanas.

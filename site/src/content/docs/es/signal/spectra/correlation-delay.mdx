...
Donde los [estimadores espectrales calibrados](/phonometry/es/signal/spectra/spectral-analysis/)
...
[`cross_spectral_density`](/phonometry/es/signal/spectra/spectral-analysis/) y los
...
[espectro de la envolvente](/phonometry/es/signal/spectra/cepstrum-echoes/), que lee
...
[herramientas públicas de retardo fraccionario y remuestreo](/phonometry/es/signal/spectra/test-signals/).
...
envolvente](/phonometry/es/signal/spectra/cepstrum-echoes/). Estimar retardos entre

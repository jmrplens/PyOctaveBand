...
[página de análisis espectral](/phonometry/es/signal/spectra/spectral-analysis/):
...
completa. Donde la [página de niveles](/phonometry/es/signal/levels/levels/)
...
[estimación de Welch](/phonometry/es/signal/spectra/spectral-analysis/) promediada
...
[`power_spectral_density`](/phonometry/es/signal/spectra/spectral-analysis/), así
que ambos son mutuamente consistentes bin a bin; el
[espectrograma en bandas de octava](/phonometry/es/signal/levels/levels/) de
...
[frecuencia instantánea de Hilbert](/phonometry/es/signal/spectra/correlation-delay/)
...
[Niveles](/phonometry/es/signal/levels/levels/). Seguir en el tiempo la
frecuencia instantánea de una sola componente es la envolvente de Hilbert
de `envelope`, en la página de
[Correlación y retardo](/phonometry/es/signal/spectra/correlation-delay/), no en
...
- [Análisis espectral](/phonometry/es/signal/spectra/spectral-analysis/): la estimación de Welch promediada para el fondo estacionario, y las figuras de mérito de las ventanas tras el enventanado del segmento.
- [Niveles](/phonometry/es/signal/levels/levels/): el espectrograma en bandas de octava fraccional con balística de sonómetro.
- [Correlación y retardo](/phonometry/es/signal/spectra/correlation-delay/): la frecuencia instantánea de Hilbert para seguir una componente.

...
- [Análisis espectral](/phonometry/es/signal/spectra/spectral-analysis/): el espectro de salida coherente de una entrada que esta página generaliza, y el núcleo de Welch compartido.
- [Correlación y retardo](/phonometry/es/signal/spectra/correlation-delay/): estimar y eliminar los retardos globales que sesgan la coherencia a la baja.
- [Multicanal y rendimiento](/phonometry/es/signal/filters/multichannel/): la ruta por canal que este análisis cruzado complementa.

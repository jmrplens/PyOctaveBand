...
[Bancos de filtros](/phonometry/es/signal/filters/filter-banks/). Cubre la matemática
...
[Procesado por bloques](/phonometry/es/signal/filters/block-processing/) la escala en
...
[Multicanal y rendimiento](/phonometry/es/signal/filters/multichannel/) la escala en
...
- [Verificación de clase de filtros (IEC 61260-1)](/phonometry/es/signal/filters/filter-compliance/):
  ...
  conformidad.
- [Procesado por bloques](/phonometry/es/signal/filters/block-processing/): flujos en

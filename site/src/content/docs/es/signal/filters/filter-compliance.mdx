...
[Bancos de filtros](/phonometry/es/signal/filters/filter-banks/), y las cinco
...
sección 6 de [Ponderación frecuencial](/phonometry/es/signal/levels/weighting/).
...
- [Ponderación frecuencial](/phonometry/es/signal/levels/weighting/): la
  ...
  [Ponderaciones especiales](/phonometry/es/signal/levels/special-weightings/).
- [Sonómetro](/phonometry/es/signal/sound-level-meter/): la cadena de

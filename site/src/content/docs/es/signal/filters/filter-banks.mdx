...
| `filter_type` | str | — | `'butter'` (por defecto), `'cheby1'`, `'cheby2'`, `'ellip'`, `'bessel'` | Consulta la [Galería de arquitecturas de filtro](/phonometry/es/signal/filters/filter-gallery/) |
...
| `stateful` / `steady_ic` (clase) | bool | — | por defecto `False` | Estado en streaming; consulta [Procesado por bloques](/phonometry/es/signal/filters/block-processing/) |
...
es [Verificación de clase de filtros](/phonometry/es/signal/filters/filter-compliance/):

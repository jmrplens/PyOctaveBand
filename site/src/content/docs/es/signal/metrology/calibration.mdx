...
[Construye un sonómetro](/phonometry/es/signal/sound-level-meter/) empieza
...
- [Construye un sonómetro](/phonometry/es/signal/sound-level-meter/): el recorrido que empieza en este paso de calibración y termina en un instrumento verificado por clase.
- [Niveles](/phonometry/es/signal/levels/levels/): todas las métricas que consumen el `calibration_factor` derivado aquí.
- [Multicanal y rendimiento](/phonometry/es/signal/filters/multichannel/): una sensibilidad por canal cuando los canales difieren.
- [Incertidumbre de medida (GUM y Monte Carlo)](/phonometry/es/signal/metrology/gum-uncertainty/): propagar la tolerancia del calibrador y la cota de deriva a la incertidumbre de un nivel.

...
[Calificación de datos](/phonometry/es/signal/metrology/data-qualification/) trae los
...
- **Calibración.** La tolerancia de clase del calibrador y la cota de
  deriva pre/post de [Calibración](/phonometry/es/signal/metrology/calibration/) son
...
- **Niveles ambientales.** La incertidumbre combinada de ISO 1996-2 de la
  página de [Niveles ambientales](/phonometry/es/environment/environmental-levels/)
...
- [Calificación de datos](/phonometry/es/signal/metrology/data-qualification/): las comprobaciones de estacionariedad que toda entrada promediada asume en silencio.
- [Calibración](/phonometry/es/signal/metrology/calibration/): las entradas de tolerancia y deriva de toda cadena calibrada.

...
Todo promedio de esta documentación - una [PSD](/phonometry/es/signal/spectra/spectral-analysis/), un
[Leq](/phonometry/es/signal/levels/levels/), un
[balance GUM](/phonometry/es/signal/metrology/gum-uncertainty/) - supone que el registro es
...
[autoespectro de Welch](/phonometry/es/signal/spectra/spectral-analysis/) del registro:
...
[PSD de Welch](/phonometry/es/signal/spectra/spectral-analysis/) y las fórmulas de error
aleatorio de los [estimadores de correlación](/phonometry/es/signal/spectra/correlation-delay/)
suponen que el registro es estacionario, igual que la idea misma de *el*
$L_{eq}$ de una medición en [Niveles](/phonometry/es/signal/levels/levels/). Cuando un
...
[espectrograma calibrado](/phonometry/es/signal/spectra/time-frequency/) - que no suponen
estacionariedad. Y cuando pasa, la
[maquinaria GUM](/phonometry/es/signal/metrology/gum-uncertainty/) puede propagar el error

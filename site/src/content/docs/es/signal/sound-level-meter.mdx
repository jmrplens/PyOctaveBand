...
Guía de fondo: [Calibración y dBFS](/phonometry/es/signal/metrology/calibration/), que
...
Guías de fondo:
[Ponderación frecuencial (A, C, Z)](/phonometry/es/signal/levels/weighting/) y
[Ponderación temporal](/phonometry/es/signal/levels/time-weighting/).
...
Guía de fondo:
[Niveles integrados y estadísticos](/phonometry/es/signal/levels/levels/), que añade
...
Guías de fondo: [Bancos de filtros](/phonometry/es/signal/filters/filter-banks/) para
las arquitecturas de filtro y el modo de fase cero,
[Procesado por bloques](/phonometry/es/signal/filters/block-processing/) para
streaming, y [Multicanal y rendimiento](/phonometry/es/signal/filters/multichannel/)
para arrays.
...
[Ponderación frecuencial](/phonometry/es/signal/levels/weighting/) (sección de
...
- [Procesado por bloques](/phonometry/es/signal/filters/block-processing/): convierte
...
[guía de calibración](/phonometry/es/signal/metrology/calibration/) para lo que

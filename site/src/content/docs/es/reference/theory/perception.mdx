...
| $L_U$ | Magnitud de la función de transferencia lineal, normalizada en 1 kHz | Líneas isofónicas (ISO 226) |
| $L_U$ | Nivel medio de la banda crítica contigua superior | Prominencia tonal, PR (ECMA-418-1) |
| $L_N$ | Nivel de sonoridad, en fonios | Líneas isofónicas, Zwicker |

...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/panel_insulation_concept_es.svg" alt="Cuatro paneles: la ley de masas de una hoja simple con su valle de coincidencia, la pared doble con la resonancia masa-muelle-masa y la ganancia de cámara, la eficiencia de radiación de la placa subiendo a la unidad por encima de la frecuencia crítica, y una pared compuesta cuya rendija abierta del 1 % limita R al tope del área abierta" width="92%" />

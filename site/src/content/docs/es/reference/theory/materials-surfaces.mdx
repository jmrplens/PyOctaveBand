...
($\alpha_s \le 0{,}50$, apartado 6.3.4), y la Parte 2 un método de campo libre
...
la **capa entera**, $R_s = \sigma d$, frente a la impedancia característica del
...
$H_c$ como la media geométrica del par intercambiado sobre una probeta

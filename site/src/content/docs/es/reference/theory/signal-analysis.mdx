...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/filter_type_comparison.svg" alt="Comparación de la respuesta en magnitud de las cinco arquitecturas de filtro para la banda de octava de 1 kHz, con un zoom en el cruce de −3 dB" width="88%" />
...
modo `high_accuracy` por defecto no aplica esa transformación al prototipo
impreso: ajusta un prototipo de la misma estructura cuya respuesta *en las
frecuencias deformadas* es la del impreso en las verdaderas, y transforma ese;
consulta
[Ponderación frecuencial](/phonometry/es/signals/levels/weighting/).

<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/weighting_responses.svg" alt="Curvas de ponderación A, C y Z de IEC 61672-1 con zoom de la región positiva de la curva A (+1,27 dB a 2,5 kHz)" width="80%" />
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/time_weighting_analysis.svg" alt="Respuestas de las ponderaciones temporales Fast, Slow e Impulse a una ráfaga de ruido" width="80%" />
...
Como G actúa sobre 0,25 Hz – 315 Hz, muy por debajo de la frecuencia de Nyquist a las frecuencias de muestreo de audio, la deformación en frecuencia de la transformación bilineal simple (aplicada sin precompensación) es despreciable en ese rango: en torno al 0,014 % a 315 Hz con $f_\mathrm{s} = 48$ kHz, menos de 0,01 dB en la respuesta. El diseño por defecto ajusta igualmente el prototipo a la frecuencia de muestreo, como hace con A y C: aquí no cuesta nada y sí importa a las frecuencias bajas a las que se suele grabar infrasonido, donde 315 Hz se acerca a Nyquist.
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/sel_concept.svg" alt="Historial de nivel del paso de un vehículo con su Leq sobre todo el evento y el bloque SEL de un segundo de igual energía" width="80%" />

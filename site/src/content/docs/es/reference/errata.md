...
- **Library behaviour:** `in_situ_total_loss_factor` takes $\sum l_k \alpha_k$
  ...
  printed block, and says so ([`tests/building/test_detailed_prediction.py`](https://github.com/jmrplens/phonometry/blob/main/tests/building/test_detailed_prediction.py)).
- **Status:** unreported.

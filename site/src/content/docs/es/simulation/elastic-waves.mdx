...
dibujados en los radios exactos $c_P t$ y $c_S t$, así que son una medición y
...
medición: el $c_R$ simulado frente a 2921 m/s, la raíz de la ecuación

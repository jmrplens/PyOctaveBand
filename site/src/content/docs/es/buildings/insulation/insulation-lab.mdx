...
este sitio toma como entrada el $R$ y el $L_n$ de laboratorio. Nada más en
...
cámara capaz de medir paredes y forjados de tipo C hasta $R_w = 55$ dB, va de
...
$K_c$: para volver a hacerla comparable.
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/background_correction_regimes_es.svg" alt="La corrección aplicada a un nivel del recinto receptor frente al margen señal-fondo: plana en la saturación de 1,3 dB por debajo de 6 dB, después la curva de resta energética, cayendo a cero en 15 dB con la regla de laboratorio de ISO 10140-4 y en 10 dB con la regla de campo de ISO 16283-1" width="88%" />
...
Lee los números en lugar de coleccionarlos. $R_w = 30$ dB es una partición
...
separadora de vivienda, y su $C_{tr} = -3$ dB dice que cede otros 3 dB frente
al tráfico, así que se declararía como 27 dB frente a una carretera.
$L_{n,w} = 79$ dB es un forjado estructural desnudo, sin revestimiento ni suelo
flotante: los límites europeos de impacto para vivienda rondan los 50 a 60 dB,
así que este forjado los incumple todos por unos 20 dB. Su $C_I = -11$ dB es la
mitad interesante: un $C_I$ muy negativo significa que el espectro medido está
...
pisadas de lo que sugiere el $L_{n,w}$ por sí solo, y un revestimiento blando
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/lab_versus_field_insulation_es.svg" alt="Una misma partición de hormigón de 150 mm dibujada tres veces por banda de tercio de octava: el índice de reducción acústica R de laboratorio con Rw = 49 dB, el R' aparente de la misma pared en un edificio con uniones buenas con R'w = 47 dB, y el R' aparente donde dominan los flancos con R'w = 42 dB, con las dos brechas acotadas" width="92%" />
...
fijas de micrófono, integrada hacia atrás. Después,
...
muro de ladrillo o bloque de (400 ± 40) kg/m² enfoscado por una cara. Un $R_w$
...
laboratorio $R$ con la corrección de ruido de fondo del apartado 4.3) e
...
**No cubierto.** El procedimiento de ISO 10140-4:2010 y los requisitos de
instalación y de montaje de ISO 10140-1:2010 e ISO 10140-5:2010 están
documentados más arriba y no están implementados en ninguna parte: nada
comprueba los recuentos de posiciones, las separaciones, los tiempos de
promediado, el rango de bandas, la geometría de la abertura de ensayo ni el
requisito de factor de pérdidas, y la condición de montaje sobrevive solo como
etiqueta de texto libre en los metadatos del informe (`"Montaje tipo A,
perímetro recibido con mortero (ISO 10140-1)"`), que es lo que pide
ISO 10140-1, ya que exige que cualquier montaje se *describa* en lugar de
elegirse de una lista. Tampoco se estima el $R'_\text{max}$ de la cámara, así
que un resultado que se acerque al techo de la instalación se producirá sin
queja alguna; esa cualificación tiene que venir de los propios ensayos del
Anexo A del laboratorio. Las mediciones de laboratorio vecinas
están cubiertas por sus propias guías: el
...
- Teoría: [Acústica de salas y edificación](/phonometry/es/reference/theory/rooms-buildings/#acústica-de-salas-y-edificación-iso-18233-iso-3382-iso-16283-iso-10140-en-12354-iso-12999-iso-717-iso-354): la derivación de R y R′ y las normalizaciones que separan laboratorio de campo.

...
Por debajo de 25 m³ esa misma norma hace obligatoria una segunda medición, en
las esquinas, para las tres bandas más bajas, y
[Recintos pequeños: procedimiento de baja frecuencia](/phonometry/es/buildings/insulation/low-frequency-procedure/)
es ese procedimiento completo, compartido por las tres partes.
...
los requisitos de instalación de ensayo y de montaje de ISO 10140-1. Eso es cosa del operador y del informe, y es lo que

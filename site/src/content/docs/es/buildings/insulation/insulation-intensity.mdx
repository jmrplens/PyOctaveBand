...
método de adquisición por barrido o por puntos discretos. Aquí tampoco se
impone la adquisición del apartado 6.4 documentada más arriba: la separación de
0,1 a 0,3 m, la velocidad de barrido de 0,1 a 0,3 m/s, el segundo barrido
girado 90° y su prueba de validez de 1,0 dB, el margen de 10 dB sobre el ruido
de fondo. Un solo barrido produce un número igual de fácilmente que una pareja
cualificada. Tampoco están

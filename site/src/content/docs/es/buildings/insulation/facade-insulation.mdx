...
procedimiento de esquina en baja frecuencia del apartado 7.3 (la contraparte de
fachada del [procedimiento de ISO
16283-1](/phonometry/es/buildings/insulation/low-frequency-procedure/),
activado por el mismo umbral de 25 m³ del recinto receptor) sí está
implementado y se alcanza con el argumento `low_frequency=` de
`facade_insulation`, para los métodos de altavoz a los que lo limita el
apartado 6; los métodos de ferrocarril y aeronaves del Anexo E no lo están. Los ejemplos resueltos de EN 12354-3 y EN 12354-4 de las ediciones de
...
- [Índices globales de aislamiento (ISO 717)](/phonometry/es/buildings/insulation/insulation-ratings/):
  ...
  $R'_{45,\mathrm{w}}$ y $R'_\mathrm{tr,s,w}$.

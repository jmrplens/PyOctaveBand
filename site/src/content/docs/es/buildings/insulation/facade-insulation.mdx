...
La ISO 16283-3:2016 (las magnitudes de fachada en campo $D_{2m}$, $D_{2m,nT}$,
$D_{2m,n}$, $R'_{45°}$ y $R'_{tr,s}$ de los métodos de elemento con altavoz y
...
índices $R_{45}$ y $R_{tr,s}$, la $D_{2m,nT}$ de la Fórmula 13 y el término de

...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/insulation_adaptation_terms.svg" alt="Izquierda: el índice de reducción acústica de un muro de hormigón denso de 150 mm y el de una doble hoja de 12 kg por metro cuadrado sobre montantes metálicos con cámara de 90 mm, ambos frente a la misma curva de referencia ISO 717-1 desplazada a Rw = 49 dB. Derecha: un diagrama de barras agrupadas de Rw, Rw + C y Rw + Ctr para las dos construcciones, idénticas en Rw y separadas 6 dB en Rw + Ctr" width="92%" />

...
eligen para que $C_I$ salga **en torno a cero** en un forjado macizo con un
...
hormigón desnudo o mal revestido (A.1). Leído así, el $C_I = -11$ dB del
...
sí solo $L'_{nT,w} = 79$ dB. El corolario es una trampa de diseño: un
...
sin ponderar sobre la que se construye $C_I$ existe precisamente porque se
...
$L'_{n,w} + C_I$ en lugar de sobre $L'_{n,w}$.

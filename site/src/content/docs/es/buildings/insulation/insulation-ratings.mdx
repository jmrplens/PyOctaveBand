...
$C_{tr}$ del Anexo A, mediante `building.weighted_rating`; el índice de
impactos de ISO 717-2:2020 con el signo de desviación opuesto, la reducción de
−5 dB en octavas y el término $C_I$, mediante
...
de fachada del Anexo F de ISO 16283-3 y el $D_{n,f,w}$ de flancos reutilizan

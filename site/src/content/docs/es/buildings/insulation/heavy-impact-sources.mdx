...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/fast_reverberation_correction.svg" alt="El término restado a un nivel medido frente al tiempo de reverberación del recinto receptor de 0,2 a 5 segundos: el término del máximo Fast, 10 lg de g(C) entre g(C0), subiendo hasta unos 5 dB, frente al término del promedio energético, 10 lg de T entre T0, subiendo hasta 10 dB, con la región en la que difieren más de 1 dB sombreada y con T0 = 0,5 s y T = 1,7275 s marcados" width="88%" />

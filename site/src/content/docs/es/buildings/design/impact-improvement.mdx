...
rodeos. Para revestimientos que no sean blandos y flexibles «pueden aparecer
desviaciones mayores respecto de los resultados del método de la serie ISO 10140
debido a la dependencia del tamaño de la probeta»; y **en caso de discrepancia
con ISO 10140, se debe utilizar el resultado de la medición según ISO 10140**.
La maqueta nunca se impone a la instalación a tamaño real.
...
plana dentro de ± 1 mm a lo largo de una línea horizontal de borde a borde y lo
bastante dura para aguantar los martillos — se le puede añadir una capa de
mortero para conseguir esa planeidad. Descansa sobre cuatro apoyos elásticos en
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_iso16251_mockup_es.svg" alt="La maqueta de suelo pequeña de ISO 16251-1: una sección de la placa de hormigón de 200 mm sobre sus cuatro apoyos elásticos con la probeta de revestimiento y la máquina de impactos, una planta de la placa de 1200 por 800 mm con las dos posiciones de máquina y las cuatro posiciones de acelerómetro y sus distancias a los bordes, y los tres ciclos de medición" width="92%" />
...
**Y $C_{I,\Delta}$ es la mitad de la respuesta, así que léelo.** La valoración
...
elástica delgada. $C_I$ es el término de adaptación que compara la suma
energética *sin ponderar* con la valoración ponderada, y
$C_{I,\Delta} = C_{I,r,0} - C_{I,r}$ contrasta el suelo de referencia tal cual
frente al suelo de referencia con el revestimiento encima, con $C_{I,r,0}$ fijado
en $-11$ dB (A.2.2; $-10{,}3$ dB cuando se exige un decimal). La Fórmula (A.5)
dice entonces qué significa la pareja:
$\Delta L_\text{lin} = \Delta L_w + C_{I,\Delta}$. La moqueta de esta página se
valora en 29 ($-13$) dB, así que en la escala de respuesta plana compra
**16 dB**, no 29. Un $C_{I,\Delta}$ muy negativo es la firma de un revestimiento
que solo funciona arriba — típico de las capas elásticas delgadas, y justo donde
la máquina de impactos las favorece —; un revestimiento con $C_{I,\Delta}$ cerca
de cero mejora todo el rango. Una ficha que solo imprime $\Delta L_w$ te ha

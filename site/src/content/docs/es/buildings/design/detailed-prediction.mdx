...
(c_\mathrm{o} T_\mathrm{s,situ})$ (fórmula 11).
...
| `fluid` | `Fluid` | — | por defecto `EN_12354_AIR` | Los 340 m/s del Anexo A con los 1,29 kg/m³ del Anexo B; pásale un `fluids.air()` calculado para predecir en el aire del edificio |

...
<ReportPreview
	...
	description="Ficha de predicción detallada a ruido aéreo de una página para el edificio del anexo L de ISO 12354-1:2017: cabecera de identificación con el forjado separador de 20 m2 y las dos viviendas de 50 m3, tabla de cuota de energía de los trece caminos (el camino de flanco 2d es el mayor con un 18,0 %, el camino directo Dd un 6,3 %), figura por banda que apila la contribución de cada camino bajo la curva del índice de reducción acústica aparente de 50 Hz a 5 kHz, el R'w = 57 dB predicho y recuadrado, la desviación típica de 1,5 dB a 2,5 dB del modelo detallado y un CUMPLE frente a una exigencia de 52 dB."
	caption="Ficha de predicción detallada a ruido aéreo (DetailedAirborneResult.report), los trece caminos del edificio del anexo L y sus cuotas de energía."
/>

<ReportPreview
	name="iso12354_detailed_impact_example"
	title="Ficha de ejemplo de predicción detallada a impactos ISO 12354-2 (PDF)"
	description="Ficha de predicción detallada a impactos de una página para el mismo edificio en la dirección de impactos: la cabecera de identificación, la tabla de cuota de energía del camino directo y de los cuatro caminos de flanco, la figura por banda de la contribución de cada camino bajo la curva del nivel de presión acústica de impactos normalizado aparente, y el L'n,w = 41 dB predicho y recuadrado con la desviación típica del modelo detallado y el veredicto frente a la exigencia."

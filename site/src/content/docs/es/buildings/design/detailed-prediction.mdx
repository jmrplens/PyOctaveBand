...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/detailed_impact_paths.svg" alt="Cuotas por banda apiladas de la energía transmitida por las cinco trayectorias de impacto del edificio del Anexo G de ISO 12354-2 con el nivel de presión acústica de impactos normalizado aparente superpuesto, la trayectoria directa a través del forjado excitado dominando en todas las bandas y la resonancia del suelo flotante marcada en el eje de frecuencias" width="92%" />

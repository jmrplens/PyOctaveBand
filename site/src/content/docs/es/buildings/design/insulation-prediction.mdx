...
(21) $L'_{n,w} = L_{n,w,eq} - \Delta L_w + K$ mediante
...
trayectoria fija qué banda. Los propios datos de los elementos ($R_w$,
$\Delta R_w$, $\Delta L_w$, masa por unidad de superficie) se toman como

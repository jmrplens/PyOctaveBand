...
de más abajo: es el elemento más débil de la lista, con $R_w$ = 33 dB, y sin
embargo los 33,5 dB tabulados para su $K_{Ff}$ sacan su trayectoria Ff de la suma
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_junction_catalogue_es.svg" alt="El catálogo de uniones del Anexo E: cruz rígida, T rígida, T con capa elástica intermedia, esquina, cambio de espesor y una pared ligera de doble hoja encontrándose con un forjado homogéneo, cada una con sus elementos numerados, sus ramas de trayectoria coloreadas, la longitud de acoplamiento marcada y la relación de masas resuelta en uno de los paneles" width="92%" />
...
los 5 dB entre $R_{s,w} = 57$ dB y $R'_w = 52$ dB. La línea discontinua es el
$R'_w$ ensamblado, que queda necesariamente por debajo de todas las trayectorias
individuales.*
...
$\Delta R_{Dd,w}$ combinado a través de `delta_r_direct`.
...
revestimiento es $\Delta L_w$ y se resta aparte.
...
**No cubierto.** Los modelos *detallados* por banda de ambas partes son el asunto
de
[Predicción detallada por bandas (ISO 12354)](/phonometry/es/buildings/design/detailed-prediction/):
la misma norma ejecutada banda a banda, con los datos de laboratorio de elemento
y de unión convertidos a sus valores in situ antes de formar las trayectorias.
Usa el modelo simplificado de aquí cuando solo conozcas las magnitudes globales
...
trayectoria fija qué banda. Los

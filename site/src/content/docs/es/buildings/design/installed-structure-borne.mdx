...
$\Delta K$ cubre las ondas longitudinales y en el plano que la teoría de ondas de
flexión se pierde — unos 4 dB para dos uniones y 6 dB para tres o más, con el
$K_{ij}$ encadenado acotado inferiormente cerca de $-5$ dB, que corresponde a
transmisión estructural total. Dos consecuencias para el dato que aportas aquí:

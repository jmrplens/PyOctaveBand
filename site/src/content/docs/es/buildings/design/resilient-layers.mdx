...
**Y luego los puentes.** Son las maneras en que la hipótesis falla en obra, más
o menos por orden de frecuencia:

- la solera en contacto con la pared, porque la banda perimetral se cortó corta,
  se dobló hacia dentro antes del vertido, o se recortó a ras y luego el rodapié
  la rejuntó por encima;

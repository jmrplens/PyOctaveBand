...
ser más corto que $T$**, de modo que caigan al menos dos rayas espectrales dentro
del ancho de banda de cualquier modo de la sala. Como el periodo de una secuencia
de orden $N$ es $(2^N-1)/f_s$, eso fija el orden:
...
redistribuyen la energía temprana y desplazan C50, C80 y $T_s$, así que esos **no**
...
mientras que la T30 fluctúa 0,12 s a lo largo de todo el barrido sin tendencia en
el extremo cercano. Esa asimetría es la trampa: un control que declare solo la T30
...
`room.room_parameters`. Las reglas de dimensionado de la ISO 18233 (longitud de
barrido y silencio del apartado B.3.1, ec. (10) del apartado 6.2.2.2 para el
periodo de la MLS), los requisitos de equipo del apartado 4.2 de la ISO 3382-1 y
las reglas de colocación de ISO 3382-1/-2 (separación, distancia a superficies, la
distancia mínima a la fuente, la alternativa del brazo giratorio y los grados de
exactitud) se citan para la planificación, junto con la lista de comprobación del
informe del apartado 9.2.
...
distorsión, pero ninguna función auxiliar la cuantifica (esa lectura vive en la
[guía de distorsión por barrido
...
- Teoría: [Acústica de salas y edificación](/phonometry/es/reference/theory/rooms-buildings/#acústica-de-salas-y-edificación-iso-18233-iso-3382-iso-16283-iso-10140-en-12354-iso-12999-iso-717-iso-354): la integración inversa de Schroeder y la deconvolución en la que se apoya el método del barrido.

...
description: "Las valoraciones de ruido de salas de ANSI/ASA S12.2-2019: la valoración de criterios de ruido (NC) sobre las curvas de la Tabla 1 (designación NC-(SIL) con el método de tangencia cuando se supera), y la valoración Room Criteria Mark II (RC) con su etiqueta espectral de retumbo/siseo/neutro (Anexo D)."
references:
  - type: article
    authors: ["Beranek, L. L."]
    year: 1957
...
valoración numérica es la **media de frecuencias medias** $\text{LMF}$, la

...
ISO 3382-3:2012 ($D_{2,S}$, $L_{p,A,S,4m}$, $r_D$, $r_P$) de
...
$L_{p,A,B}$, tampoco se calcula aquí: es la media energética ponderada A de
...
revisión sucesora ISO 3382-3:2022 retira la distancia de privacidad $r_P$,
añade la distancia de confort $r_C$ y traslada el STI por posición al método
...
de Lombard: se cancela en $L_{SN}$ mientras todo el mundo alce la voz por

...
$k = 24\ln 10 / c_0$ (así $k = 0{,}161$ para $c_0 = 343\ \mathrm{m/s}$) y el
...
y Eyring acotan la zona intermedia, y Arau-Puchades templa la sobrepredicción de
...
10,90 m² en 9,81 m² revestidos con $\alpha_s$ = 0,85 más 1,09 m² desnudos con
...
datos — $\alpha_w$, NRC, SAA — *no* sustituye a la tabla por bandas (ver la
...
ya no en cuanto una de ellas queda partida por una ventana o un revestimiento. La
...
una. Toma esa pérdida como $\alpha$ por reflexión y linealízala y obtienes
...
sobre la media y obtienes **Millington-Sette**, que se derrumba a cero en cuanto
...
atenuación de potencia (intensidad) $m$, en neper por metro:
...
**frecuencia de Schroeder** $f_s \approx 2000\sqrt{T/V}$ ($V$ en m³, $T$ en s
...
Sabine y Eyring son los dos caballos de batalla, y la separación entre ambos
...
línea de referencia y no emita ningún veredicto. Referencias que conviene llevar
encima:
...
- Las **salas críticas para el habla** (aulas, salas de reuniones, salas de
  ...
  medias, y se ajustan más cuanto más pequeña es la sala. La Tabla 1 de la
...
[guía de Acústica de salas](/phonometry/es/buildings/rooms/room-acoustics/) en lugar
de una predicción estadística.

## Véase también

- [Medida y clasificación de la absorción sonora](/phonometry/es/materials/absorbers/absorption-measurement/):
  la medición ISO 354 de la que sale cada $\alpha_s$ de esta página, su
...
- Teoría: [Acústica de salas y edificación](/phonometry/es/reference/theory/rooms-buildings/#acústica-de-salas-y-edificación-iso-18233-iso-3382-iso-16283-iso-10140-en-12354-iso-12999-iso-717-iso-354): la hipótesis de campo difuso que supone toda fórmula de la familia Sabine, y dónde deja de cumplirse.

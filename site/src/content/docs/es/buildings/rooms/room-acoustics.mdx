...
convierte en una **curva de decaimiento** mediante la integración hacia atrás de
...
son [Acústica de oficinas diáfanas](/phonometry/es/buildings/rooms/open-plan-acoustics/).

## Qué cubre esta guía

**Cubierto.** La ISO 3382-1:2009 (apartado 5.3.3 de integración hacia atrás y
...
Cada banda de la respuesta al impulso se convierte en una curva de decaimiento mediante la integración hacia atrás de Schroeder de la RI al cuadrado, y una recta ajustada por mínimos cuadrados sobre un rango de evaluación se extrapola a una caída completa de 60 dB, $T = -60/\text{slope}$ (ISO 3382-1/2): EDT de 0 a −10 dB (reverberación percibida), T20 de −5 a −25 dB y T30 de −5 a −35 dB.

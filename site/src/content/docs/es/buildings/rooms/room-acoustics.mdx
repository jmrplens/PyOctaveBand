...
da dos procedimientos admisibles, y el que soporta esta API es el primero: la
...
**Cubierto.** La ISO 3382-1:2009 (apartado 5.3.3 de integración inversa y
...
propias,
[Medición de la respuesta al impulso](/phonometry/es/buildings/rooms/room-impulse-response/)
y [Acústica de oficinas diáfanas](/phonometry/es/buildings/rooms/open-plan-acoustics/).
...
- Teoría: [Acústica de salas y edificación](/phonometry/es/reference/theory/rooms-buildings/#acústica-de-salas-y-edificación-iso-18233-iso-3382-iso-16283-iso-10140-en-12354-iso-12999-iso-717-iso-354): el modelo de decaimiento que hay detrás de T20, T30 y EDT y las relaciones de energía con las que se construyen los parámetros de claridad y definición.

...
receptor fija el tiempo de llegada y la divergencia $1/(4\pi r)$ de esa
reflexión.*
...
estadística, o al
[solucionador FDTD](/phonometry/es/simulation/fdtd-simulation/).
...
- el tiempo de reverberación de Eyring recuperado del decaimiento de la RIR
  ...
  [solucionador 2D FDTD](/phonometry/es/simulation/fdtd-simulation/)
...
implementado por `room.modes`, `room.room_mode_frequency`,
...
y ejecutar el
[solucionador 2D FDTD](/phonometry/es/simulation/fdtd-simulation/). Las
...
- [Simulación de ondas FDTD 2D](/phonometry/es/simulation/fdtd-simulation/): el
  solucionador de ondas independiente usado para contrastar el eco de pared rígida y
  el decaimiento.

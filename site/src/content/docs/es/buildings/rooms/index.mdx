...
- [Fuerza sonora G (ISO 3382-1)](/phonometry/es/buildings/rooms/sound-strength/):
  lo fuerte que suena la sala, frente a la misma fuente a 10 m en campo libre, y
  las tres rutas impresas hasta esa referencia.
- [Impresión espacial (ISO 3382-1)](/phonometry/es/buildings/rooms/spatial-impression/):
  de dónde llega el sonido, medido con un micrófono en ocho junto al
  omnidireccional y con una cabeza que lleva dos.
- [Soporte de escenario e incertidumbre (ISO 3382-1)](/phonometry/es/buildings/rooms/stage-and-uncertainty/):
  las dos medidas que se toman en el escenario con la fuente a un metro, y la
  incertidumbre que el capítulo 7 pone a un tiempo de reverberación medido.
- [Informe y cualificación de la fuente (ISO 3382-1)](/phonometry/es/buildings/rooms/reporting-and-qualification/):
  la Tabla 1 y el barrido deslizante de directividad, los recuentos de
  receptores de la Tabla A.2, y qué bandas promedia cada número único de la
  Tabla A.1.
- [Acústica de oficinas diáfanas (ISO 3382-3)](/phonometry/es/buildings/rooms/open-plan-acoustics/):
...
sala real a baja frecuencia. Para eso, la sección de [simulación de
ondas](/phonometry/es/simulation/) ejecuta un esquema FDTD sobre la geometría
real.
</ScopeClaim>

<ScopeClaim status="not-covered">
**Ni auralización, ni trazador de rayos, ni modelo de sala.** No hay
importador de geometría, ni base de datos de materiales, ni renderizador: las
páginas toman dimensiones, coeficientes y respuestas al impulso como entradas,
y devuelven parámetros. Los propios coeficientes de absorción salen de
...
*entre* salas: eso es [Aislamiento
acústico](/phonometry/es/buildings/insulation/).
</ScopeClaim>
</Scope>

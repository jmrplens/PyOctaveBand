...
description: "La única medida de auditorio que necesita una fuente calibrada: G como la energía de la respuesta al impulso medida frente a la misma fuente a 10 m en campo libre, y las tres rutas impresas hasta esa referencia cuando no hay una cámara anecoica de 10 m."
references:
  - type: standard
...
$G$, es la magnitud que cierra ese hueco, y es la única de la Tabla A.1 de
la ISO 3382-1 que necesita una fuente calibrada. Todo lo demás de la
[página de parámetros acústicos de salas](/phonometry/es/buildings/rooms/room-acoustics/)
— EDT, T20, T30, C50, C80, D50, $T_\mathrm{s}$ — es un cociente de energías dentro
de un mismo registro y sobrevive a cualquier ganancia que se le ponga
delante. $G$ no.

...
tal cual). Una trayectoria, en cambio, sí se calcula: una entrada que publica
pasos de procedimiento en lugar de puntos fijos se vuela con el modelo de
actuaciones del Apéndice B del Vol. 2 de ECAC Doc 29, que convierte un
procedimiento publicado en un perfil para el aeródromo y la meteorología desde
los que se vuela.
</ScopeClaim>

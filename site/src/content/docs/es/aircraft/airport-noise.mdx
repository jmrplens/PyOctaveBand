...
El modelo cubre también el rodaje de aterrizaje (la máscara `landing_roll` del
`FlightSegmentState`: fracción de ruido reducida Ec. 4-21b, geometría al
extremo más cercano, sin término de directividad), el ángulo de alabeo por
segmento (su `bank`, positivo con el ala de estribor arriba; el ángulo de depresión es

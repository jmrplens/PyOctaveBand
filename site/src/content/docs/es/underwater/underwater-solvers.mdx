...
- **El régimen propio de la teoría de rayos** (Jensen §3.4.2): «la longitud de
  ...
  problema». A 20 Hz en 100 m de agua la profundidad son 1,3 longitudes de onda
  y se propagan dos o tres modos; la suma de haces se dispersa entonces unas
  décimas de decibelio frente al campo exacto y no converge en nada. Léelo por
  encima de unos cientos de hercios en aguas someras, y usa `normal_modes` por
  debajo.

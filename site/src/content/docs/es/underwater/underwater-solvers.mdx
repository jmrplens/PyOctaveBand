...
100 Hz el error en $|p|$ es de $7,5\times10^{-5}$ con esa anchura y el mismo a
todas las distancias probadas, y sube a $5\times10^{-4}$ con la quinta parte de
ella y a $0,36$ con quince veces. La banda de 10 a 50 longitudes de onda del
...
**Dónde se acaba.** Tres límites, en el orden en que aprietan.

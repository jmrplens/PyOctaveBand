...
la guía de ondas ideal de presión nula, hasta 0,02 dB con el abanico abierto a
88 grados.
...
- **El abanico está truncado** en `max_angle_deg`, y una guía de ondas con dos
  ...
  de 1000 m a 300 Hz, frente a la suma de fuentes imagen: 0,15 dB a 2 km con los
  80 grados por defecto, pero 4,1 dB a 5 km, que bajan a 0,0005 dB al abrir el
  abanico a 88 grados. Recortar el *oráculo* al mismo semiángulo lo mueve
  otro tanto, así que esto es el abanico y no el método. Un fondo real y

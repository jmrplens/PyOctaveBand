...
description: "Calcular el campo sonoro submarino cuando las formas cerradas no bastan: la expansión en modos normales de la guía de ondas estratificada, el trazado de rayos con el invariante de Snell y las zonas de convergencia, la búsqueda de eigenrayos que convierte un abanico trazado en la lista de llegadas de un receptor, el trazado de haces gaussianos para un campo que se mantiene finito en las cáusticas, y la ecuación parabólica split-step de Fourier, cada uno validado contra una forma cerrada exacta, con la guía de selección de modelo para elegir entre ellos."
references:
  - type: book
...
(Ecs. 3.79, 3.125-3.126). Cada uno está validado contra una
...
frecuencia, más, a través de `eigenrays`, la lista de llegadas por receptor),

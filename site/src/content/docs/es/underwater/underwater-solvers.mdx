...
Pasar un par `bathymetry` de nodos, `(ranges_m, depths_m)`, sustituye el
...
- **El régimen propio de la teoría de rayos** (Jensen §3.4.2): «la longitud de
  ...
  un puñado de modos.
- **El abanico está truncado** en el `max_angle_deg` del abanico, y una guía
  de ondas con dos
  ...
  disipativo (el `FluidSeabed` de más arriba)

...
de la página de [Acústica submarina](/phonometry/es/underwater/underwater-acoustics/):
...
distancia, y eso es justo lo que lo convierte en referencia para los solucionadores
numéricos de
[Solucionadores de propagación
...
divergencia. En ese punto el campo hay que calcularlo, y los solucionadores de
...
`ship_source_spectrum` de arriba. Los solucionadores numéricos del campo
...
- [Solucionadores numéricos de propagación submarina](/phonometry/es/underwater/underwater-solvers/):
  los solucionadores de modos normales, trazado de rayos y ecuación parabólica para

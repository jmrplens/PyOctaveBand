...
propagación* $N_{PL}$ es la diferencia entre el nivel de fuente en una
dirección especificada y el nivel de presión acústica cuadrático medio en una
posición especificada, $N_{PL}(x) = L_S - L_p(x)$, referida a 1 m²
(apartado 3.4.1.4). La *pérdida por transmisión* $\Delta L_{TL}$ es la

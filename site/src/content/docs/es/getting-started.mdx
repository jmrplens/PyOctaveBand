...
El análisis en octavas de arriba usa el núcleo `filters`, uno de los diecisiete
...
- [Galería de arquitecturas de filtro](/phonometry/es/guides/filter-gallery/): elige una arquitectura e inspecciona sus respuestas

...
cepstro](/phonometry/es/signals/spectra/cepstrum-echoes/)
...
2. **Detectar y transformar la envolvente.** La cadencia de repetición de los
   ...
   [guía del cepstro y el espectro de envolvente](/phonometry/es/signals/spectra/cepstrum-echoes/).
...
[cepstro](/phonometry/es/signals/spectra/cepstrum-echoes/) colapsa toda una familia de

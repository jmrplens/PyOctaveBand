...
ofrece: el [espectro de envolvente y el cepstrum](/phonometry/es/signal/spectra/cepstrum-echoes/)
y el [promediado síncrono en el tiempo](/phonometry/es/signal/spectra/synchronous-averaging/).
...
2. **Detectar y transformar la envolvente.** La cadencia de repetición de los
   ...
   [guía del cepstrum y el espectro de envolvente](/phonometry/es/signal/spectra/cepstrum-echoes/).
...
[cepstrum](/phonometry/es/signal/spectra/cepstrum-echoes/) colapsa toda una familia de
...
- [Cepstrum, ecos y espectro de envolvente](/phonometry/es/signal/spectra/cepstrum-echoes/):

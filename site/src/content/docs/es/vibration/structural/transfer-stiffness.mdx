...
Sobre el forjado de hormigón ($k_t = 3$ GN/m) la fuerza entregada *es* la
...
código, ni tampoco los requisitos de acondicionamiento e instrumentación de la
sección 3: el acondicionamiento de precarga, fluencia y temperatura, los dos
ensayos previos de 15 dB, la planitud de 0,5 dB de los transductores y el
emparejamiento entre canales, y la resolución de cinco líneas por banda se
describen aquí y se dejan al operador. Los soportes hidráulicos quedan del todo
fuera de la descripción con un solo espectro: su rigidez depende de la amplitud
por diseño, así que un único $L_k(f)$ no los caracteriza.

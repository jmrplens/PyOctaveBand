...
magnitudes intermedias, y un sobre dentro del cual tiene que quedar un
...
receptor a 4 m sobre el suyo, 195 m de separación en proyección sobre el suelo,
...
caen dentro de una quinta parte del sobre que permite el documento.*
...
Treinta y cuatro filas de conformidad sujetan los siete casos al sobre del

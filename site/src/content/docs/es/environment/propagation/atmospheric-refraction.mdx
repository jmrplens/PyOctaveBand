...
refractante de los solucionadores oceánicos de
[`phonometry.underwater.propagation.numerical`](/phonometry/es/underwater/underwater-solvers/):
un **modelo de rayos** y un solucionador de **ecuación parabólica (PE)**.
...
descrita en el módulo como la contrapartida de los «solucionadores oceánicos

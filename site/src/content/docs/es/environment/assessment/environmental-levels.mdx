...
description: "Lden, Ldn y los niveles de evaluación compuestos de ISO 1996-1, con el ajuste tonal, la corrección de ruido residual y el presupuesto de incertidumbre de medida de ISO 1996-2."
references:
  - type: standard
  ...
  - type: standard
    ...
    note: "La corrección de ruido residual del apartado 10.4, el presupuesto de incertidumbre de medida del apartado 4 / Anexo F, el mapeo de audibilidad media de la Tabla J.1 del Anexo J y el método de cribado del Anexo K."
  - type: standard
...
ajuste tonal, la corrección de ruido residual y el presupuesto de incertidumbre
de medida.
...
(apartado 10.4), el presupuesto de incertidumbre de medida (apartado 4, anexo F),
...
- [Exposición laboral (ISO 9612)](/phonometry/es/perception/hearing/occupational-exposure/): la contraparte en el puesto de trabajo, de las muestras por tarea al nivel de exposición diario con su presupuesto de incertidumbre.

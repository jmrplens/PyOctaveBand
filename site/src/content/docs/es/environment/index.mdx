...
ciudad, ni capa GIS: las funciones de propagación toman una fuente, un
receptor y el suelo entre ambos, los dos modelos de refracción suponen un
suelo plano en z = 0, y cómo se descompone una línea fuente en fuentes
puntuales lo declara fuera de alcance el propio CNOSSOS. Del lado de la
evaluación, la biblioteca empieza donde termina el sonómetro — las posiciones
del receptor y las correcciones de fachada de ISO 1996-2, y los procedimientos
de medición del anexo IV del RD 1367/2007 (posiciones de micrófono, duración
de las series, número de mediciones), no están implementados, solo la
aritmética que sigue una vez aplicados. La zonificación acústica, los mapas de
ruido y los planes de acción de la Ley 37/2003 son instrumentos de
planificación, no cálculos.
</ScopeClaim>
</Scope>

## Antes y después de estas páginas

Toda evaluación de aquí es un $L_\mathrm{eq}$ corregido, así que la calibración, la

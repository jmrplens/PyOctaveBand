...
[Niveles integrados y estadísticos](/phonometry/es/signal/levels/levels/), y los
...
- [Niveles integrados y estadísticos](/phonometry/es/signal/levels/levels/): los niveles $L_{Aeq}$, $L_{Ceq}$ y $L_{AIeq}$ por fase que alimentan las tres correcciones.

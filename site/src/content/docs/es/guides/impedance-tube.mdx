...
[solver FDTD](/phonometry/es/guides/fdtd-simulation/) y recupera la respuesta
...
[solver FDTD 2D](/phonometry/es/guides/fdtd-simulation/) es un tubo de onda
...
- [Simulación FDTD](/phonometry/es/guides/fdtd-simulation/): el solver 2D
  detrás de los tubos virtuales de la sección 5.
- [Calibración](/phonometry/es/guides/calibration/): la calibración de
  micrófonos previa a la función de transferencia con dos micrófonos.
- Referencia de la API: [`materials.impedance_tube`](/phonometry/es/reference/api/materials/impedance-tube/).

...
descriptores Lden y Ldn, los niveles de evaluación compuestos de ISO 1996-1
...
(Lden, Ldn, niveles de evaluación) y los procedimientos de determinación de
...
- [Niveles ambientales (ISO 1996-1/-2)](/phonometry/es/guides/environmental-levels/): los indicadores Lden/Ldn, los niveles de evaluación y la cadena de determinación de ISO 1996-2 construidos sobre los niveles de esta página.

...
- **Molestia comunitaria a largo plazo**: $L_{den}$/$L_{dn}$ y los niveles
  ...
  [Niveles ambientales](/phonometry/es/guides/environmental-levels/).
...
[Sonoridad](/phonometry/es/guides/loudness/). Que un único $L_{eq}$ sea un
...
[Niveles ambientales](/phonometry/es/guides/environmental-levels/). La IEC
61252 se revisó en 2025; aquí solo están las fórmulas de la primera edición
implementada (1993), no las de la más reciente.

## Véase también

- [Niveles ambientales (ISO 1996-1/-2)](/phonometry/es/guides/environmental-levels/): los indicadores $L_{den}$/$L_{dn}$, los niveles de evaluación y la cadena de determinación de ISO 1996-2 construidos sobre los niveles de esta página.
...
- Referencia de la API: [`metrology.levels`](/phonometry/es/reference/api/levels/levels/).

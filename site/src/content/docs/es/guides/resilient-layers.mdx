---
title: "Predicción del comportamiento de capas elásticas (revestimientos, suelos flotantes, trasdosados)"
description: "El lado de la predicción de las capas elásticas: la máquina de impactos como sistema masa-resorte-amortiguador, la frecuencia de corte de un revestimiento de suelo blando a partir de su rigidez de contacto, las leyes 30 lg y 40 lg de mejora de un suelo flotante por encima de su resonancia masa-resorte, y la mejora ponderada de un trasdosado según el Anexo D de ISO 12354-1 a partir de su frecuencia de resonancia."
references:
  - type: book
    authors: ["Hopkins, C."]
    year: 2007
  ...
  - type: standard
    ...
    url: "https://www.iso.org/standard/16637.html"
...
# La fuerza de la máquina de impactos es un espectro de líneas en múltiplos de
# 10 Hz, así que la mejora por banda es el cociente de las fuerzas cuadráticas
# medias sobre las líneas de cada banda; ese promedio elimina el rizado del
...
res.improvement                     # delta-L del cociente de fuerzas
res.two_line                        # 0 dB bajo fco, 40 lg(f/fco) encima
res.plot()
```
...
## Trasdosados: el anexo D lee la magnitud global en la resonancia

Un trasdosado sobre una pared es el mismo problema de resorte con el signo
cambiado: puede *reducir* el aislamiento acústico, y el anexo D de
...
de tercio de octava en la que cae. Por debajo de 200 Hz el trasdosado ayuda,
...
# El mismo trasdosado sobre montantes con cámara de 100 mm rellena de lana.
...
$\Delta R(f)$ de un trasdosado: el anexo D es un método de magnitud global, y
donde ISO 12354 necesita un espectro de trasdosado o bien lo mide (anexo G de
...
- [Predicción del aislamiento de paneles](/phonometry/es/guides/panel-sound-insulation/):
  ...
  aéreo de la resonancia del trasdosado.

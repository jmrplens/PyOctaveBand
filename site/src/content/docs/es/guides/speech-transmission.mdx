...
# STI frente al tiempo de reverberación: barre speech.sti_from_impulse_response sobre
...
- [Sonoridad](/phonometry/es/guides/loudness/) y
  [Métricas de calidad sonora](/phonometry/es/guides/sound-quality/): sonoridad, agudeza,

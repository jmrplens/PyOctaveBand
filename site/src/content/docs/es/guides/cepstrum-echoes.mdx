...
el cepstro de potencia la altura del primer pico es exactamente el
coeficiente de reflexión `a` - con su signo - una forma cerrada que los
tests y la batería de conformidad fijan a 1e-10. `echo_detection`
...
interferente fuera de banda nunca llega al detector.

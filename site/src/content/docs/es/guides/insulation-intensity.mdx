...
Una cámara reverberante lee la potencia sonora transmitida de forma
*indirecta*: la sala receptora integra cada vatio que llega, lo traiga la vía
...
ensayo entre dos salas, y los flancos suprimidos de la instalación hacen de
...
- [Medición del aislamiento en laboratorio](/phonometry/es/guides/insulation-lab/):
  el método por presión de ISO 10140 que la adaptación Kc reproduce.
...
- [Índices globales de aislamiento (ISO 717)](/phonometry/es/guides/insulation-ratings/):
  el motor de curva de referencia tras RI,w y DI,n,e,w.

...
references:
  ...
  - type: standard
    ...
    note: "El apartado 3.3 define la atenuación normalizada del techo Dn,c con A0 = 10 m2, y los apartados de instalación fijan la profundidad del plenum, los volúmenes de los recintos y la absorción exigida al revestimiento."
  - type: standard

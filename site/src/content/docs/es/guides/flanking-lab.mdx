...
references:
  ...
  - type: standard
    ...
    note: "El apartado 3.3 define la atenuación normalizada del techo Dn,c con A0 = 10 m2, y los apartados de instalación fijan la profundidad del plénum, los volúmenes de los recintos y la absorción exigida al revestimiento."
  - type: standard
  ...
  - type: book
    ...
    note: "La Sección 9.2.3 presenta el modelo unidimensional de plénum de Mechel, Ecs. (9.13) a (9.20). ISBN 978-0-415-42853-8."
---
...
## Techos suspendidos: el trayecto por el plénum (ISO 140-9, Vigran 9.2.3)

Dos despachos separados por un tabique que se detiene en el techo suspendido
comparten un único plénum continuo por encima. El sonido sale del recinto
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/ceiling_plenum_flanking_es.svg" alt="Dos paneles: el índice de reducción del trayecto techo-plénum Rcl por bandas de octava para dos profundidades de plénum frente a la suma de los índices de los dos techos, y la atenuación normalizada del techo de un informe de ensayo acreditado ASTM E1414 con la curva ASTM E413 ajustada y sus deficiencias sombreadas dando CAC 34" width="92%" />

*Izquierda: el plénum cobra una penalización fija frente a la suma de los dos
techos, y un plénum más profundo devuelve parte de ella. Derecha: la misma
...
presenta Vigran en la Sección 9.2.3, trata el plénum como un conducto revestido
...
plénum, Ec. (9.14)); la potencia inyectada se reparte, con una fracción $s_S$
...
cuyo exponente del lado receptor incorpora la fuga de vuelta al recinto,
$m'_R = m_R + s_R\tau_R/h$ (Ec. (9.17)). Para un plénum con poca atenuación y
...
con $\varepsilon = 1$ para paredes laterales del plénum totalmente absorbentes
y $\varepsilon = 2$ para totalmente reflectantes. Un plénum profundo ayuda, un
...
a la del techo, $R_{cl,p} = R_{cl} + 10\lg(H_S/L_S)$ (Ec. (9.13)), que es lo
...
# La geometría del ejemplo de Vigran: LS = LR = 4,75 m, plénum 0,43 m,
...
# Un plénum revestido atenúa el trayecto lateral (Ec. (9.18) en vez de (9.20)):
...
**atenuación normalizada del techo** $D_{n,c} = D - 10\lg(A/A_0)$
...
superior y un plénum de 650 mm a 760 mm de profundidad con una pared lateral y
...
plénum. Su equivalente norteamericana, ASTM E1414, usa
$A_0 = 12\ \text{m}^2$, de modo que un valor ASTM queda unos
$10\lg(12/10) = 0{,}79$ dB por encima para los mismos recintos.
...
unidimensional de plénum de la Sección 9.2.3 de Vigran, con
`building.normalized_ceiling_attenuation`,
`building.ceiling_attenuation_class`,
`building.plenum_flanking_reduction_index` y
`building.partition_referenced_reduction_index`. El modelo de plénum
no tiene salida numérica publicada propia, así que se ancla en sus
formas cerradas y en la convergencia de la Ec. (9.18) a la Ec. (9.20);

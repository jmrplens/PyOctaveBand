...
secuencia de fases en pozos cuyo más profundo se acerca a la mitad de la
longitud de onda de diseño, así que un difusor para las centenas bajas de hercios mide decenas de
...
- Referencia de la API: [`materials.metadiffuser`](/phonometry/es/reference/api/materials/metadiffuser/) y [`materials.diffuser_design`](/phonometry/es/reference/api/materials/diffuser-design/).

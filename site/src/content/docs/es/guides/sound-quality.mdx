...
<ThemeImage
  ...
  alt="Tonalidad específica media de ECMA-418-2 sobre las 53 bandas Bark_HMS para un tono de 1 kHz a 40 dB SPL: la tonalidad se concentra en un único pico en la banda crítica del tono, hacia 8,5 Bark_HMS, y cae casi a cero en el resto, integrando T = 1,00 tu_HMS"
  width="80%"
/>

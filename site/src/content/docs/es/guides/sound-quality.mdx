...
[Sonoridad](/phonometry/es/guides/loudness/); la de ECMA-418-2, que
comparte el mismo front-end auditivo, en
[Sonoridad avanzada](/phonometry/es/guides/advanced-loudness/).
...
[Sonoridad avanzada](/phonometry/es/guides/advanced-loudness/), y los modelos de intensidad de

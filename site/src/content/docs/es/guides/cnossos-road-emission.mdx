...
a la velocidad de referencia `vm = vref = 70 km/h`, donde también se anulan los
dos términos de velocidad, las potencias acústicas **son** los coeficientes
`AR,i,m` y `AP,i,m` de la Tabla F-1.

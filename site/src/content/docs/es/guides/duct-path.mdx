...
`L_W = 10 lg S_G + 30 lg xi + 60 lg U_G - 31.3` a partir del área de la cara,
la velocidad de aproximación `U_G = Q / S_G` y el coeficiente normalizado de
pérdida de carga `xi`, repartido por octavas mediante la función de forma
`C_D = -11.82 - 0.15 A - 1.13 A^2` (`-5.82` si el equipo es circular) en torno
a la banda de pico `f_P = 48.8 U_G`.
...
# El difusor de impulsion de la hoja de Long: 24 x 24 in, 312 cfm, 0.05 in pd.

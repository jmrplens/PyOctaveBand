...
*El modelo de dos sensores `y(t) = 0,8·x(t−τ0) + n(t)` bajo las tres
normalizaciones: la función coeficiente está acotada y tiene su pico en +τ0
(arriba); sobre el rango completo de retardos la estimación sesgada se
atenúa hacia los extremos mientras que la insesgada paga su insesgadez con
una varianza que crece allí (abajo).*
...
`y(t) = α·x(t-τ0) + n(t)` de la ecuación 5.21). Un registro con varias

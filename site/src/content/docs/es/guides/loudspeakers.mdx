...
según las convenciones de escala de IEC 60263.
...
[distorsión con barrido exponencial](/phonometry/es/guides/swept-sine-distortion/).
...
- [Potencia acústica](/phonometry/es/guides/sound-power/): el descriptor de
  emisión de las fuentes que no deberían sonar.

---
title: "Fuentes de impacto pesadas y blandas (ISO 16283-2, JIS A 1418-2)"
...
está en
[Medición del aislamiento en obra (ISO 16283)](/phonometry/es/guides/insulation-field/)
y [Medición del aislamiento en laboratorio](/phonometry/es/guides/insulation-lab/).
...
30 mm de espesor de pared, masa efectiva $(2,5 \pm 0,1)$ kg y coeficiente de
restitución $0,8 \pm 0,1$, dejada caer desde $(100 \pm 1)$ cm medidos desde la
base de la pelota; y un neumático de automóvil inflado a
$(2,4 \pm 0,2)\times 10^5$ Pa con una masa efectiva de $(7,3 \pm 0,2)$ kg,
dejado caer desde 85 cm.
...
$10\lg(T/T_0)$ es incorrecta: un detector Fast nunca integra más de unos 1,7 s
...
- Referencia de la API: [`building.heavy_impact`](/phonometry/es/reference/api/building/heavy-impact/).

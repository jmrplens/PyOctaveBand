...
- **La frecuencia de diseño fija la profundidad.** El pozo más profundo es
  ...
  [metadifusor](/phonometry/es/guides/metadiffusers/): a 500 Hz un diseño
...
[guía de metadifusores](/phonometry/es/guides/metadiffusers/).

## Véase también

- [Metadifusores](/phonometry/es/guides/metadiffusers/): la versión en
...
- Referencia de la API: [`materials.scattering_diffusion`](/phonometry/es/reference/api/materials/scattering-diffusion/) y [`materials.diffuser_design`](/phonometry/es/reference/api/materials/diffuser-design/).

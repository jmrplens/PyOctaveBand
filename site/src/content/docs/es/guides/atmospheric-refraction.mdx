---
title: "Refracción atmosférica: rayos y ecuación parabólica"
...
ax = bajada.plot(color="#1f77b4")
subida.plot(ax=ax, color="#d62728")
plt.show()
```
...
rayos.plot()   # los rayos rasantes vuelven al suelo y rebotan a lo largo
plt.show()
```

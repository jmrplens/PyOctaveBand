...
con superficie de presión-liberada en $z = 0$ y fondo de presión-liberada o
rígido. Cada autofunción $\Psi_m(z)$ es una onda estacionaria en
...
por transmisión coherente sale como $TL = -20 \lg\,\lvert
...
El algoritmo **split-step de Fourier** la marcha exactamente en dos
...
[sección de pérdida por transmisión](/phonometry/es/guides/underwater-propagation/)
...
la [sección de la ecuación del sonar](/phonometry/es/guides/underwater-propagation/)
...
- [Refracción atmosférica: rayos y la GFPE](/phonometry/es/guides/atmospheric-refraction/):
  ...
  un lecho marino.
- [Simulación de ondas FDTD 2D](/phonometry/es/guides/fdtd-simulation/): la
  alternativa en el dominio del tiempo tras la animación del canal SOFAR de
  la guía de propagación.
- Referencia de la API: [`underwater.numerical_propagation`](/phonometry/es/reference/api/underwater/numerical-propagation/).

...
$L_{eq}$ de una medición en [Niveles](/phonometry/es/guides/levels/). Cuando un
...
- Referencia de la API: [`metrology.data_qualification`](/phonometry/es/reference/api/metrology/random-data/).

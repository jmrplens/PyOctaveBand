...
[Metaabsorbentes](/phonometry/es/guides/metamaterial-absorbers/) lleva las
...
[Difusores y sus coeficientes](/phonometry/es/guides/diffusers/) cubre las
...
en campo lejano.
[Metadifusores](/phonometry/es/guides/metadiffusers/) reconstruye el difusor
de Schroeder a partir de rendijas cargadas con resonadores, entre uno y dos
órdenes de magnitud más delgado. Y
[Absorción in situ de firmes de carretera](/phonometry/es/guides/road-absorption/)
mide la absorción de un pavimento allí donde está, por la técnica de
sustracción de ISO 13472-1 sobre superficie extensa o con el tubo puntual de
ISO 13472-2.
...
- [Absorbentes porosos y multicapa](/phonometry/es/guides/porous-absorbers/):
  ...
  aleatoria.
- [Metaabsorbentes](/phonometry/es/guides/metamaterial-absorbers/): el
  acoplamiento crítico y el panel ranurado de sonido lento con su
  solucionador de diseño.
- [Resumen de Difusores y superficies](/phonometry/es/guides/sections/diffusion-surfaces/):
  qué hace una superficie con el sonido que devuelve, de los coeficientes a
  los paneles de metamaterial y los pavimentos.

...
$$
\Delta L = 30 \lg \frac{f}{f_0}\ \text{dB (losas de arena/cemento o sulfato de calcio)},
\qquad
\Delta L = 40 \lg \frac{f}{f_0}\ \text{dB (asfalto, losas secas)}.
$$
...
$\Delta L_w = 13\lg m' - 14{,}2\lg s' + 20{,}8$ dB, condensa la misma física

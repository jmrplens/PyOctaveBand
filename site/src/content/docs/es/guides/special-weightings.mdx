...
[Ponderación frecuencial](/phonometry/es/guides/weighting/), también cubre
...
- [Ponderación frecuencial](/phonometry/es/guides/weighting/): las curvas A,
...
- Referencia de la API: [`filters.weighting`](/phonometry/es/reference/api/filters/parametric-filters/) y [`filters.compliance`](/phonometry/es/reference/api/filters/compliance/).

...
sirve para comparaciones con datos heredados, y la **AU** (IEC 61012), la
única aún en vigor, mantiene las componentes ultrasónicas fuera de una
lectura de exposición audible.

Las cuatro comparten la maquinaria de las curvas de IEC 61672-1 (0 dB en
1 kHz donde aplica, sobremuestreo `high_accuracy`, procesado multicanal y
por bloques con estado). Las propias curvas A, C y Z, su origen, el diseño

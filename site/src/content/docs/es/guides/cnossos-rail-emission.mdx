...
- **causa**: la rugosidad del carril $L_{r,TR}$ (Tabla G-1b, que selecciona el
  dígito 2 del descriptor de vía) y la rugosidad de la rueda $L_{r,VEH}$
...
El texto de 2015 decía «8 dB para $R < 300\ \text{m}$ y 5 dB para
$300\ \text{m} < R < 500\ \text{m}$», lo
...
que $L_{W,0,\mathrm{const},i} = L_{W,0,\mathrm{idling},i}$ y una sola tabla
sirve para ambas. El ralentí
...
$10\lg 0{,}01 = -20\ \text{dB}$ a lo largo de la vía:
...
En la fuente B solo es direccional la fuente aerodinámica, $10\lg(\cos^2\psi)$
...
$L'_{W,\mathrm{eq,line},i} + 10\lg(dL)$, que es aritmética.

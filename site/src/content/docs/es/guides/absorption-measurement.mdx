...
El área de absorción acústica equivalente $A$ que gobierna $R'$, $L'_n$, la
corrección ambiental $K_2$ de ISO 3744 y el término de absorción de ISO 3741 se
...
mismo motor de renderizado que la [ficha de aislamiento de ISO 717](/phonometry/es/guides/insulation-ratings/#informe-de-iso-717-report);

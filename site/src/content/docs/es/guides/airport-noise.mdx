...
ensamblado en `SEL`/`LAmax` por `event_level` y el contorno en malla de
...
ensambla los índices acumulados multievento (una suma tipo Lden sobre un
...
- [Niveles integrados y estadísticos](/phonometry/es/guides/levels/): los
  índices de largo plazo tipo Lden que un estudio de aeropuerto completo

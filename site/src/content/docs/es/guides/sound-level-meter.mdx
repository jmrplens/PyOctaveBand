...
Guías de fondo:
[Ponderación frecuencial (A, C, Z)](/phonometry/es/guides/weighting/) y
...
- Referencia de la API: [`metrology.calibration`](/phonometry/es/reference/api/levels/calibration/),
  [`filters.weighting`](/phonometry/es/reference/api/filters/parametric-filters/),
  [`signal.levels`](/phonometry/es/reference/api/levels/levels/),

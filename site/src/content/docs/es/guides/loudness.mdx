...
- Referencia de la API: [`psychoacoustics.loudness_zwicker`](/phonometry/es/reference/api/psychoacoustics/zwicker/) y [`psychoacoustics.loudness_contours`](/phonometry/es/reference/api/psychoacoustics/contours/).

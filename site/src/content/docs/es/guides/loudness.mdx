...
<ReportPreview
	...
	description="Ficha de sonoridad de una página: una cabecera de metadatos, una tabla de métricas con la sonoridad total N y el nivel de sonoridad LN, el patrón de sonoridad específica sobre la tasa de banda crítica, el resultado de un solo número N = 8.2 sono (LN = 70.4 fonio) en caja y una fila de veredicto CUMPLE frente a un límite de 12 sonos."

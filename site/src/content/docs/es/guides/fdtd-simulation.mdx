...
campo lejano *dispersado*, sin necesidad de una pasada de referencia.
...
probe.reset()                              # e integrar periodos completos
...
probe.reset()
sim.run(round(10.0 / f0 / sim.dt))        # diez periodos completos de DFT

...
## 2b. Tubos de medida virtuales: el solver medido por las normas

Un dominio de tres filas con paredes rígidas es un tubo de onda plana, y
con el mapa de `damping` por celda una muestra porosa se convierte en un
fluido equivalente (mapas de densidad, velocidad y pérdidas). Eso cierra un
...
(acero) la onda de Scholte se pega a la velocidad del agua hasta un 0,03 %
y su cola evanescente alcanza ~7 longitudes de onda dentro del agua: es en
...
orden del esquema. El compañero elástico P-SV del §5: el esquema
...
sólido: un 0,03 % por debajo de la del agua sobre acero (1479,6 m/s), pero

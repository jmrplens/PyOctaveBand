...
references:
  ...
  - type: book
    ...
    note: "Section 11.3.4: the rigid and limp frame limits of the Biot theory, the decoupling frequency and the limp effective density (Eqs 11.53-11.55, after Panneton 2007). ISBN 978-0-470-74661-5."
---
...
material adherido a una estructura vibrante.
...
implementados en sala limpia como se describe arriba. Esto cubre los

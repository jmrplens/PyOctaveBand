...
- **El panel microperforado es un absorbente con acoplamiento crítico avant
  ...
  lo que no puede hacer es ralentizar el sonido, así que su cavidad sigue
  siendo un cuarto de longitud de onda en la resonancia y la construcción no
  alcanza el régimen de sublongitud de onda profunda.

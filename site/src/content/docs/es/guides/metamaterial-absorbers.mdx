...
- **El panel microperforado es un absorbente con acoplamiento crítico avant
  ...
  cavidad, con cavidades de una décima a una vigésima de longitud de onda,
  un orden por debajo de la compresión del panel ranurado, así que la
  construcción no alcanza el régimen de sublongitud de onda profunda.
...
- [Resistencia al flujo de aire](/phonometry/es/guides/airflow-resistance/):
  ...
  granel.
- Referencia de la API: [`materials.slow_sound_absorber`](/phonometry/es/reference/api/materials/slow-sound-absorber/).

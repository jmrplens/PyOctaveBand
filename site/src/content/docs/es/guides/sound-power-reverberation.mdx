...
## 1. Sala reverberante, grado de precisión (ISO 3741)
...
cámara `Lp(ST)`, el área de absorción de Sabine `A = (55.26/c)·(V/T60)` y una
...
sonora de referencia de potencia conocida `LW(RSS)` medida en la misma cámara,
de modo que la cámara no necesita caracterizarse:
...
correcciones meteorológicas C1/C2, y el método de comparación con una
...
- [Acústica de salas](/phonometry/es/guides/room-acoustics/): la medición del
  tiempo de reverberación `T60` que fija el área de absorción de Sabine.
...
- [Teoría](/phonometry/es/reference/theory/environment-transport/): las
  derivaciones de Waterhouse y C1/C2.

...
`N` celdas iguales y coloca un acelerómetro en el centro de cada una, con `N`
fijado solo por el área.

<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_vibration_sound_power_es.svg" alt="Método de velocidad superficial de ISO/TS 7849: una máquina en ensayo con su superficie de medición vibrante de 2,5 por 1,6 metros dividida en diez celdas iguales, un acelerómetro en el centro de cada celda, el sonido aéreo radiado saliendo de la superficie, la tabla del número de posiciones de medida y la relación de control LWA = LvA + 10 lg(S/S0) + 10 lg épsilon" width="92%" />

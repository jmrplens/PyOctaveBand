...
description: "Adquisición de la respuesta al impulso (ISO 18233), parámetros de sala EDT/T20/T30/C50/C80/Ts (ISO 3382-1/2) y métricas de habla en oficinas diáfanas (ISO 3382-3)."
references:
  - type: book
    authors: ["Kuttruff, H."]
    year: 2016
...
sala (ISO 3382-1/2) y métricas espaciales del habla para oficinas diáfanas
(ISO 3382-3). Dos mediciones de decaimiento separadas en una cámara
reverberante, una con la sala vacía y otra con la probeta instalada, dan la
absorción acústica de un material; ese método
(ISO 354) vive en
...
($D_{2,S}$, $L_{p,A,S,4m}$, $r_D$, $r_P$) de `room.open_plan_metrics`.
...
$T_1$/$T_2$ medido se ha trasladado a su propia guía,
[Medida y clasificación de la absorción sonora](/phonometry/es/guides/absorption-measurement/).
...
- [Informe de conformidad](https://github.com/jmrplens/phonometry/blob/main/docs/CONFORMANCE.md): los decaimientos en forma cerrada y las
  definiciones de parámetros frente a los que se validan las implementaciones de ISO 18233 / ISO 3382.

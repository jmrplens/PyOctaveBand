...
description: "Predicción EN 12354 del aislamiento acústico in situ entre salas a partir de datos de elemento: los modelos de flancos aéreos y de impacto de EN 12354-1/2 con sus índices de reducción de vibraciones de unión y sus fichas de predicción."
references:
  - type: book
    authors: ["Hopkins, C."]
    year: 2007
...
predicción EN 12354 del comportamiento in situ entre salas a partir de datos
...
del cerramiento del edificio en lugar de entre dos salas: la EN 12354-3, el
...
- [Índices globales de aislamiento (ISO 717)](/phonometry/es/guides/insulation-ratings/):
  el motor de curva de referencia tras los R'w y L'n,w previstos.
- [Medición del aislamiento en laboratorio](/phonometry/es/guides/insulation-lab/):
...
- [Transmisión por flancos en laboratorio (ISO 10848)](/phonometry/es/guides/flanking-lab/):
  el índice de reducción de vibraciones de unión Kij medido que consume el modelo.

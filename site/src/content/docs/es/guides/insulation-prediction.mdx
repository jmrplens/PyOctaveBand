...
- Referencia de la API: [`building.prediction.global_model`](/phonometry/es/reference/api/building/global-model/) y [`building.prediction.facade`](/phonometry/es/reference/api/building/facade/).

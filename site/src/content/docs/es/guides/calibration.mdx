...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_calibration_dataflow_es.svg" alt="Flujo de datos de la calibración: la grabación del calibrador y la grabación de medición proceden de la misma cadena sin tocar, sensitivity() convierte la primera en el factor S en pascales por unidad digital y comprueba la estabilidad a corto plazo de IEC 60942, toda función de nivel acepta ese factor como calibration_factor y el resultado son niveles en dB SPL re 20 µPa; si se omite el factor, los niveles quedan en dBFS" width="92%" />

...
`spherical_spreading_adjustment` ($\Delta L_s = -20\lg(r/60)$, Ec. 24),
...
$10 C_h \lg\bigl(3 + (40/\lambda)\,C''\,\delta\bigr)$, con tope de 25 dB) con
...
la media geométrica, la difracción rasante da el clásico $10\lg 3$, y

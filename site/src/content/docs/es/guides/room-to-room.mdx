...
reverberantes, $\text{TL} = 10\lg(1/\tau)$ la pérdida por transmisión de la
...
relevante es $L_{p1} = L_W + 10\lg(4/R_1)$. Eso es `steady_state_spl` con
...
$10\lg 4 = 6{,}02\ \text{dB}$, y sin él las respuestas impresas salen 6 dB
por debajo.
...
los paneles, $\text{TL} = \text{IL} + 10\lg(S_E / R_i)$, que es

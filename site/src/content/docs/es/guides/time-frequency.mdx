...
dos estimadores tiempo-frecuencia de `phonometry.signal`, ambos con la
...
- Referencia de la API: [`signal.time_frequency`](/phonometry/es/reference/api/spectra/time-frequency/).

...
útil (apartado 7.3, Tabla 3), y el índice residual de presión-intensidad
`δpI0` como el suelo de error de fase del instrumento. ISO 9614-1:1993 para
los indicadores de campo del Anexo A F2, F3 y F4 (`field_indicators`) y el
criterio de capacidad dinámica del Anexo B (`dynamic_capability_index`).

**No cubierto.** La propia determinación de potencia sonora de ISO 9614-1,
...
la [guía de potencia sonora](/phonometry/es/guides/sound-power/). Los
límites de aceptación del índice residual de clase 1 / clase 2 de
IEC 61043 tampoco se verifican en la biblioteca: `δpI0` es un valor que
quien mide aporta desde su propia cadena sonda-analizador, no algo que
phonometry clasifique.

...
description: "La respuesta al impulso determinista por fuentes imagen de una sala rectangular (Kuttruff, Vorländer) y el nivel estacionario estadístico con la constante de sala, la distancia crítica y la frecuencia de Schroeder (Bies)."
references:
  - type: book
    authors: ["Kuttruff, H."]
    year: 2016
...
y las cuatro imágenes de primer orden le siguen entre 17,3 y 21,6 ms.

...
<ThemeImage
  ...
  alt="Desviación del umbral de audición según ISO 7029 de un hombre de 70 años sobre un eje de audiograma invertido de 125 Hz a 8000 Hz: la mediana sube desde unos 3 dB a 125 Hz hasta unos 45 dB a 8000 Hz, el fractil 90 % pedido queda muy por debajo y la banda sombreada del 10 al 90 por ciento se ensancha hacia las frecuencias altas"
  width="88%"
/>

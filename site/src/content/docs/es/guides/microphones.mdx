...
sensibilidad es $L_M = 20\lg(M / 1\,\text{V/Pa})$ dB, negativo para todo
...
de directividad** $D = 20\lg(M_0/M_\mathrm{diff})$ compara la sensibilidad
...
ambos $10\lg 3 = 4{,}8$ dB: en un campo difuso de sala, un cardioide
...
ponderada, $L_N = 20\lg\bigl((U_N/M)/20\,\mu\text{Pa}\bigr)$. La norma lo

...
sola magnitud, el **índice de reverberación** $k = 10\lg(T/T_0)$
...
$D_n = D + k + 10\lg(A_0 T_0/(0{,}16\,V))$, la aparente
$R' = D + k + 10\lg(S T_0/(0{,}16\,V))$ (usando $V/7{,}5$ como $S$ cuando es
...
*El índice de reverberación $k = 10\lg(T/T_0)$ desplaza la diferencia de
...
reverberación $k = 10\lg(T/T_0)$ medido con
...
- Referencia de la API: [`building.survey_insulation`](/phonometry/es/reference/api/building/survey-insulation/).

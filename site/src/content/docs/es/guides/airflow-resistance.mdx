...
[absorbedor de rendija](/phonometry/es/guides/metamaterial-absorbers/) la hereda
por rendija; y cuando una medida en
[tubo de impedancia](/phonometry/es/guides/impedance-tube/) discrepa de una
...
- [Tubo de impedancia](/phonometry/es/guides/impedance-tube/): la medida a
...
- [Medida y clasificación de la absorción sonora](/phonometry/es/guides/absorption-measurement/):
  ...
  terminado.
- Referencia de la API: [`materials.airflow_resistance`](/phonometry/es/reference/api/materials/airflow-resistance/).

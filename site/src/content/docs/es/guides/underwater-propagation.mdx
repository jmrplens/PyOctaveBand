...
| `normal_modes` | Baja frecuencia, aguas someras, independiente de la distancia | Suma modal exacta con pocos modos propagantes ($m < kD/\pi$); la solución de referencia en su régimen |
| `parabolic_equation` | Baja frecuencia, caminos largos de un solo sentido | TL($z$,$r$) de campo completo con refracción; marcha perfiles arbitrarios en distancia |

...
Las dos herramientas de adquisición operan en el mismo marco de dos
canales: la excitación eléctrica es la referencia, el micrófono la
respuesta, y los espectros cruzados de Welch entre ambos dan la respuesta
en frecuencia más una coherencia que la vigila. La inversión regularizada
trabaja después sobre la respuesta medida, como post-proceso.

...
alrededor de su forma cerrada $10\lg(0{,}64/0{,}25) = 4{,}1$ dB en toda
frecuencia.*
...
- **ENBW** (ancho de banda equivalente de ruido, en bins): cuánto más ancho
  ...
  $10\lg(\mathrm{ENBW})$ dB por encima de la densidad verdadera.
...
$20\lg(N\sin(\pi/2N))$, el núcleo de Dirichlet evaluado medio bin fuera del
centro.

...
El estimador es una cadena fija, y cada cifra de calidad que reporta se
deriva de una única decisión de diseño, la longitud del segmento. El diagrama
la recorre con los números del ejemplo de esta página.

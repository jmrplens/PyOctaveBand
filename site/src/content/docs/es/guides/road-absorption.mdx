...
- **Área muestreada.** La técnica de sustracción promedia del orden de 3 m²
  de superficie por posición (el radio de área muestreada de 1,34 m de la
  sección 1), una muestra razonable de textura y juntas; el método puntual
...
- [Tubo de impedancia](/phonometry/es/guides/impedance-tube/): el método de
...
- [Difusores y sus coeficientes](/phonometry/es/guides/diffusers/): la otra
...
- [Propagación en exteriores](/phonometry/es/guides/outdoor-propagation/):
  ...
  propagación.
- Referencia de la API: [`materials.road_absorption`](/phonometry/es/reference/api/materials/road-absorption/).

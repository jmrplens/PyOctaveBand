...
un factor que crece con la ponderación de agudeza `wS` y la ponderación combinada
...
`wS` es cero para `S ≤ 1,75 acum` (la agudeza solo añade molestia por encima de
...
sonoridad Zwicker variable en el tiempo de la ISO 532-1, `S` de la agudeza DIN

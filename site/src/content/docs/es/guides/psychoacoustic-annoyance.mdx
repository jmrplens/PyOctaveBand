...
la sonoridad Zwicker variable en el tiempo de la ISO 532-1, $S$ de la agudeza
...
un orden de magnitud más abajo, en $f_{mod} \approx 4\ \text{Hz}$ en lugar del
máximo de la
...
nivel $L$ y la frecuencia de modulación $f_{mod}$:
...
$f_{mod} \approx 3{,}7\ \text{Hz}$ y crece a ambos lados. El resultado se
...
- Referencia de la API: [`psychoacoustics.psychoacoustic_annoyance`](/phonometry/es/reference/api/psychoacoustics/annoyance/) y [`psychoacoustics.fluctuation_strength`](/phonometry/es/reference/api/psychoacoustics/fluctuation-strength/).

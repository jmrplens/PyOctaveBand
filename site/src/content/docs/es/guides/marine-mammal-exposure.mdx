...
:::note
NMFS 2024 imprime $C = 1,37$ dB para el grupo de otáridos en agua y afirma en la
nota al pie de esa misma tabla que el valor debería ser 1,36 dB. La biblioteca

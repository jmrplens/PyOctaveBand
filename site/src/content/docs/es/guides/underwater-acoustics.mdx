...
references:
  ...
  - type: standard
    ...
    note: "Las referencias de 1 µPa (presión) y 1 µPa²·s (exposición) y las definiciones de nivel de presión sonora, nivel de exposición sonora y nivel de pico."
  - type: standard
    organization: "International Organization for Standardization"
    year: 2016
  ...
  - type: standard
    ...
    note: "La exposición sonora por golpe (Fórmulas 3–4), de pico y acumulada (Fórmulas 8–9) de la sección 3, y el nivel de presión sonora cuadrático medio (Fórmula 7) de la sección 1."
---
...
con `p₀ = 1 µPa` y `E₀ = 1 µPa²·s`. El nivel de presión sonora es el nivel

...
(20 µPa), que supone un desplazamiento de $20\lg(20) \approx 26{,}02$ dB y **no** una
...
$\Delta L$ diverge a `u` bajo (rasante / baja frecuencia) y tiende a `−10·lg(2) =
...
- El modelado general de propagación submarina (rayos, modos normales, ecuación parabólica) se cubre en [Solvers numéricos de propagación submarina](/phonometry/es/guides/underwater-solvers/).

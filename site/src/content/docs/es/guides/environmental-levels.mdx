...
Una comunidad no oye un único LAeq: oye un día cuyas tardes y noches pesan
...
Combínalo con `laeq()` por periodo para ir de grabaciones a Lden. El propio
...
cribado de emisión complementario, no la base del Kt.
...
**Cubierto.** El Lden, el Ldn y el nivel de valoración compuesto de la ISO
...
- [Niveles integrados y estadísticos](/phonometry/es/guides/levels/): los niveles Leq/LAeq, percentiles y de suceso con los que se componen los indicadores de esta página.
- [Audibilidad objetiva de tonos en ruido (ISO/PAS 20065)](/phonometry/es/guides/tone-audibility/): la audibilidad tonal cuyo valor medio se traduce en el ajuste Kt (Tabla J.1).

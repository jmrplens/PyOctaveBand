...
- [Elegir un método](/phonometry/es/devices/emission/sound-power/#elegir-un-método) — las siete rutas hacia la potencia acústica y cuál permite cada instalación.

...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/filter_butter_fraction_3_order_6_es.svg" alt="Respuesta en frecuencia del banco de filtros Butterworth de tercio de octava, 33 bandas de 12,5 Hz a 20 kHz con orden 6" width="80%" />
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_calibration_setup_es.svg" alt="Cadena de calibración: calibrador acústico acoplado en el micrófono a 94,0 dB y 1 kHz, preamplificador, interfaz de audio y la sensibilidad que convierte unidades digitales en pascales" width="92%" />
...
El análisis en octavas de arriba usa `phonometry.filters`, uno de los diecinueve

...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diffuse_field_absorption.svg" alt="Coeficiente de absorción de una capa porosa de 50 mm con respaldo rígido frente a la frecuencia de 125 Hz a 4 kHz: el promedio de Paris a incidencia aleatoria queda por encima de la curva a incidencia normal, y las dos convergen a medida que la capa se hace gruesa frente a la longitud de onda" width="80%" />

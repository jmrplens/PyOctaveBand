...
- **El aire, medido y no supuesto (apartado 7.2).** $c_0$ y $\rho c_0$ no son
  ...
  `air_density_iso10534(temperature_c=..., atmospheric_pressure_kpa=...)`. Las
  dos ecuaciones están escritas en kelvin y los dos argumentos van en grados
  Celsius, como cualquier otra temperatura de la biblioteca; la conversión
  ocurre dentro, así que los 293 K impresos siguen literales frente a la
  página. El fragmento de la ficha de abajo las alimenta directamente a

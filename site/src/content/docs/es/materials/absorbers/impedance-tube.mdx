...
[solucionador FDTD](/phonometry/es/simulation/fdtd-simulation/) y recupera la respuesta
...
ejecuta esta misma medición de forma virtual dentro del solucionador FDTD y
...
## 5. El tubo virtual: el solucionador medido por las normas

Un dominio de tres filas con paredes rígidas del
[solucionador FDTD 2D](/phonometry/es/simulation/fdtd-simulation/) es un tubo de onda
...
- [Absorbentes porosos y multicapa](/phonometry/es/materials/absorbers/porous-absorbers/):
  los modelos de fluido equivalente y el solucionador multicapa cuya matriz de
  cadena se lee con la misma maquinaria ASTM E2611 que una probeta medida.
- [Simulación FDTD](/phonometry/es/simulation/fdtd-simulation/): el solucionador 2D

...
de geometría, validez y corrección, y la reducción por función de
transferencia de dos micrófonos es la rutina ISO 10534-2 de [Tubo de
impedancia](/phonometry/es/materials/absorbers/impedance-tube/). Nada de esta
subsección mide el ruido que una superficie *genera* — el término de fuente de
rodadura es terreno de CNOSSOS, en [Fuentes

...
Cualquier otra cosa lanza en vez de devolver un número que nadie imprimió:
...
rechaza es un estado que no puede darse: una temperatura igual o por debajo del
cero absoluto, una presión no positiva, una humedad fuera de cero y la
saturación.

## Cómo se fijan los números

El oráculo es la Tabla F.1: cinco magnitudes en dos conjuntos de condiciones,
diez cifras en total. La tolerancia no se elige. Un valor impreso con siete
cifras significativas está enunciado con media unidad de su última posición, así
que eso es lo que significa reproducirlo, y el test deriva esa cota de la cadena
impresa en vez de llevar una constante que alguien escogió:

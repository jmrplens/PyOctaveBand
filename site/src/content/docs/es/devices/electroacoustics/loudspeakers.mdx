...
con $L_{H\text{-}M} = 76$ dB y $L_{H\text{-}L} = 80$ dB. Las ganancias de lazo
...
2. **Excita con ruido rosa** y lee el nivel en la posición del micrófono con el
   ...
   hacia dónde apunta forman parte del lazo. Eso es $L_{H\text{-}M}$. Acercar o
...
| `microphone_directivity` | float | dB | por defecto 0 | $D_M(\theta)$, 0 omni, unos -2 cardioide |
| `open_microphones` | int | — | ≥ 1, por defecto 1 | $N_m$ |
...
**No cubierto.** Las funciones no comprueban ninguna de las condiciones de
arriba: reducen y presentan las curvas que se les entregan, así que el
...
en torno a la potencia admisible (potencia de ruido nominal, tensiones

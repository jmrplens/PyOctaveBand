...
[Calibración y dBFS](/phonometry/es/signal/metrology/calibration/).
...
- [Calibración y dBFS](/phonometry/es/signal/metrology/calibration/): convertir la
  sensibilidad nominal de un micrófono en niveles de presión acústica
  calibrados.
- [Montar un sonómetro](/phonometry/es/signal/sound-level-meter/): la cadena

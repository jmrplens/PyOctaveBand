...
los estimadores de respuesta en frecuencia $H_1$/$H_2$ de Bendat y
...
dispositivo con una senoide de 997 Hz 60 dB por debajo de plena escala, elimina la
...
- **Distorsión de modulación** (14.12.7): un tono grave grande $f_\text{low}$
  y un tono agudo pequeño $f_\text{high}$ (preferiblemente 4:1). Los valores
  por orden son sumas *aritméticas* de las amplitudes de las bandas laterales
...
- **Distorsión total por frecuencia diferencia** (14.12.10): un ensayo de dos
  tonos específico ($f_1 = 2f_0$, $f_2 = 3f_0 - \delta$; los tonos
...
- **Intermodulación dinámica** (DIM, 14.12.9): una senoide de 15 kHz más una onda
...
significativa; un único segmento da $\gamma^2 \equiv 1$ por construcción.

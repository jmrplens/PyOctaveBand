...
Todos menos el último son valores impresos del ejemplo 1 del anexo A, y el
resultado lleva además el resto de intermedios impresos, así que un cálculo se
puede contrastar con la norma fila a fila en vez de darlo por bueno.

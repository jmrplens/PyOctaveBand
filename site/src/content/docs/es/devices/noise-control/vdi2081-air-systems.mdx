...
references:
  - type: standard
    ...
    primary: true
    note: "El método: el ventilador del apartado 4.3 con las Ecuaciones (13) y (15), la atenuación de conducto del apartado 6 con las Tablas 5 y 7, el ruido de flujo de las Ecuaciones (16), (17) y (18), el silenciador de bafles y su ruido propio de la Ecuación (49), la reflexión de boca del apartado 6.6 y el paso a la sala de la Ecuación (36). Sustituida por Blatt 1:2022-04, que no está en la biblioteca."
  - type: standard
    organization: "Verein Deutscher Ingenieure"
    year: 2005

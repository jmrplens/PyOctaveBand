...
references:
  - type: standard
    ...
    primary: true
    note: "El método: el ventilador del apartado 4.3 con las Ecuaciones (13) y (15), la atenuación de conducto del apartado 6 con las Tablas 5 y 7, el ruido de flujo de las Ecuaciones (16) y (17), el silenciador de bafles y su ruido propio de la Ecuación (49), la reflexión de boca del apartado 6.6 y el paso a la sala de la Ecuación (36). Sustituida por Blatt 1:2022-04, que no está en la biblioteca."
  - type: standard
    organization: "Verein Deutscher Ingenieure"
    year: 2005
...
- **Un tramo recto** (apartado 5.2.1, Ecuaciones (16) y (17) con la Figura 16),
  ...
  `flow_noise_straight_duct` para las octavas sobre las que la Figura 16
  reparte el primero de ellos.
...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/vdi2081_flow_noise_es.svg" alt="Dos paneles. A la izquierda, el nivel de potencia acústica global de un tramo recto frente a la velocidad en el conducto, de 1 a 15 metros por segundo, para una sección de 0,2 metros cuadrados: una curva continua para la Ecuación 16 que sube de 0 a 59 decibelios y otra discontinua para la Ecuación 17 ponderada A que sube de menos 32 a 50, la segunda más inclinada porque lleva una potencia setenta de la velocidad. Una línea vertical de puntos marca el ejemplo resuelto en 5,83 metros por segundo, donde los marcadores dan 38 y 22 decibelios. A la derecha, el espectro por octavas del mismo conducto a 3, 5,83 y 10 metros por segundo, tres curvas que caen de 63 hercios a 8 kilohercios, la más rápida a la vez la más alta y la más plana." width="100%" />

*La quinta potencia de la velocidad es toda la regla de diseño: un conducto
dimensionado para la mitad de velocidad suena quince decibelios menos, y veintiuno
en el número ponderado A.*

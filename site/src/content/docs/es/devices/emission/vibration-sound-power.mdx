...
la verdad. Después ejecuta la misma escena dos veces, a $f_c/2$ y a $2f_c$, sin
...
$\lambda_B = 0{,}40$ m es *más corta* que los 0,57 m del sonido en aire, así que
$\sin\theta = \lambda/\lambda_B$ no tiene solución — no hay ángulo por el que el
sonido pueda salir — y la piel que ocupa su lugar decae con una altura de
$1/\sqrt{k_B^2 - k_0^2} = 0{,}091$ m; por encima de la coincidencia, que
$\lambda_B = 0{,}20$ m es *más larga* que los 0,14 m en aire, así que la traza

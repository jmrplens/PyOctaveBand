...
<ThemeImage src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/radiation_plate_geometry.svg" alt="Vista frontal a escala de la placa del modelo de radiación: una placa gris de 1,5 m por 1,25 m simplemente apoyada dentro de su pantalla rígida rayada, con ambos lados acotados y la condición de contorno en el título" width="82%" loading="eager" />

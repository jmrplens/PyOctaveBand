...
- [Intensidad acústica (p-p)](/phonometry/es/devices/emission/intensity/): la sonda de
  ...
  de ISO 9614-1 que sustentan los métodos de barrido y la determinación en
  puntos discretos que esos indicadores cualifican.

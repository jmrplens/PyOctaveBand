...
vibración](/phonometry/es/devices/emission/vibration-sound-power/). Y también
la séptima que nombra la ruta de decisión, la suma por puntos discretos de
ISO 9614-1, que vive en [Intensidad
acústica](/phonometry/es/devices/emission/intensity/) junto a los indicadores
de campo del Anexo A que presta a las partes de barrido. La ISO 3743-1, la
ISO 3743-2 y la ISO 3747, los miembros restantes de la familia ISO 3740, no

...
hoja de datos, alimenta una predicción de sala (EN 12354) o se contrasta con
...
declaración de emisión sonora ISO 4871 que imprime una hoja de datos.
...
1. **¿Para qué es el número?** Una declaración de hoja de datos o una
...
de emisión independiente del dispositivo que figura en una hoja de datos o

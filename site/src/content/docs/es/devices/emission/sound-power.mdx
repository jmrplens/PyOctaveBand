...
número único, $L_{WAd} = L_{WA} + K_{WA}$ y la verificación del apartado 6.2
...
sucesos aislados. El nivel de presión acústica de emisión $L_{pA}$ que
acompaña a $L_{WA}$ en una declaración se consume, no se determina: la ISO
...
allá del caso de máquina única $K = 1{,}645\,\sigma_R$ (Anexo A.2.2) se

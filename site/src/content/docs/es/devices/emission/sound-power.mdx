...
description: "El nivel de potencia acústica LW como descriptor de emisión independiente del dispositivo: la elección entre las ocho vías de determinación normalizadas (ISO 3744/3746, ISO 3745, ISO 3741, ISO 3747, ISO 9614-1, ISO 9614-2, ISO 9614-3, ISO/TS 7849), qué prometen los grados de precisión, y la declaración de emisión sonora de ISO 4871 con sus formas de número doble y único y su verificación."
references:
  - type: book
...
un límite de emisión de ruido. phonometry implementa ocho vías normalizadas
para obtenerlo, repartidas en seis guías: una superficie envolvente de
...
la misma comparación con una fuente sonora de referencia llevada a la sala
en la que trabaja la máquina (ISO 3747), cubierta en
...
Todas proporcionan la misma magnitud para una fuente que funciona de forma
estacionaria, un $L_W$ por banda y un total ponderado A $L_{W\mathrm{A}}$, pero
bajo entornos, grados de precisión y restricciones prácticas distintos. Una
fuente que emite por ráfagas no tiene potencia estacionaria que declarar, y la
vía in situ determina en su lugar su nivel de energía sonora $L_J$
(apartado 8.5).
...
| Comparación in situ | **ISO 3747** | Presión acústica de la fuente y de una fuente sonora de referencia calibrada en las mismas posiciones | La parte reverberante de la sala en la que trabaja la máquina ($\Delta L_f \ge 7$ dB) | Grado 2 ($\sigma_{\mathrm{R}0} \approx 1{,}5\ \text{dB}$) / grado 3 ($\approx 4{,}0\ \text{dB}$) | Una máquina que no puede salir de su instalación, en una sala demasiado reverberante para una superficie envolvente |
...
electrodomésticos, y ninguna está implementada aquí. En la práctica, para un
electrodoméstico pequeño, la ISO 3744 sobre una semiesfera en esa misma sala
suele estar disponible con el mismo grado. Su pariente in situ, la ISO 3747,
está en la tabla y tiene su propia guía,
[Potencia acústica in situ por comparación](/phonometry/es/devices/emission/sound-power-in-situ/):
la fórmula de comparación de la
[página de ISO 3741](/phonometry/es/devices/emission/sound-power-reverberation/#2-el-método-de-comparación-ec-21)
aplicada a la sala en la que trabaja la máquina en lugar de a una cámara
cualificada, con el ruido de fondo corregido en cada posición de micrófono y
el grado leído del exceso de nivel de presión acústica. La lámina de abajo
dibuja siete de las ocho: la comparación in situ comparte el álgebra de la
fila de presión acústica con la ISO 3741 y se dibuja en su propia página.
...
Las ocho dan la misma magnitud, y la última llega sin micrófono. Que
...
grado 2 (ISO 3744, ISO 3747, ISO 9614-2) y 3 dB o más para el grado 3 (aún mayores
...
de por segundo, definido en los mismos apartados de la ISO 3741, la ISO 3744 y
la ISO 3746 y determinado por `sound_energy_pressure` sobre la [superficie
envolvente](/phonometry/es/devices/emission/sound-power-pressure/#4-nivel-de-energía-acústica-de-una-ráfaga-apartado-83),
por `sound_energy_reverberation`, o por `sound_energy_comparison` contra una
fuente de referencia, en la [cámara
reverberante](/phonometry/es/devices/emission/sound-power-reverberation/#4-nivel-de-energía-acústica-de-un-suceso-aislado-apartado-92)
y por `sound_energy_in_situ` allí donde la máquina trabaja, en [Potencia
acústica in situ por comparación](/phonometry/es/devices/emission/sound-power-in-situ/#2-fuentes-impulsivas-el-nivel-de-energía-acústica-ec-13-a-20).
La prueba práctica: si el nivel
...
Las ocho determinaciones viven en sus guías de método: la superficie
...
vibración](/phonometry/es/devices/emission/vibration-sound-power/), y la
comparación in situ de ISO 3747 en [Potencia acústica in situ por
comparación](/phonometry/es/devices/emission/sound-power-in-situ/). La
ISO 3743-1 y la ISO 3743-2, los miembros restantes de la familia ISO 3740, no
están implementadas. El nivel de *energía* acústica $L_J$ de un suceso aislado
sí lo está, para la ISO 3744, la ISO 3746, la ISO 3741 y la ISO 3747, cada una
en su propia página; la ISO 3745 no define ninguno.
El nivel de presión acústica de emisión $L_{p\mathrm{A}}$ que
...
- [Potencia acústica en cámara reverberante (ISO 3741)](/phonometry/es/devices/emission/sound-power-reverberation/):
  ...
  y meteorológicas.
- [Potencia acústica in situ por comparación (ISO 3747)](/phonometry/es/devices/emission/sound-power-in-situ/):
  la comparación con una fuente de referencia donde trabaja la máquina, con
  el nivel de energía acústica de una fuente impulsiva.
...
- [Potencia acústica a partir de la vibración (ISO/TS 7849)](/phonometry/es/devices/emission/vibration-sound-power/):
  la vía de velocidad superficial, para una máquina a la que no puede acercarse un micrófono.
...
ISO 3741, ISO 3747, ISO 9614-1, ISO 9614-2, ISO 3745, ISO 9614-3 e ISO/TS 7849.
...
(ISO 3744, ISO 3747, ISO 9614-2) y 3 dB o más para el grado 3. Un $L_{W\mathrm{A}}$ de grado 2

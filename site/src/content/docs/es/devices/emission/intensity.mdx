...
presupuesto y el procedimiento no puede ayudar. Ese caso, y el de que no exista
subconjunto que cumpla las condiciones, se rechazan con un mensaje que nombra
la acción (d) de la tabla B.3, que es a lo que recurre la norma.

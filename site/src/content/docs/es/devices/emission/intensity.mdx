...
el valor verdadero dentro de $\pm 2s$ del medido con una confianza del 95 %; y
una banda que haya fallado el criterio 2 aún puede registrarse, siempre que la
acompañe el intervalo de confianza del 95 % de la ecuación (B.3):

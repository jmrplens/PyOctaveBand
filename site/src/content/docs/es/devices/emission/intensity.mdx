...
inspección); y $L_d = \delta_{pI0} - K$ es la **capacidad dinámica**, el mayor
...
registra $I_n$ en todas las bandas. Gira la sonda **180° alrededor de un eje
...
nivel máximo **los dos valores de $I_n$ deben tener signos opuestos y los dos
...
comprobación previa al uso del apartado 14 y el ensayo de inversión de la sonda
de ISO 9614-2 son igualmente procedimientos, no funciones.

...
<details>
<summary>Ver el código de la figura de potencia acústica</summary>
...
ax.set_xlabel("Frecuencia [Hz]")
ax.set_ylabel("Nivel de potencia acústica $L_W$ [dB re 1 pW]")
ax.set_title("Espectro de potencia acústica ISO 9614-1 "

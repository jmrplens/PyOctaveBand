...
nada aquí lo ejecuta. Tampoco hay una *función auxiliar* de normalización: la
sección 7 enseña la ganancia única, y aplicarla es una multiplicación. Y nada
de esta página es un **modelo** de sonoridad — la ponderación K es un filtro
lineal fijo, así que el enmascaramiento, la dependencia con el nivel, las bandas
críticas y la suma binaural quedan fuera por construcción; eso vive en
[Sonoridad (ISO 532)](/phonometry/es/perception/psychoacoustics/loudness/).

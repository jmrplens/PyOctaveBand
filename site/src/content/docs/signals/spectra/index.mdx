...
estimators ([spectral
analysis](/phonometry/signals/spectra/spectral-analysis/), [multiple and
partial coherence](/phonometry/signals/spectra/miso-coherence/)), the
time-frequency middle ground
([spectrograms](/phonometry/signals/spectra/time-frequency/)), the
spectrum-shape methods
([cepstrum](/phonometry/signals/spectra/cepstrum-echoes/)), the period-domain
methods ([synchronous
averaging](/phonometry/signals/spectra/synchronous-averaging/)), the
time-domain estimators ([correlation and
delay](/phonometry/signals/spectra/correlation-delay/)), and the stimulus and
system toolbox ([test
signals](/phonometry/signals/spectra/test-signals/), [system
measurement](/phonometry/signals/spectra/system-measurement/)).
...
qualification](/phonometry/signals/metrology/data-qualification/) tests decide;
when a record fails them, the honest tools are the short-time views rather than
the averaged ones.

[Calibrated spectral analysis](/phonometry/signals/spectra/spectral-analysis/) is where
...
intensity](/phonometry/devices/emission/intensity/).

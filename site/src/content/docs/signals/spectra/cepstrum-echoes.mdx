...
$f_m$ on an analysis bin the magnitude detector reads 0.3996 against the closed
...
harmonics survive the detector), and choose $f_s$ at least 2.56 times the top of

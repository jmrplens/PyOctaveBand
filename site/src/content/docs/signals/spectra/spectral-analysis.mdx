...
**Covered.** Bendat & Piersol's Welch estimators (*Random Data*, 4th ed.,
...
[sound intensity](/phonometry/devices/emission/intensity/) pages, not here. So is
multiple and partial coherence, on the
[MISO coherence](/phonometry/signals/spectra/miso-coherence/) page. This page

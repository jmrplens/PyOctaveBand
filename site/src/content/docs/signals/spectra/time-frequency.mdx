...
`OctaveFilterBank.spectrogram` on the [Levels](/phonometry/signals/levels/levels/)
page. Tracking a single component's instantaneous frequency over time is
the Hilbert envelope of `envelope`, on the
[Correlation and delay](/phonometry/signals/spectra/correlation-delay/) page, not

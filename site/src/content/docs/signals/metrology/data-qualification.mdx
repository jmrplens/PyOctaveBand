...
$2\sqrt{f_c^2 + B^2/12} = 2013.3$, an apparent frequency of 1007 Hz; from there
...
- [Levels](/phonometry/signals/levels/levels/): the $L_{eq}$ whose definition assumes one stationary measurement.

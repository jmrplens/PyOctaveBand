...
- Theory: [Magnitude Responses](/phonometry/reference/theory/signal-analysis/#magnitude-responses-hjw): what a magnitude response is as a complex transfer function, and how the five architectures differ before any band is filtered.

...
[Filter Banks](/phonometry/signals/filters/filter-banks/), [Frequency
...
[Filter Banks](/phonometry/signals/filters/filter-banks/) instead. `high_accuracy`
...
Weighting](/phonometry/signals/levels/weighting/) for the offline high-accuracy
...
[Integrated and Statistical Levels](/phonometry/signals/levels/levels/) describes.

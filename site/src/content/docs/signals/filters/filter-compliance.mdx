...
not an instrument. Those tests belong to IEC 61260-2:2016 (pattern evaluation)
and IEC 61260-3:2016 (periodic tests), which section 3b summarizes and this
page does not run. Near Nyquist, the bilinear transform warps the frequency

...
noise_control.fan_sound_power(relative_efficiency_percent=80.0, fan_static_pressure_pa=**duty).plot()
plt.show()

fig, ax = plt.subplots()
for efficiency in (90.0, 80.0, 55.0):
    res = noise_control.fan_sound_power(relative_efficiency_percent=efficiency, fan_static_pressure_pa=**duty)

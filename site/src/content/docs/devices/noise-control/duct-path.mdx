...
references:
  ...
  - type: standard
    ...
    note: "Section 6.7.3: the level an air outlet produces in a room (Equation (36)), the equivalent absorption area a reverberation time implies (Equation (37)) and the reverberation radius rH = 0,2 sqrt(A). Element 20 of the worked example in its Part 2:2005-05 is the case checked here."
  - type: standard

...
The air-handling unit and the outdoor-propagation chapters the superseding
editions added, which are not held here; the room acoustics VDI 2081 leaves to
VDI 2569; and the vibration isolation of the plant, which Section 7.6 of
Blatt 1 does cover and this library does not.
</ScopeClaim>
</Scope>

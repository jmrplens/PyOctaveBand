...
references:
  - type: standard
    ...
    primary: true
    note: "The method: the fan of Section 4.3 with Equations (13) and (15), the duct attenuation of Section 6 with Tables 5 and 7, the flow noise of Equations (16), (17) and (18), the splitter silencer and its self-noise of Equation (49), the end reflection of Section 6.6 and the room step of Equation (36). Superseded by Blatt 1:2022-04, which is not held here."
  - type: standard
    organization: "Verein Deutscher Ingenieure"
    year: 2005

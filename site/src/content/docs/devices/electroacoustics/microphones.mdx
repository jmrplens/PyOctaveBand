...
[Calibration and dBFS](/phonometry/signal/metrology/calibration/).
...
- [Loudspeaker Characterisation (IEC 60268-5)](/phonometry/devices/electroacoustics/loudspeakers/):
  ...
  the chain.
- [Calibration and dBFS](/phonometry/signal/metrology/calibration/): turning a
  microphone's rated sensitivity into calibrated sound pressure levels.
- [Build a sound level meter](/phonometry/signal/sound-level-meter/): the

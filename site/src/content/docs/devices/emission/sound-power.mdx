...
per second, defined in the same clauses of ISO 3741, ISO 3744 and ISO 3746 and
determined by `sound_energy_pressure` over the [enveloping
surface](/phonometry/devices/emission/sound-power-pressure/#4-sound-energy-level-of-a-burst-clause-83),
by `sound_energy_reverberation`, or `sound_energy_comparison` against a
reference source, in the [reverberation
room](/phonometry/devices/emission/sound-power-reverberation/#4-sound-energy-level-of-a-single-event-clause-92),
and by `sound_energy_in_situ` where the machine works, in [Sound Power in Situ
by Comparison](/phonometry/devices/emission/sound-power-in-situ/#2-impulsive-sources-the-sound-energy-level-eq-13-to-20).
...
situ comparison of ISO 3747 in [Sound Power in Situ by
Comparison](/phonometry/devices/emission/sound-power-in-situ/). ISO 3743-1 and
ISO 3743-2, the remaining members of the ISO 3740 family, are not implemented.
The sound *energy* level $L_J$ of a single event is covered for ISO 3744,
ISO 3746, ISO 3741 and ISO 3747, each on its own page; ISO 3745 defines none.
The emission sound pressure level $L_{p\mathrm{A}}$ that

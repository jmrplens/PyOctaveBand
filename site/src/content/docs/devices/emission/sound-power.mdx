...
vibration](/phonometry/devices/emission/vibration-sound-power/). ISO 9614-1's
own discrete-point power summation is not implemented at all; only its field
indicators are, in [Sound Intensity](/phonometry/devices/emission/intensity/).
ISO 3743-1, ISO 3743-2 and ISO 3747, the remaining members of the ISO 3740
family, are not implemented either, and neither is the sound *energy* level

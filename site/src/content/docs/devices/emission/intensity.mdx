...
$L_d = \delta_{pI0} - K$ is the **dynamic capability**, the largest field index
...
exceeds the surface mean; record $I_n$ in every band. Rotate the probe **180°
...
the band of maximum level **the two values of $I_n$ must have opposite signs and

...
The rest of Annex A and its neighbours: the early and late lateral energy
measures of A.2.4 and A.2.5, the interaural cross correlation of Annex B, the
stage support of Annex C, the measurement uncertainty of Clause 7, and the
source directivity qualification of Table 1.
</ScopeClaim>
</Scope>

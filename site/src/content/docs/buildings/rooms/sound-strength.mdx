...
description: "The one auditorium measure that needs a calibrated source: G as the energy of the measured impulse response against the same source at 10 m in a free field, and the three printed routes to that reference when no anechoic room is 10 m across."
references:
  - type: standard

...
ISO 3382-3 fiche through `.report()`. Long's *Architectural Acoustics* 2e
Chapter 17 crowd self-noise model (Eqs. (17.50) to (17.54)) through
`room.crowd_noise` and its parts.
...
they came from. The crowd self-noise model is a *design* calculation and

...
2 (Table 2.1 for façades, 2.1.1 airborne and party walls, 2.1.2 impact and 2.2
...
- Theory: [Room and building acoustics](/phonometry/reference/theory/rooms-buildings/#room-and-building-acoustics-iso-18233-iso-3382-iso-16283-iso-10140-en-12354-iso-12999-iso-717-iso-354): the quantities the code requires, derived from ISO 12354 and ISO 717 rather than from the code.

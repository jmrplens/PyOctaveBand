...
ISO 717-1:2020's reference-curve airborne rating (the 1 dB shifting rule with
the 32.0 dB / 10.0 dB unfavourable-deviation caps, read at 500 Hz) with the
Annex A spectrum adaptation terms $C$ and $C_{tr}$, via
`building.weighted_rating`; ISO 717-2:2020's impact rating with the opposite
deviation sign, the octave −5 dB reduction and the $C_I$ term, via
...
Nothing on this page measures: every function takes an already-measured (or
predicted) band spectrum from the
[field](/phonometry/buildings/insulation/insulation-field/),
[laboratory](/phonometry/buildings/insulation/insulation-lab/),
[intensity](/phonometry/buildings/insulation/insulation-intensity/),
[survey](/phonometry/buildings/insulation/insulation-survey/) or
[flanking](/phonometry/buildings/insulation/flanking-lab/) guides. The façade
single number of ISO 16283-3 Annex F and the flanking $D_{n,f,w}$ reuse these
...
rates, in [Heavy and Soft Impact
Sources](/phonometry/buildings/insulation/heavy-impact-sources/).
</ScopeClaim>
</Scope>

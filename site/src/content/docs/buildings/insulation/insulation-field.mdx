...
ISO 16283-1/-2's own position and procedure requirements — the counts,
distances and averaging of
[Taking the measurement](#taking-the-measurement-iso-16283-1-clauses-7-and-9)
and the corner measurements of
[Small rooms](#small-rooms-the-low-frequency-procedure-clause-8) — are
documented here and checked nowhere: energy-averaging happens once positions
are supplied, but nothing verifies how many were taken, where, or that the
25 m³ trigger was even tested for. The Formula (12) and (13) combination of the

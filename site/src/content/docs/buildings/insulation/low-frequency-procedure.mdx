...
result, and the eight rows it carries in the
[conformance report](/phonometry/reference/conformance/) judge printed numbers and
closed forms instead. What stands in for an oracle, one row at a time:

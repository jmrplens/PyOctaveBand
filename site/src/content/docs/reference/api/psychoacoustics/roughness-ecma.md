---
title: "psychoacoustics.quality.roughness_ecma"
...
is reused from [`phonometry.psychoacoustics.loudness.ecma`](/phonometry/reference/api/psychoacoustics/ecma/); this module
adds the roughness-specific chain:

* roughness-specific zero-padding (Clause 5.1.2.2) and segmentation
  (Clause 5.1.5.2) with the fixed block/hop $s_\mathrm{b} = 16384$ /
  $s_\mathrm{h} = 4096$
  (Clause 7.1.1);

...
* **BS ISO 13472-2:2010** - *spot method*. This is an **in-situ application of
  ...
  [`phonometry.materials.absorbers.impedance_tube.two_microphone_impedance`](/phonometry/reference/api/materials/impedance-tube/#two_microphone_impedance) and is **not**

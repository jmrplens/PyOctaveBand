...
$$
L'_{W,eq,line,i,m} = L_{W,i,m} + 10 \lg\left( \frac{Q_m}{1000 v_m} \right) \tag{2.2.1}
$$
...
$L_{W,segment,i} = L'_{W,eq,line,i} + 10 \lg(dL)$. This is
arithmetic, not a
...
$L_{WR,i,m} = A_{R,i,m} + B_{R,i,m} \lg(v_m/v_{ref}) + dL_{WR,i,m}$ with the
...
Evaluates
$L'_{W,eq,line,i,m} = L_{W,i,m} + 10 \lg(Q_m/(1000 v_m))$ for every

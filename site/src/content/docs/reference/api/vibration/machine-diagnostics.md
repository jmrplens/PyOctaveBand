...
| `lobe_orders` | Highest `\|k\|` in `mL = n N_blades +/- k N_vanes` (integer >= 1, Default: 1). |
...
| `count` | Number of harmonics, `>= 1` (the fundamental first). |
...
**Returns:** The shaft rotational frequency `fs`, in hertz.

...
restricted to shallow samples that absorb little ($\alpha_s \le 0.50$,
...
$R_s = \sigma d$, against the characteristic impedance of air: a rigidly backed
...
functions (7.5.1, Eq. 8), or measure a calibration factor $H_c$ once, as the

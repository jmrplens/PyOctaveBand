...
oversampled rate (≥ 144 kHz); see [Frequency Weighting](/phonometry/signal/levels/weighting/).
...
*The three IEC 61672-1 weighting curves realized by the library, with the small positive region of the A curve magnified. The special B, D and AU curves are charted in [Special Weightings](/phonometry/signal/levels/special-weightings/).*
...
See the [Special Weightings guide](/phonometry/signal/levels/special-weightings/) for usage.
...
See the [Levels guide](/phonometry/signal/levels/levels/) for usage and the [Calibration guide](/phonometry/signal/metrology/calibration/) for absolute-scale setup.
...
See the [GUM Uncertainty guide](/phonometry/signal/metrology/gum-uncertainty/) for usage.

...
$$
f_m = 1000 \cdot G^{(x-30)/b} \quad (b \text{ odd}), \qquad
f_m = 1000 \cdot G^{(2x-59)/(2b)} \quad (b \text{ even})
$$
...
**Exact centre against printed label.** The $f_m$ above is the exact midband
...
It is identical to $L_{EP,d}$ of Directive 86/188/EEC and $L_{EX,8h}$ of ISO 1999 (IEC 61252, 3.3 NOTES 5–6). The anchor of IEC 61252 (3.3 NOTE 4): an exposure of **3.2 Pa²h corresponds to $L_{EX,8h}$ of exactly 90 dB**. ISO 9612 prescribes how to sample a working day to obtain it and how to bound the result; see [Occupational noise exposure](/phonometry/reference/theory/environment-transport/#occupational-noise-exposure-iso-9612).

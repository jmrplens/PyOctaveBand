...
<img class="light-only" src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_bank_dataflow.svg" alt="Data flow inside one band of the filter bank: a low band, whose centre frequency is far below half the sample rate, takes the resample_poly decimation branch to fs over M so its poles stay clear of the unit circle, every band is then a cascade of second-order sections with the minus 3 dB points on the band edges rather than one high-order transfer function, both branches end in the band level in dB, and sigbands=True additionally returns the band signal at the input rate" style="width:92%" loading="lazy"><img class="dark-only" src="https://raw.githubusercontent.com/jmrplens/phonometry/main/.github/images/diagram_bank_dataflow_dark.svg" alt="Data flow inside one band of the filter bank: a low band, whose centre frequency is far below half the sample rate, takes the resample_poly decimation branch to fs over M so its poles stay clear of the unit circle, every band is then a cascade of second-order sections with the minus 3 dB points on the band edges rather than one high-order transfer function, both branches end in the band level in dB, and sigbands=True additionally returns the band signal at the input rate" style="width:92%" loading="lazy">

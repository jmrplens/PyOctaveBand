...
- Beranek, L. L., & Mellow, T. J. (2012). *Acoustics: Sound fields and
  ...
  [Loudspeaker Characterisation](/phonometry/guides/loudspeakers/) and
...
- International Electrotechnical Commission. (2014). *Sound system equipment —
  ...
  Cited by [Microphone Characterisation](/phonometry/guides/microphones/).
- International Electrotechnical Commission. (2007). *Sound system equipment —
  ...
  Cited by [Loudspeaker Characterisation](/phonometry/guides/loudspeakers/).
- International Electrotechnical Commission. (1982). *Scales and sizes for
  ...
  Cited by [Loudspeaker Characterisation](/phonometry/guides/loudspeakers/) and
  [Microphone Characterisation](/phonometry/guides/microphones/).
...
- Fahy, F. J. (1995). *Sound intensity* (2nd ed.). E&FN Spon.
  ...
  Cited by [Sound Power by Intensity Scanning](/phonometry/guides/sound-power-intensity/)
  and [Sound Intensity (p-p)](/phonometry/guides/intensity/).
...
- International Organization for Standardization. (2010). *Acoustics —
  ...
  Cited by [Sound Power in the Reverberation Room](/phonometry/guides/sound-power-reverberation/).
- International Organization for Standardization. (2010). *Acoustics —
  Determination of sound power levels and sound energy levels of noise
  ...
  Cited by [Sound Power by Pressure Methods](/phonometry/guides/sound-power-pressure/).
...
- Long, M. (2014). *Architectural acoustics* (2nd ed.). Academic Press.
  ...
  Cited by [Image Sources and the Steady-State Room Field](/phonometry/guides/room-image-sources/),
  [Open-Plan Office Acoustics](/phonometry/guides/open-plan-acoustics/) and
  [Loudspeaker Characterisation](/phonometry/guides/loudspeakers/).
...
- Cox, T. J., & D'Antonio, P. (2017). *Acoustic absorbers and diffusers:
  ...
  [Metadiffusers](/phonometry/guides/metadiffusers/) and
...
- Jiménez, N., Umnova, O., & Groby, J.-P. (Eds.). (2021). *Acoustic waves in
  ...
  Cited by [Metadiffusers](/phonometry/guides/metadiffusers/) and
  [Metamaterial Absorbers](/phonometry/guides/metamaterial-absorbers/).
- Hargreaves, T. J., Cox, T. J., Lam, Y. W., & D'Antonio, P. (2000). Surface
  ...
  Cited by [Diffusers and Their Coefficients](/phonometry/guides/diffusers/).
...
- Jiménez, N., Cox, T. J., Romero-García, V., & Groby, J.-P. (2017).
  ...
  Cited by [Metadiffusers](/phonometry/guides/metadiffusers/).
...
- Jiménez, N., Groby, J.-P., Pagneux, V., & Romero-García, V. (2017).
  ...
  Cited by [Metamaterial Absorbers](/phonometry/guides/metamaterial-absorbers/)
  and [Metadiffusers](/phonometry/guides/metadiffusers/).
...
- International Organization for Standardization. (2002). *Acoustics —
  ...
  radius.
  Cited by [In-situ Road-Surface Absorption](/phonometry/guides/road-absorption/).
- International Organization for Standardization. (2010). *Acoustics —
  Measurement of sound absorption properties of road surfaces in situ —
...
- SAE International. (2006). *Method for predicting lateral attenuation of
  ...
  Cited by [Airport noise](/phonometry/guides/airport-noise/).
...
- Ainslie, M. A. (2010). *Principles of sonar performance modelling*.
  ...
  [Underwater sound propagation](/phonometry/guides/underwater-propagation/)
  and [Marine-mammal noise exposure](/phonometry/guides/marine-mammal-exposure/).
...
- National Marine Fisheries Service (2018). *2018 Revision to: Technical
  ...
  Cited by [Marine-mammal noise exposure](/phonometry/guides/marine-mammal-exposure/).
...
- Moore, B. C. J. (2013). *An introduction to the psychology of hearing*
  ...
  Cited by [Advanced Loudness](/phonometry/guides/advanced-loudness/).

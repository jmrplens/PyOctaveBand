...
description: "Sound in the sea: the ISO 18405 reference levels, ship radiated noise (ISO 17208) and pile-driving exposure (ISO 18406), propagation from closed-form propagation loss and the sonar equation to ambient noise and full numerical solvers, and the marine-mammal hearing criteria that turn a level into an assessment."
---
...
solver](/phonometry/simulation/elastic-waves/) is the nearest thing the
library has.
</ScopeClaim>

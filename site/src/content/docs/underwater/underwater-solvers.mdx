...
throughout. Each is validated against an exact closed form: the ideal
pressure-release waveguide's modes, the circular-arc rays of a linear
gradient, and free-field spherical spreading, plus the mutual agreement of the
modal and PE transmission loss.
</ScopeClaim>

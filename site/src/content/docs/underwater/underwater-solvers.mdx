...
field). The three differ in what they approximate, not in what they model, so
choosing between them is a regime question — the table in section 5 is the short
answer.

...
[Levels](/phonometry/signal/levels/levels/) are defined on, while the integrated
...
See [Integrated & Statistical Levels](/phonometry/signal/levels/levels/) for
...
(clause 3.8) with the Fast and Slow time constants (clause 5.7),
...
subject of
[Build a sound level meter](/phonometry/signal/sound-level-meter/). ANSI
...
- [Levels](/phonometry/signal/levels/levels/): the percentile levels defined on the detector's output, and the integrated metrics that bypass it.
- [Build a sound level meter](/phonometry/signal/sound-level-meter/): the complete IEC 61672-1 instrument chain around this detector.
- [Frequency Weighting](/phonometry/signal/levels/weighting/): the A/C/Z filters applied before the detector.
- [Block Processing](/phonometry/signal/filters/block-processing/): streaming the detector over frames without state discontinuities.
- [Impulsive-sound prominence](/phonometry/environment/assessment/impulsive-sound/): the modern onset-based rating of impulses that replaced the I weighting.

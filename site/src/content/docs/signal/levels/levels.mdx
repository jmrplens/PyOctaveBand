...
- **Long-term community annoyance**: $L_{den}$/$L_{dn}$ and the ISO
  ...
  [Environmental Levels](/phonometry/environment/environmental-levels/).
...
level track (see [Time Weighting](/phonometry/signal/levels/time-weighting/)).
...
[Calibration](/phonometry/signal/metrology/calibration/).
...
of [Environmental Levels](/phonometry/environment/environmental-levels/) does.
...
[Environmental Levels](/phonometry/environment/environmental-levels/): the
...
See [Calibration and dBFS](/phonometry/signal/metrology/calibration/) to convert digital units to physical
SPL, and [Time Weighting](/phonometry/signal/levels/time-weighting/) for the envelope details. The
...
[data qualification](/phonometry/signal/metrology/data-qualification/) tests answer it
...
[Environmental Levels](/phonometry/environment/environmental-levels/). IEC
61252 was revised in 2025; only the formulae of the implemented first
edition (1993) are here, not the newer one.

## See also

- [Environmental Levels (ISO 1996-1/-2)](/phonometry/environment/environmental-levels/): the $L_{den}$/$L_{dn}$ indicators, rating levels and the ISO 1996-2 determination chain built on the levels of this page.
- [Time Weighting](/phonometry/signal/levels/time-weighting/): the Fast/Slow/Impulse detector the percentile levels are defined on.
- [Calibration](/phonometry/signal/metrology/calibration/): the sensitivity factor that turns digital units into the pascals every level here assumes.
...
- [Multichannel and Performance](/phonometry/signal/filters/multichannel/): per-channel levels and how to combine them energetically.

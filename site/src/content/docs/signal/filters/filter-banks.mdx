...
| `filter_type` | str | — | `'butter'` (default), `'cheby1'`, `'cheby2'`, `'ellip'`, `'bessel'` | See the [Filter Architecture Gallery](/phonometry/signal/filters/filter-gallery/) |
...
| `stateful` / `steady_ic` (class) | bool | — | default `False` | Streaming state; see [Block Processing](/phonometry/signal/filters/block-processing/) |
...
decibels, is
[Filter Class Verification](/phonometry/signal/filters/filter-compliance/): the
...
[Filter Architecture Gallery](/phonometry/signal/filters/filter-gallery/). The
Table 1 class acceptance masks and their verification
have moved to
[Filter Class Verification](/phonometry/signal/filters/filter-compliance/). Near

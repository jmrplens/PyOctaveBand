...
[Filter Banks](/phonometry/signal/filters/filter-banks/); proving that a designed
bank meets a performance class of IEC 61260-1 is
[Filter Class Verification](/phonometry/signal/filters/filter-compliance/).
...
reference stay in [Filter Banks](/phonometry/signal/filters/filter-banks/). The

...
[Time Weighting](/phonometry/signal/levels/time-weighting/#6-block-processing).
...
| `high_accuracy` (weighting) | resolves to `False` by default (the legacy bilinear design, see [Frequency Weighting](/phonometry/signal/levels/weighting/)); explicitly passing `True` raises `ValueError` | The polyphase resampling inside is block-incompatible |
...
[Filter Banks](/phonometry/signal/filters/filter-banks/), [Frequency
Weighting](/phonometry/signal/levels/weighting/) and [Time
Weighting](/phonometry/signal/levels/time-weighting/) already implement them:
...
[Filter Banks](/phonometry/signal/filters/filter-banks/) instead. `high_accuracy`
...
Weighting](/phonometry/signal/levels/weighting/) for the offline high-accuracy
...
[Integrated and Statistical Levels](/phonometry/signal/levels/levels/) describes.

...
The foundation page is [Filter Banks](/phonometry/signal/filters/filter-banks/). It
...
the job of the
[Filter Architecture Gallery](/phonometry/signal/filters/filter-gallery/): what their
...
[Block Processing](/phonometry/signal/filters/block-processing/) scales it in *time*:
...
[Multichannel and Performance](/phonometry/signal/filters/multichannel/) scales it in
...
- [Filter Banks](/phonometry/signal/filters/filter-banks/): the band mathematics,

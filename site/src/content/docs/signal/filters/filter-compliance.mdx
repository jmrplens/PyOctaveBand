...
parameter reference, is [Filter Banks](/phonometry/signal/filters/filter-banks/),
and the five architectures with their compared responses are
[Filter Architecture Gallery](/phonometry/signal/filters/filter-gallery/); the same
machinery applied to the frequency weightings is section 6 of
[Frequency Weighting](/phonometry/signal/levels/weighting/).
...
- [Filter Banks](/phonometry/signal/filters/filter-banks/): the band mathematics and
  the architectures whose class is verified here.
- [Frequency Weighting](/phonometry/signal/levels/weighting/): the companion
  verification of the A, C and Z curves against the IEC 61672-1 tolerance
  tables, with the G, B, D and AU curves covered in
  [Special Weightings](/phonometry/signal/levels/special-weightings/).
- [Sound Level Meter](/phonometry/signal/sound-level-meter/): the instrument

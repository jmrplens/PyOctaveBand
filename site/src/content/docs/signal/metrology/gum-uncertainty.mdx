...
[Data qualification](/phonometry/signal/metrology/data-qualification/) provides the
...
- **Calibration.** The calibrator's class tolerance and the pre/post drift
  bound of [Calibration](/phonometry/signal/metrology/calibration/) are textbook
...
- **Environmental levels.** The ISO 1996-2 combined uncertainty of the
  [Environmental Levels](/phonometry/environment/environmental-levels/) page is
...
- [Data qualification](/phonometry/signal/metrology/data-qualification/): the stationarity checks every averaged input silently assumes.
- [Calibration](/phonometry/signal/metrology/calibration/): the tolerance and drift inputs of every calibrated chain.

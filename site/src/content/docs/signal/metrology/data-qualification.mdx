...
Every average in this documentation - a [PSD](/phonometry/signal/spectra/spectral-analysis/), a
[Leq](/phonometry/signal/levels/levels/), a
[GUM budget](/phonometry/signal/metrology/gum-uncertainty/) - assumes the record is
...
[Welch autospectrum](/phonometry/signal/spectra/spectral-analysis/):
...
[Welch PSD](/phonometry/signal/spectra/spectral-analysis/) and the random-error
formulas of the [correlation estimators](/phonometry/signal/spectra/correlation-delay/)
all assume the record is stationary, as does the very idea of *the* $L_{eq}$ of
a measurement in [Levels](/phonometry/signal/levels/levels/). When a record fails
...
[calibrated spectrogram](/phonometry/signal/spectra/time-frequency/) - that do not
assume stationarity. And when it passes, the
[GUM machinery](/phonometry/signal/metrology/gum-uncertainty/) can propagate the

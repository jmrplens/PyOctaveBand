...
[spectral-analysis page](/phonometry/signal/spectra/spectral-analysis/): the
...
[levels page](/phonometry/signal/levels/levels/) offers the fractional-octave-band
...
[Welch estimate](/phonometry/signal/spectra/spectral-analysis/) is the low-variance
...
[`power_spectral_density`](/phonometry/signal/spectra/spectral-analysis/), so the
two are mutually consistent bin by bin; the
[octave-band spectrogram](/phonometry/signal/levels/levels/) of
...
[Hilbert instantaneous frequency](/phonometry/signal/spectra/correlation-delay/) of
...
`OctaveFilterBank.spectrogram` on the [Levels](/phonometry/signal/levels/levels/)
page. Tracking a single component's instantaneous frequency over time is
the Hilbert envelope of `envelope`, on the
[Correlation and delay](/phonometry/signal/spectra/correlation-delay/) page, not
this one. As with the spectral-analysis page, this implements Bendat &
Piersol's estimators, not a certification standard.

## See also

- [Spectral analysis](/phonometry/signal/spectra/spectral-analysis/): the averaged Welch estimate for the stationary background, and the window figures of merit behind the segment taper.
- [Levels](/phonometry/signal/levels/levels/): the fractional-octave-band spectrogram with sound-level-meter ballistics.
- [Correlation and delay](/phonometry/signal/spectra/correlation-delay/): the Hilbert instantaneous frequency for tracking one component.

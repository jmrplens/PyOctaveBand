...
first (see [Correlation and delay](/phonometry/signal/spectra/correlation-delay/))
and keep `nperseg` well above the longest remaining delay.

The estimators share the Welch core of the
[calibrated spectral analysis](/phonometry/signal/spectra/spectral-analysis/) page
...
- [Spectral analysis](/phonometry/signal/spectra/spectral-analysis/): the single-input coherent output spectrum this page generalizes, and the shared Welch core.
- [Correlation and delay](/phonometry/signal/spectra/correlation-delay/): estimating and removing the bulk delays that bias coherence low.
- [Multichannel and Performance](/phonometry/signal/filters/multichannel/): the per-channel path this cross-channel analysis complements.

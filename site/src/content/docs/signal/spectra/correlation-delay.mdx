...
Where the [calibrated spectral estimators](/phonometry/signal/spectra/spectral-analysis/) describe a
...
[`cross_spectral_density`](/phonometry/signal/spectra/spectral-analysis/) and the H1/H2
...
[envelope spectrum](/phonometry/signal/spectra/cepstrum-echoes/), which reads the same
...
[fractional-delay and resampling tools](/phonometry/signal/spectra/test-signals/).
...
spectrum](/phonometry/signal/spectra/cepstrum-echoes/). Estimating delays across

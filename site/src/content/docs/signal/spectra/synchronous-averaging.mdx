...
[`fractional_delay`](/phonometry/signal/spectra/test-signals/), and the waveform is
...
[test-signals page](/phonometry/signal/spectra/test-signals/), and the recovered
...
- **The [cepstrum](/phonometry/signal/spectra/cepstrum-echoes/)** needs no
...
- **The [envelope spectrum](/phonometry/signal/spectra/cepstrum-echoes/#5-the-envelope-spectrum-modulations-as-lines)**
...
[cepstrum](/phonometry/signal/spectra/cepstrum-echoes/), not of this page.
Locating amplitude-modulation periodicities, such as bearing faults, is
the
[envelope spectrum](/phonometry/signal/spectra/cepstrum-echoes/#5-the-envelope-spectrum-modulations-as-lines),
...
- [Cepstrum and echoes](/phonometry/signal/spectra/cepstrum-echoes/): reference-free detection of harmonic and sideband families, and the envelope spectrum.
- [Correlation and delay](/phonometry/signal/spectra/correlation-delay/): the Hilbert envelope behind envelope analysis.
- [Test signals](/phonometry/signal/spectra/test-signals/): the fractional-delay kernel the non-integer period alignment uses.

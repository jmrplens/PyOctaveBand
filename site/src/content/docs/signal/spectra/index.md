...
[Calibrated spectral analysis](/phonometry/signal/spectra/spectral-analysis/) is the
...
[Multiple and partial coherence](/phonometry/signal/spectra/miso-coherence/) carries
...
[Time-frequency analysis](/phonometry/signal/spectra/time-frequency/) is the view in
...
[Test signals and sample-rate tools](/phonometry/signal/spectra/test-signals/) is
...
[System measurement](/phonometry/signal/spectra/system-measurement/) turns the
...
[uncertainty pages](/phonometry/signal/metrology/)
supply the error-analysis vocabulary the estimates are stated in.

## Pages in this section

- [Calibrated spectral analysis](/phonometry/signal/spectra/spectral-analysis/):
...
- [Multiple and partial coherence](/phonometry/signal/spectra/miso-coherence/):

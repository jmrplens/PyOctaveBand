...
The [spectral estimators](/phonometry/signal/spectra/spectral-analysis/) describe *what
...
extends the [Hilbert envelope](/phonometry/signal/spectra/correlation-delay/) with an
...
[Hilbert envelope](/phonometry/signal/spectra/correlation-delay/) (`kind="magnitude"`,
...
[calibrated spectral estimators](/phonometry/signal/spectra/spectral-analysis/), and its
...
[Hilbert envelope](/phonometry/signal/spectra/correlation-delay/) returns in time, and a

...
[Build a sound level meter](/phonometry/signal/sound-level-meter/) assembles
...
[Filter Banks](/phonometry/signal/filters/filter-banks/) first: it introduces the band
decomposition every other page assumes. Then
[Integrated and Statistical Levels](/phonometry/signal/levels/levels/) shows the
metrics most measurements end in, and
[Calibration and dBFS](/phonometry/signal/metrology/calibration/) anchors them to
physical units.
...
- [Filter Banks](/phonometry/signal/filters/filter-banks/): the fractional-octave
...
- [Frequency Weighting (A, C, Z)](/phonometry/signal/levels/weighting/): the
...
- [Special Weightings (G, B, D, AU)](/phonometry/signal/levels/special-weightings/):
  ...
  per IEC 61012.
- [Time Weighting](/phonometry/signal/levels/time-weighting/): Fast, Slow and Impulse
  exponential ballistics per IEC 61672-1.
- [Integrated and Statistical Levels](/phonometry/signal/levels/levels/): Leq and
...
- [Time-frequency analysis](/phonometry/signal/spectra/time-frequency/): the
...
- [System measurement](/phonometry/signal/spectra/system-measurement/):

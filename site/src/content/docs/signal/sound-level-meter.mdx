...
Deep guide: [Calibration and dBFS](/phonometry/signal/metrology/calibration/), which
...
Deep guides: [Frequency Weighting (A, C, Z)](/phonometry/signal/levels/weighting/)
and [Time Weighting](/phonometry/signal/levels/time-weighting/).
...
Deep guide: [Integrated and Statistical Levels](/phonometry/signal/levels/levels/),
which adds noise dose and octave spectrograms; the $L_{den}$ and rating levels
continue in [Environmental Levels](/phonometry/environment/environmental-levels/).
...
Deep guides: [Filter Banks](/phonometry/signal/filters/filter-banks/) for the filter
architectures and zero-phase mode,
[Block Processing](/phonometry/signal/filters/block-processing/) for streaming, and
[Multichannel and Performance](/phonometry/signal/filters/multichannel/) for arrays.
...
[Frequency Weighting](/phonometry/signal/levels/weighting/) (section on class
verification) and
...
- [Measurement uncertainty (GUM and Monte Carlo)](/phonometry/signal/metrology/gum-uncertainty/):
  ...
  included.
- [Calibrated spectral analysis](/phonometry/signal/spectra/spectral-analysis/): when
...
- [Block Processing](/phonometry/signal/filters/block-processing/): turn this page's
...
the [calibration guide](/phonometry/signal/metrology/calibration/) for exactly what

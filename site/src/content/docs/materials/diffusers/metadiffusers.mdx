...
reflect with $|R_n|$ near one and to differ only in phase. The first slit does
come close to critical coupling — its absorption peaks at 0.99 — but at
2305 Hz, above the 2 kHz the phase profile is tuned for, where it still
reflects 0.97 of the incident pressure. The critically coupled slit that a

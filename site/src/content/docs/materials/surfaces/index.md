---
title: "Surfaces measured in place"
description: "Surfaces that have no sample: why a pavement is characterised where it lies, the ISO 13472-1 subtraction technique against the ISO 13472-2 spot tube, what each is scoped to, and the editions the library implements."
---
...
- [Impedance Tube](/phonometry/materials/absorbers/impedance-tube/): the
...
[Impedance Tube](/phonometry/materials/absorbers/impedance-tube/). Nothing in
this subsection measures the noise a surface *generates* — the tyre-road source
term is CNOSSOS territory, in [Environmental
sources](/phonometry/environment/sources/) — and no in-situ method is provided

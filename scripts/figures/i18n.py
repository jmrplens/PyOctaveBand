...
_ES_EXACT = {
    ...
    "Ratio $z$": "Cociente $z$",
    "Local environmental correction $K_3$ (dB)": "Corrección ambiental local $K_3$ (dB)",
    "What the room adds, and where grade 2 ends": "Lo que añade la sala, y dónde acaba el grado 2",
